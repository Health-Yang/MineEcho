...
import { n as loadInstalledPluginIndexInstallRecords, r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CQGWoRBr.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-BMCHYmJL.js";
import { a as resetModelCatalogCache } from "./model-catalog-D4xiPrTf.js";
...
import { r as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-r0bvLe6M.js";
...
import { r as resetDirectoryCache } from "./target-resolver-B7hXUFIt.js";
...
import { i as warmCurrentProviderAuthState, t as clearCurrentProviderAuthState } from "./model-provider-auth-BdnG0kzt.js";
import { v as resolveHooksConfig } from "./hooks-Bxv6l2rO.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BPVi24kM.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DYGDzttF.js";
...
import { t as buildGatewayCronService } from "./server-cron-i5IplaUe.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D14M-vmX.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-CTwHRNNM.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-CA1tT6VW.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-C8VBLfVk.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-CAb-1YL6.js"), import("./gmail-watcher-lifecycle-BJJG0m1i.js")]);
