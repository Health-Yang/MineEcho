...
import { n as privateFileStoreSync, t as privateFileStore } from "./private-file-store-DUBa54Tt.js";
import { i as isLoopbackHost } from "./net-ziAus6sd.js";
import { c as isBlockedHostnameOrIp } from "./ssrf-DcS_PaqX.js";
...
import { A as resolveRealtimeVoiceAgentConsultToolsAllow, I as createTalkSessionController, R as recordTalkObservabilityEvent, S as buildRealtimeVoiceAgentConsultPolicyInstructions, k as resolveRealtimeVoiceAgentConsultTools, y as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "./session-runtime-DkzeLM7W.js";
import { f as resolveRealtimeVoiceFastContextConsult, m as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-BNYRswSU.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-Bii1opsG.js";
import "./api-D6eOwq_u.js";
import { a as resolveVoiceCallEffectiveConfig, c as deepMergeDefined, i as resolveVoiceCallConfig, n as normalizeVoiceCallConfig, o as resolveVoiceCallSessionKey, r as resolveTwilioAuthToken, s as validateProviderConfig } from "./config-BONHnfZF.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CAuJytMO.js";
import { t as resolveVoiceResponseModel } from "./response-model-Ci4XSDqB.js";
import { t as isProviderStatusTerminal } from "./call-status-C5kx9YsJ.js";
import { t as getHeader } from "./http-headers-CbGCjTeU.js";
...
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-CaXb1qC8.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-qw_n8MXp.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-yPJQiKIj.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Beiaa6Fx.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-Cj8BirNm.js");
...
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-CmDQbaes.js");
