...
import { C as BrowserTabNotFoundError, b as BrowserProfileUnavailableError, f as redactCdpUrl } from "./cdp.helpers-TK-p0nR2.js";
import "./tmp-openclaw-dir-Cmkv4p-a.js";
import "./record-shared-CSP4p9a4.js";
...
async function createChromeMcpSession(profileName, options, signal) {
	...
	try {
		...
		if (signal?.aborted) created.then((session) => closeChromeMcpSessionHandle(session)).catch(() => {});
		throw err;
	}
}
