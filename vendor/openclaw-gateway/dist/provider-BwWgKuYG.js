import { _ as resolveFoundryModelCapabilities, d as isFoundryProviderApi, i as PROVIDER_ID, l as buildFoundryProviderBaseUrl, o as applyFoundryProfileBinding, p as normalizeFoundryEndpoint, s as applyFoundryProviderConfig, u as extractFoundryEndpoint, v as resolveFoundryTargetProfileId } from "./shared-CuT5dg4L.js";
import { n as entraIdAuthMethod, t as apiKeyAuthMethod } from "./auth-DFPBV8K_.js";
import { t as prepareFoundryRuntimeAuth } from "./runtime-Dk-YO_hV.js";
	...
	return {
		...
		onModelSelected: async (ctx) => {
			...
			const nextModels = configuredModels.map((model) => {
				...
				if (selectedModelCapabilities.compat) nextModel.compat = selectedModelCapabilities.compat;
				return nextModel;
			});
