...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-BxfOKSSj.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-Bi7J4VVm.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-Dcn79T5s.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-BDQMoNEZ.js");
	if (params.argv) {
