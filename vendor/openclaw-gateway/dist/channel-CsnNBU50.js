...
import { i as resolveToolsBySender } from "./group-policy-CH35LESg.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-lW-EvTAF.js";
import "./channel-api-CB2MzgaB.js";
import { t as parseDiscordTarget } from "./target-parsing-D0KB0cgg.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-DNcnaSGf.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-08zSs2Hk.js";
import { t as getDiscordRuntime } from "./runtime-B_MWZ4rH.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-BLM9ekb3.js";
import { t as getDiscordApprovalCapability } from "./approval-native-LAFOYziv.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-BXr4LFe_.js";
import { t as discordMessageActions$1 } from "./channel-actions-ClbFAVGC.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-Brso726t.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-BJydmYh2.js";
import { n as discordOutbound } from "./outbound-adapter-CdKGF5sa.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-CiqUzNHY.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-B7wucswJ.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BLzuxH2y.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-BBazDc8y.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-B7GSd0KY.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-BmcKErr7.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-CMP6ab5s.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-B5mqtRUa.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-D-_kjxfa.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-SXeb3Rog.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-CEa4sULA.js");
