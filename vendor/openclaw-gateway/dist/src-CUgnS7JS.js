...
import { i as writeJsonFileAtomically } from "./json-store-DXH8dkSO.js";
...
import { o as saveResponseMedia } from "./fetch-C_mdbFEd.js";
...
import { f as summarizeMapping, u as mergeAllowlist } from "./allow-from-1lsBdc2n.js";
...
import { o as dispatchReplyFromConfigWithSettledDispatcher } from "./inbound-reply-dispatch-Cyw7nhJQ.js";
import "./channel-outbound-DuRkxH3q.js";
import { o as createDraftStreamLoop } from "./draft-stream-controls-BQxtd4iQ.js";
import { n as logInboundDrop, r as logTypingFailure } from "./logging-Dr3f0mtP.js";
import { n as DEFAULT_WEBHOOK_MAX_BODY_BYTES } from "./http-body-BdNDpkYn.js";
...
import { a as resolveInboundSessionEnvelopeContext } from "./channel-inbound-DCx_VUbe.js";
import "./channel-ingress-runtime-DiD_0kO1.js";
import { n as createChannelPairingController } from "./channel-pairing-BQ_p8VVd.js";
import { n as getOptionalMSTeamsRuntime, t as getMSTeamsRuntime } from "./runtime-api-8IP8gIq_.js";
import { B as extractInlineImageCandidates, C as buildUserAgent, D as formatUnknownError, E as formatMSTeamsSendErrorHint, F as IMG_SRC_RE, G as normalizeContentType, H as isDownloadableAttachment, I as applyAuthorizationHeaderForUrl, J as resolveMediaSsrfPolicy, K as readNestedString, L as encodeGraphShareId, M as tryNormalizeBotFrameworkServiceUrl, N as ATTACHMENT_TAG_RE, P as GRAPH_ROOT, Q as tryBuildGraphSharesUrlForSharedLink, R as estimateBase64DecodedBytes, S as loadMSTeamsSdkWithAuth, T as classifyMSTeamsSendError, U as isLikelyImageAttachment, V as inferPlaceholder, W as isUrlAllowed, X as safeFetchWithPolicy, Y as resolveRequestUrl, Z as safeHostForUrl, _ as resolveMSTeamsStorePath, a as fetchGraphJson, b as createMSTeamsAdapter, h as resolveMSTeamsCredentials, q as resolveAttachmentFetchPolicy, w as ensureUserAgentHeader, x as createMSTeamsTokenProvider, y as createBotFrameworkJwtValidator, z as extractHtmlFromAttachment } from "./graph-users-RJpSO2CH.js";
import { c as resolveMSTeamsUserAllowlist, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-BhWjF4h4.js";
import { i as resolveMSTeamsRouteConfig, r as resolveMSTeamsReplyPolicy, t as resolveMSTeamsAllowlistMatch } from "./policy-C50Uhr8R.js";
import { C as readJsonFile, S as createMSTeamsConversationStoreFs, T as writeJsonFile, _ as buildFileInfoCard, b as createMSTeamsPollStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as resolveGraphChatId, g as removePendingUploadFs, h as getPendingUploadFs, l as sendMSTeamsMessages, m as removePendingUpload, p as getPendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as parseFileConsentInvoke, w as withFileLock, x as extractMSTeamsPollVote, y as uploadToConsentUrl } from "./probe-CHVOpgdi.js";
