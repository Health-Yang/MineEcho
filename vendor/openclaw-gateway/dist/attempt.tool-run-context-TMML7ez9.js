...
import { i as asOptionalRecord, o as isRecord } from "./record-coerce-Btbek4uV.js";
...
import { w as resolvePluginControlPlaneFingerprint } from "./plugin-registry-BALJ9TgI.js";
...
import { Q as resolveProviderRuntimePlugin } from "./provider-runtime-CGENk1Ok.js";
import "./model-selection-DF4MbMUd.js";
import { d as stripRuntimeContextCustomMessages } from "./internal-runtime-context-DftY0OXU.js";
...
import { f as isGoogleModelApi } from "./pi-embedded-helpers-Bj4nONRY.js";
import { n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-B9whgasj.js";
import { a as normalizeTargetForProvider } from "./target-normalization-T6DjS48n.js";
import { r as splitMediaFromOutput } from "./parse-DUEAjR-q.js";
import { n as MIN_PROMPT_BUDGET_TOKENS, t as MIN_PROMPT_BUDGET_RATIO } from "./pi-compaction-constants-fWf8vbuR.js";
import { n as retryAsync } from "./retry-wkIyb3UE.js";
import { S as repairToolUseResultPairing, T as stripToolResultDetails } from "./openai-transport-stream-BOZ_TYPY.js";
import { r as estimateToolResultReductionPotential } from "./tool-result-truncation-B6rIoGLw.js";
import { u as shouldPreserveThinkingBlocks } from "./provider-replay-helpers-B816pw0N.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BFKbGTvr.js");
...
async function summarizeChunks(params) {
	...
	for (const chunk of chunks) try {
		summary = await retryAsync(() => generateSummary$1(chunk, params.model, params.reserveTokens, params.apiKey, params.headers, params.signal, effectiveInstructions, summary), {
			attempts: 3,
			minDelayMs: 500,
			maxDelayMs: 5e3,
			jitter: .2,
...
//#endregion
export { isToolResultError as A, extractMessagingToolSend as C, extractToolResultText as D, extractToolResultMediaArtifact as E, isMessageToolSendActionName as F, isMessagingTool as I, isMessagingToolSendAction as L, sanitizeToolArgs as M, sanitizeToolResult as N, filterToolResultMediaUrls as O, collectTextContentBlocks as P, buildToolLifecycleErrorResult as S, extractToolErrorMessage as T, resolveCompactionTimeoutMs as _, formatPrePromptPrecheckLog as a, shouldAllowProviderOwnedThinkingReplay as b, SUMMARIZATION_OVERHEAD_TOKENS as c, pruneHistoryForContextShare as d, resolveContextWindowTokens as f, compactWithSafetyTimeout as g, compactContextEngineWithSafetyTimeout as h, estimateRenderedLlmBoundaryTokenPressure as i, isToolResultTimedOut as j, isCoreToolResultMediaTrustedName as k, computeAdaptiveChunkRatio as l, createAgentToolResultMiddlewareRunner as m, PREEMPTIVE_OVERFLOW_ERROR_TEXT as n, shouldPreemptivelyCompactBeforePrompt as o, summarizeInStages as p, buildPrePromptContextBudgetStatus as r, SAFETY_MARGIN as s, buildEmbeddedAttemptToolRunContext as t, estimateMessagesTokens as u, providerRequiresSignedThinking as v, extractToolErrorCode as w, runAgentCleanupStep as x, resolveTranscriptPolicy as y };
