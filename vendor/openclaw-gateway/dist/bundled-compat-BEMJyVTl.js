...
import { n as hasExplicitPluginConfig } from "./manifest-registry-DYz4Sf21.js";
...
function withBundledPluginEnablementCompat(params) {
	...
	const allow = params.config?.plugins?.allow;
	const allowSet = !useCompatDiscovery && Array.isArray(allow) && allow.length > 0 ? new Set(normalizeUniqueStringEntries(allow.map((pluginId) => normalizePluginId(pluginId)))) : void 0;
