...
import { n as appendBootstrapPromptWarning } from "./bootstrap-budget-CLqQUFdu.js";
...
import { n as applySkillEnvOverridesFromSnapshot } from "./env-overrides-CtKr5dRj.js";
import "./skills-AlUGzl4g.js";
import { g as getProcessSupervisor } from "./bash-tools.exec-runtime-8PX3ZS_g.js";
import { a as createCliJsonlStreamingParser, i as shouldUseClaudeLiveSession, o as extractCliErrorMessage, r as runClaudeLiveSessionTurn, s as parseCliOutput } from "./claude-live-session-DJ29JCJw.js";
import { r as cliBackendLog } from "./log-MynECmiB.js";
import { a as prepareCliPromptImagePayload, c as resolveSessionIdToSend, d as buildCliSupervisorScopeKey, f as resolveCliNoOutputTimeoutMs, l as resolveSystemPromptUsage, n as buildCliArgs, o as resolveCliRunQueueKey, p as prepareClaudeCliSkillsPlugin, r as enqueueCliRun, s as resolvePromptInput, u as writeCliSystemPromptFile } from "./helpers-3DYmR60e.js";
...
async function executePreparedCliRun(context, cliSessionIdToUse) {
	...
	const systemPromptFile = systemPromptArg && (!useResume || backend.systemPromptWhen === "always") ? await writeCliSystemPromptFile({
		backend,
	...
	try {
		...
		if (!fallbackClaudeSkillsPluginCleanupOwned) await fallbackClaudeSkillsPlugin?.cleanup();
