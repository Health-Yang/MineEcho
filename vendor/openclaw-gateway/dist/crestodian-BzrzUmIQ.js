...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-Djt47Ol0.js";
import { r as resolveCrestodianOperation } from "./dialogue-DtoYTNDu.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BAqrT3mp.js")).runCrestodianTui;
	opts.onReady?.();
