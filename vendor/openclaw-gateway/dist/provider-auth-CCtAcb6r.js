...
import "./ref-contract-DArhJvB2.js";
import "./provider-env-vars-CteAyjcQ.js";
import "./constants-0i5hheAU.js";
import { c as loadAuthProfileStoreForSecretsRuntime, l as loadAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-lFmS2pvu.js";
import "./model-auth-markers-BxvoYSZo.js";
import { t as resolveEnvApiKey } from "./model-auth-env-Yj6OHlxK.js";
import "./models-config.providers.secrets-Ulzq2N3I.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-CG-kSTIB.js";
...
import "./provider-auth-input-CydwoCLd.js";
import "./provider-auth-helpers-BypOO1dt.js";
import "./provider-api-key-auth-CfroE9dd.js";
import "./agent-dir-compat-CEN4sd-j.js";
import "./provider-auth-result-8qg_ZVzB.js";
...
const COPILOT_TOKEN_REQUEST_TIMEOUT_MS = 3e4;
...
function createCopilotTokenRequestAbort(params) {
...
function formatCopilotTokenRequestError(error, params) {
	if (params.timedOut) return /* @__PURE__ */ new Error(`GitHub Copilot token exchange timed out after ${params.timeoutMs ?? COPILOT_TOKEN_REQUEST_TIMEOUT_MS}ms`);
	if (params.signal?.aborted) return /* @__PURE__ */ new Error("GitHub Copilot token exchange cancelled");
	if (error instanceof Error && (error.name === "AbortError" || error.name === "TimeoutError")) return /* @__PURE__ */ new Error(`GitHub Copilot token exchange timed out after ${params.timeoutMs ?? COPILOT_TOKEN_REQUEST_TIMEOUT_MS}ms`);
	return error instanceof Error ? error : /* @__PURE__ */ new Error(`GitHub Copilot token exchange failed: ${String(error)}`);
}
...
async function resolveCopilotApiToken(params) {
	...
	try {
		...
		throw formatCopilotTokenRequestError(error, {
			...params,
