...
import { s as listCoreGatewayMethodNames } from "./core-descriptors-BUnLwpF8.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-CWrd66LC.js";
import "./loader-ChBMT90m.js";
import { F as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-B5Ug58ea.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-D1Fn7PIL.js";
import { c as initSubagentRegistry } from "./subagent-registry-J8FQ56_P.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-CRN7KR6M.js";
import { n as listGatewayMethods } from "./server-methods-list-C93LQxTG.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-pcvjLzCK.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-uMz057ia.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-z5cxkjzt.js");
