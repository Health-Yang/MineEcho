...
import { t as CONFIG_PATH } from "./paths-CQv1_CDw.js";
...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-CtRQ27Ls.js";
import { r as normalizeProviderId$1 } from "./provider-id-nh-uBdZ_.js";
...
import { r as normalizeChatChannelId } from "./ids-OP3BJTaQ.js";
import { i as setPathExistingStrict } from "./path-utils-CJUNH_hN.js";
import { n as discoverConfigSecretTargets } from "./target-registry-DQj4ycIE.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-BlARNTf3.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { r as normalizeTalkSection } from "./talk-Cxq1Zt-L.js";
...
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-CTRQpZ0m.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-Y0sCwnR-.js";
import { n as getLoadedChannelPlugin } from "./registry-Be8exPcf.js";
import { c as migrateLegacyRuntimeModelRef, o as legacyRuntimeModelAliasRequiresRuntimePolicy, s as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-DXHvPXsy.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-DeGjsqpJ.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Ds6eNzoL.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DORFNfXX.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BbDLgB1X.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BR29OBuW.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CIE2t7qx.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BnARWTHy.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-rWbYQ87-.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BAdv8nHj.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-Z18iXfzd.js");
