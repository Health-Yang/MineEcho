#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-BsfWgA0I.js";
import { t as formatCliFailureLines } from "./failure-output-Bd4CqnmA.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-gDVRMZSa.js";
import { t as isMainModule } from "./is-main-DoKHeRG7.js";
import { c as isUncaughtExceptionHandled, r as isBenignUncaughtExceptionError, t as installUnhandledRejectionHandler } from "./unhandled-rejections-uJ1-s-X0.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-B3qC69IP.js"));
if (isMain) {
