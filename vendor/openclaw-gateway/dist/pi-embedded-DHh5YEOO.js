...
import { o as resolveAgentExecutionContract, r as hasConfiguredModelFallbacks, v as resolveSessionAgentIds } from "./agent-scope-CudANNo3.js";
import { i as isCronSessionKey } from "./session-key-utils-AmKO9Roj.js";
...
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-5VCl4fwR.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { n as resolveSafeTimeoutDelayMs } from "./timer-delay-awNPCchy.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, c as resolveContextConfigProviderForRuntime, d as resolveSelectedOpenAIPiRuntimeProvider, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-CnBPb3N4.js";
...
import { s as emitAgentPlanEvent } from "./agent-events-BuYtWSh4.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-CeOacmio.js";
import { Y as resolveProviderAuthProfileId, b as prepareProviderRuntimeAuth } from "./provider-runtime-CGENk1Ok.js";
...
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BHbpuv3O.js";
import { c as isTimeoutErrorMessage } from "./failover-matches-BO6PBwHx.js";
import "./runs-p1TN18LG.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-BpOBzvOi.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-Detu9Td-.js";
import { n as sleepWithAbort } from "./backoff-BQ4uO4hX.js";
import { i as enqueueCommandInLane } from "./command-queue-fCeWoVd6.js";
import { S as parseImageSizeError, _ as isRateLimitAssistantError, a as formatAssistantErrorText, c as isBillingAssistantError, f as isFailoverAssistantError, g as isLikelyContextOverflowError, i as extractObservedOverflowTokenCount, p as isFailoverErrorMessage, s as isAuthAssistantError, t as classifyFailoverReason, u as isCompactionFailureError, x as parseImageDimensionError } from "./errors-DuGAmFy8.js";
import { c as resolveFailoverStatus, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-wBZizcCn.js";
import { d as setReplyPayloadMetadata, i as getReplyPayloadMetadata, r as copyReplyPayloadMetadata, u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-payload-DM17pxMC.js";
import { a as hasReplyPayloadContent } from "./payload-Cpx3heIy.js";
import { x as isStrictAgenticExecutionContractActive } from "./openclaw-tools-BUQsixTe.js";
import { A as shouldRotateCompactionTranscript, C as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, Ct as resolveReplayInvalidFlag, Dt as createEmbeddedRunReplayState, E as shouldWarnEmbeddedRunStageSummary, Et as shouldTreatEmptyAssistantReplyAsSilent, Ot as observeReplayMetadata, P as normalizeContextTokenBudget, S as mergeUsageIntoAccumulator, St as resolveReasoningOnlyRetryInstruction, T as formatEmbeddedRunStageSummary, Tt as resolveSilentToolResultReplyPayload, _ as resolveOverloadProfileRotationLimit, _t as resolveAttemptReplayMetadata, a as RUNTIME_AUTH_REFRESH_MARGIN_MS, b as scrubAnthropicRefusalMagic, bt as resolvePlanningOnlyRetryInstruction, c as buildErrorAgentMeta, d as isAssistantForModelRef, f as resolveActiveErrorContext, g as resolveOverloadFailoverBackoffMs, gt as resolveAckExecutionFastPathInstruction, h as resolveMaxRunRetryIterations, ht as extractPlanningOnlyPlanDetails, i as selectAgentHarness, k as rotateTranscriptFileAfterCompaction, l as buildUsageAgentMetaFields, m as resolveFinalAssistantVisibleText, mt as STRICT_AGENTIC_BLOCKED_TEXT, o as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, p as resolveFinalAssistantRawText, r as runAgentHarnessAttempt, s as RUNTIME_AUTH_REFRESH_RETRY_MS, t as maybeCompactAgentHarnessSession, u as createCompactionDiagId, v as resolveRateLimitProfileRotationLimit, vt as resolveEmptyResponseRetryInstruction, w as createEmbeddedRunStageTracker, wt as resolveRunLivenessState, x as createUsageAccumulator, xt as resolvePlanningOnlyRetryLimit, y as resolveReportedModelRef, yt as resolveIncompleteTurnPayloadText } from "./selection-C4e-Qn9W.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-BO5sRfPm.js";
import { _ as listActiveProcessSessionReferences, g as resolveContextEngineCapabilities, m as resolveEmbeddedCompactionTarget, p as buildEmbeddedCompactionRuntimeContext, r as forgetPromptBuildDrainCacheForRun, v as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-6Y-UzS6M.js";
import { i as pickFallbackThinkingLevel, s as normalizeTextForComparison } from "./pi-embedded-helpers-Bj4nONRY.js";
import { n as resolveProcessToolScopeKey } from "./pi-tools-B2ovZXCA.js";
import "./auth-profiles-BqdzLfrX.js";
import { n as markAuthProfileSuccess } from "./profiles-7sSr_su8.js";
import { i as resolveAuthProfileOrder, l as isProfileInCooldown, r as resolveAuthProfileEligibility } from "./order-Df4RKtkA.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-CVigAzJO.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-Dii4DVpK.js";
import { i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, p as shouldPreferExplicitConfigApiKeyAuth, t as applyAuthHeaderOverride } from "./model-auth-DEXDfJh7.js";
import { c as retireSessionMcpRuntimeForSessionKey, s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-r0bvLe6M.js";
import "./pi-bundle-mcp-tools-Dx9OBYuL.js";
import { f as hasMessagingToolDeliveryEvidence, p as hasOutboundDeliveryEvidence } from "./subagent-announce-delivery-DK-Ub9gW.js";
import { _ as resolveCompactionTimeoutMs, h as compactContextEngineWithSafetyTimeout, x as runAgentCleanupStep } from "./attempt.tool-run-context-TMML7ez9.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./pi-embedded-utils-Co_Vyn6I.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-DIqK0fbR.js";
import { p as parseReplyDirectives } from "./payloads-BSIGv16L.js";
import { N as formatToolAggregate } from "./streaming-Bpx5ncw8.js";
import { c as LiveSessionModelSwitchError, d as buildApiErrorObservationFields, o as resolveSessionSuspensionReason, p as shouldSuppressRawErrorConsoleSuffix, s as suspendSession, u as shouldAllowCooldownProbeForReason } from "./model-fallback--w47Y_pS.js";
import { t as log$1 } from "./logger-DLLDK9dc.js";
import "./tool-split-DchkB24K.js";
...
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-D_iBBJQp.js";
import { n as resolveModelAsync } from "./model-D1xkjWU8.js";
import { t as ensureContextEnginesInitialized } from "./init-Dd1uDq_y.js";
import { a as resolveLiveToolResultMaxChars, o as sessionLikelyHasOversizedToolResults, s as truncateOversizedToolResultsInSession } from "./tool-result-truncation-B6rIoGLw.js";
import "./extra-params-BxDvfOci.js";
import { c as runContextEngineMaintenance } from "./context-engine-lifecycle-DxaBy-g1.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, r as evaluateContextWindowGuard, s as resolveContextWindowInfo } from "./context-window-guard-0r-APPpV.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-C_po5gkc.js";
import { _ as persistSessionCompactionCheckpoint, c as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON, f as captureCompactionCheckpointSnapshotAsync, n as asCompactionHookRunner, p as cleanupCompactionCheckpointSnapshot, s as runPostCompactionSideEffects, t as readPiModelContextTokens, v as readSessionLeafIdFromTranscriptAsync, y as resolveSessionCompactionCheckpointReason } from "./model-context-tokens-BpXhDFUw.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-7SnOGJlC.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-BQK4nhr2.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-iW_r7-MG.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DHAF78Pl.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-BMApTz47.js";
import { r as buildAgentRuntimePlan } from "./build-Dyj3J0Vc.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-tTrfRME0.js";
import fs from "node:fs/promises";
import { randomBytes } from "node:crypto";
//#region src/agents/pi-embedded-runner/compact.queued.ts
function shouldFallbackAfterHarnessCompaction(result, harnessPolicyRuntime, explicitHarnessId) {
	if (harnessPolicyRuntime === "codex" || explicitHarnessId === "codex") return false;
...
async function compactEmbeddedPiSession(params) {
	...
	if (harnessResult) {
		if (!shouldFallbackAfterHarnessCompaction(harnessResult, harnessPolicy.runtime, params.agentHarnessId)) {
			await contextEngine.dispose?.();
...
async function runEmbeddedPiAgent(params) {
	...
	return enqueueSession(() => {
		...
		return enqueueGlobal(async () => {
			...
			const modelResolutionProviders = selectedPiRuntimeProvider !== provider ? [selectedPiRuntimeProvider, provider] : [provider];
			...
			if (!modelResolution) {
				...
				for (const candidateProvider of modelResolutionProviders) {
					const candidateResolution = await resolveModelAsync(candidateProvider, modelId, agentDir, params.config, { workspaceDir: resolvedWorkspace });
					firstModelResolution ??= candidateResolution;
					if (candidateResolution.model) {
						resolvedModelProvider = candidateProvider;
						modelResolution = candidateResolution;
			...
			let piExternalCliAuthScope = pluginHarnessOwnsTransport ? { ignoreAutoPreferredProfile: false } : resolveExternalCliAuthOverlayScopeFromSelection({
				provider,
				cfg: params.config,
				agentId: params.agentId,
				modelId,
