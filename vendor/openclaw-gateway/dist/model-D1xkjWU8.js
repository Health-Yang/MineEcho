...
import { i as loadPluginManifest } from "./manifest-CLXJII1a.js";
import { i as normalizeStaticProviderModelId, n as modelKey } from "./model-ref-shared-CwD1xLDF.js";
import "./defaults-mDjiWzE5.js";
import { r as hasAnyRuntimeAuthProfileStoreSource } from "./runtime-snapshots-DOjW6jJR.js";
import { V as runProviderDynamicModel, W as shouldPreferProviderRuntimeResolvedModel, c as buildProviderUnknownModelHintWithPlugin, g as normalizeProviderResolvedModelWithPlugin, i as applyProviderResolvedTransportWithPlugin, r as applyProviderResolvedModelCompatWithPlugins, v as normalizeProviderTransportWithPlugin, y as prepareProviderDynamicModel } from "./provider-runtime-CGENk1Ok.js";
import { t as listOpenClawPluginManifestMetadata } from "./manifest-metadata-scan-CSBVjElK.js";
import { f as isSecretRefHeaderValueMarker } from "./model-auth-markers-BxvoYSZo.js";
import "./model-selection-DF4MbMUd.js";
import { a as normalizeModelCompat } from "./provider-model-compat-M50YUhbu.js";
...
import { l as sanitizeConfiguredModelProviderRequest, o as resolveProviderRequestConfig, t as attachModelProviderRequestTransport } from "./provider-request-config-CVigAzJO.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CZ_wh5_j.js";
import { a as shouldUnconditionallySuppress, n as buildSuppressedBuiltInModelError, r as shouldSuppressBuiltInModel } from "./model-suppression-CH2iitwC.js";
import { t as attachModelProviderLocalService } from "./provider-local-service-DglKovk7.js";
...
async function resolveModelAsync(provider, modelId, agentDir, cfg, options) {
	...
	if (model && options?.allowBundledStaticCatalogFallback) {
		const staticMediaInput = resolveBundledStaticCatalogModel({
			provider: normalizedRef.provider,
			modelId: normalizedRef.model,
			cfg,
			workspaceDir
...
//#endregion
export { resolveBundledStaticCatalogModel as a, bundledStaticCatalogProviderUsesRuntimeAugment as i, resolveModelAsync as n, buildInlineProviderModels as o, resolveModelWithRegistry as r, resolveModel as t };
