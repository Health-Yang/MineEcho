...
import { f as isSameSsrFPolicy } from "./ssrf-DcS_PaqX.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-U414eGG1.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-VD11m0Aj.js";
import { n as isToolAllowed } from "./tool-policy-CSL2XJ3F.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-DTzdayJb.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Da0m6i2H.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BxBAoMrZ.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-BZTXR7vM.js";
import { A as removeRegistryEntry, C as resolveSandboxWorkspaceDir, D as readBrowserRegistry, M as updateRegistry, N as computeSandboxBrowserConfigHash, O as readRegistry, S as resolveSandboxScopeKey, _ as appendWorkspaceMountArgs, a as execDocker, b as resolveReadOnlyWorkspaceSkillMounts, c as isDockerDaemonUnavailable, g as appendReadOnlyWorkspaceSkillMountArgs, j as updateBrowserRegistry, k as removeBrowserRegistryEntry, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as formatReadOnlyWorkspaceSkillMountHashState, w as slugifySessionKey, x as resolveSandboxAgentId } from "./docker-Bh0-Ii1j.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Bk_5dAVo.js";
import { A as runDockerSandboxShellCommand, D as buildPinnedRenamePlan, E as buildPinnedRemovePlan, O as buildPinnedWritePlan, T as buildPinnedMkdirpPlan, a as getSandboxBackendManager, b as normalizeContainerPath, k as dockerSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, x as relativePathEscapesContainerRoot, y as isPathInsideContainerRoot } from "./browser-bridges-qZK-Lyvp.js";
...
function parseStatMtimeMs(value) {
	const raw = value ?? "0";
	if (/^\d+(?:\.\d+)?$/.test(raw)) return Number(raw) * 1e3;
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-DAVjOuiq.js"),
				import("./exec-defaults-Dynhd2PM.js"),
				import("./skills-BZ7XNDP2.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-Cnl9NKnt.js")).maybePruneSandboxes(cfg);
