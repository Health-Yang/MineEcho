...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-CtRQ27Ls.js";
...
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-DnaAkS4N.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CIDKr3aI.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DlVSgxY7.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-8RjUWV_5.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CGPDOJMx.js";
import { t as runSetupWizard } from "./setup-BGVFA9VS.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-cBtC5CfH.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B7U6e_vj.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DhxJSRho.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-qtphahAv.js");
