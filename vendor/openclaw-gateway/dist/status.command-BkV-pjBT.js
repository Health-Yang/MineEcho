...
import { c as normalizePairingConnectRequestId, d as readConnectPairingRequiredMessage, f as readPairingConnectErrorDetails } from "./connect-error-details-Co08hq5R.js";
import { o as readRestartSentinel } from "./restart-sentinel-DePW2OSL.js";
...
async function buildStatusCommandReportData(params) {
	...
	const retainedLostLine = (params.opts.deep || params.opts.verbose) && retainedLost && retainedLost.count > 0 ? params.theme.muted(`${retainedLost.count} lost task${retainedLost.count === 1 ? "" : "s"} retained until ${retainedLost.nextCleanupAfter ? new Date(retainedLost.nextCleanupAfter).toISOString() : "cleanupAfter"}`) : null;
	return {
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-CSQB1ui4.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-CIk7l1m-.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-Cp3u5nmi.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-BVYPdkuz.js"));
const statusGatewayConnectionRuntimeLoader = createLazyImportLoader(() => import("./status.gateway-connection.runtime.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-klsXsiLI.js"));
