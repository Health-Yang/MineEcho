...
import { L as WebFetchProviderPlugin, M as PluginWebFetchProviderEntry, N as PluginWebSearchProviderEntry, U as WebSearchProviderPlugin, w as PluginRuntimeTaskFlow } from "./types-core-CiUqduCn.js";
...
import { K as ChannelMessageActionName$1, T as ChannelMessagingAdapter, c as ChannelCapabilities } from "./types.core-CmhUJuY-.js";
import { c as EmbeddingProviderAdapter } from "./embedding-providers-DkT4Cx4A.js";
import { Bt as ProviderCatalogResult, C as OpenClawPluginApi, D as OpenClawPluginCliRegistrar, Gn as RealtimeVoiceProviderPlugin, Kn as SpeechProviderPlugin, Ot as ProviderAuthMethod, St as PluginTextTransformRegistration, T as OpenClawPluginCliCommandDescriptor, Ui as MemoryEmbeddingProviderAdapter, Wn as RealtimeTranscriptionProviderPlugin, Xn as VideoGenerationProviderPlugin, Yn as UnifiedModelCatalogProviderPlugin, a as ImageGenerationProviderPlugin, cn as ProviderPlugin, dr as CodexAppServerExtensionFactory, h as MigrationProviderPlugin, ht as PluginLogger, li as AgentHarness, o as MediaUnderstandingProviderPlugin, pn as ProviderPluginWizardSetup, qn as TranscriptSourceProvider, v as MusicGenerationProviderPlugin, vr as CliBackendPlugin } from "./types-qwKXExVW.js";
import { tt as PluginHookRegistration } from "./hook-types-DEHbmiQj.js";
import { a as ChannelSetupStatus, c as ChannelSetupWizardAdapter, i as ChannelSetupResult, o as ChannelSetupStatusContext, t as ChannelSetupConfigureContext } from "./setup-wizard-types-CDi6EJxd.js";
import { Bo as PluginSessionActionRegistration, Fo as PluginControlUiDescriptor, Go as PluginSessionExtensionRegistration, Po as PluginAgentEventSubscriptionRegistration, Qo as PluginTrustedToolPolicyRegistration, Ro as PluginRuntimeLifecycleRegistration, Zo as PluginToolMetadataRegistration, qo as PluginSessionSchedulerJobRegistration } from "./index-DFDUKbHk.js";
import { n as ChannelPlugin } from "./types.public-DkG_i7qb.js";
import { n as PluginRuntime } from "./types-DTbj6Ogc.js";
import { i as PluginRegistry, r as PluginRecord, t as PluginAgentToolResultMiddlewareRegistration } from "./registry-types-DN17KoLD.js";
import { u as buildChannelSetupWizardAdapterFromSetupWizard } from "./setup-wizard-binary-q2dl956H.js";
