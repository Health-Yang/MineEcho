...
import { u as parseThreadSessionSuffix } from "./session-key-utils-AmKO9Roj.js";
...
import { f as readNumberParam, g as readStringParam, i as createActionGate, t as ToolAuthorizationError } from "./common-BooMjDNL.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-CcqJUBno.js";
import "./channel-core-LlziNmjH.js";
import "./routing-BEOAuKfu.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-DUgslXLg.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CDbnl1Qr.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-0rGWr8Ti.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-CXv85GEO.js";
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DorIyB3D.js";
import "./approval-native-runtime-0Hr9Qyul.js";
import { x as createChannelMessageAdapterFromOutbound } from "./channel-outbound-DuRkxH3q.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BrYXq8bp.js";
import "./channel-status-BX1a89bS.js";
import "./channel-actions-De3bK4k3.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BQ_p8VVd.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-B9DhbNAO.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-3A7FQpsR.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-DZUtZWk6.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CEyMBA_e.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-D3gJsMAZ.js";
import { n as normalizeMatrixUserId } from "./allowlist-Bs4zQivG.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-61mYOHO8.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-BsXTvcGD.js";
import { t as formatMatrixErrorMessage } from "./errors-DY2AYXwT.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-C-tJbojJ.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BH3R00HP.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-D5YCnPR1.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Ck84yDux.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-B-lQnpQr.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-CZVhDCpO.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-BP-NIc28.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BkBvciku.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-O4JDzRdE.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-Ch5cYPCI.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DhiTxhXg.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-D1OXUxzF.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-D1OXUxzF.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-C5NMoRPe.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
