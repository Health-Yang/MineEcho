...
import { i as formatErrorMessage$1 } from "./errors-BsfWgA0I.js";
...
import { a as saveRemoteMedia, i as readRemoteMediaBuffer } from "./fetch-C_mdbFEd.js";
...
import { u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BJ6AORAh.js";
...
import "./runtime-api-2TM3S6xr.js";
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-_eEJ-7cd.js";
import { t as getTlonRuntime } from "./runtime-B0ffOFfb.js";
import { t as tlonSetupWizard } from "./setup-surface-BKB9RLVT.js";
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-CkSYlwC72.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-CCIj8TZy.js").then((m) => /* @__PURE__ */ __toESM(m.default));
		...
		async (awsIdentityProperties) => {
			...
			const { fromTokenFile } = await import("./dist-cjs-D_f5KDDJ.js").then((m) => /* @__PURE__ */ __toESM(m.default));
