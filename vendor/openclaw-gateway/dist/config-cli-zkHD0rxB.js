...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-CtRQ27Ls.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-DQj4ycIE.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DArhJvB2.js";
import { a as resolveSecretRefValue } from "./resolve-hHR0Z6wg.js";
import { n as info, o as success, t as danger } from "./globals-DZ-ifL5z.js";
import { S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, W as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot } from "./io-BlARNTf3.js";
...
import { w as SecretProviderSchema } from "./zod-schema.core-BPJs63Rs.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-DEsBBcQJ.js";
import { n as setCommandJsonMode } from "./json-mode-BnygczZc.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-pg2Qd8QQ.js");
