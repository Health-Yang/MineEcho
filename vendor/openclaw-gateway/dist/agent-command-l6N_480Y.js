...
import { f as resolveMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BhX2UsCC.js";
...
import { r as buildConfiguredModelCatalog, v as resolveConfiguredModelRef } from "./model-selection-shared-BuXkxoPc.js";
import { i as parseModelRef, n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-l_jinpMc.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-D4xiPrTf.js";
...
import { At as createTrajectoryRuntimeRecorder, n as resolveAvailableAgentHarnessPolicy } from "./selection-C4e-Qn9W.js";
import { l as ensureAgentWorkspace } from "./workspace-BxBAoMrZ.js";
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-Df4RKtkA.js";
import { a as runWithModelFallback, c as LiveSessionModelSwitchError } from "./model-fallback--w47Y_pS.js";
import { r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-DRzgz0AK.js";
import { t as buildOutboundSessionContext } from "./session-context-BklLDvOT.js";
import { n as resolveSession } from "./session-D_iBBJQp.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-CC7zWwhc.js";
import { n as repairProviderWrappedModelOverride, t as applyModelOverrideToSessionEntry } from "./model-overrides-jsF3RKPy.js";
...
import { t as prepareInternalSessionEffectsTranscript } from "./internal-session-effects-BOnfxdYU.js";
...
import "./live-model-switch-DHAF78Pl.js";
import { t as classifyEmbeddedPiRunResultForModelFallback } from "./result-fallback-classifier-DcRzJL7K.js";
import { t as resolveFastModeState } from "./fast-mode-DA48mzi5.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-D8zH9MuQ.js";
import { t as NodeRegistry } from "./node-registry-DJv3Gymf.js";
import { n as applyVerboseOverride } from "./level-overrides-BMF1mjFo.js";
import { a as resolveInternalEventTranscriptBody, i as resolveAcpPromptBody, n as persistSessionEntry$1, r as prependInternalEventContext, t as resolveAgentRunContext } from "./run-context-B6eKqAFL.js";
...
const acpPolicyRuntimeLoader = createLazyImportLoader(() => import("./policy-BZeIXxst.js"));
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-DsV7TonL.js"));
const acpSessionIdentifiersRuntimeLoader = createLazyImportLoader(() => import("./session-identifiers-DoZlH9hS.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-CAmqX-tI.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-DomsiLn4.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-Dynhd2PM.js"));
const skillsRuntimeLoader = createLazyImportLoader(() => import("./skills-BZ7XNDP2.js"));
const skillsFilterRuntimeLoader = createLazyImportLoader(() => import("./filter-BTPetlyd.js"));
const skillsRefreshStateRuntimeLoader = createLazyImportLoader(() => import("./refresh-state-C01wP9Zg.js"));
const skillsRemoteRuntimeLoader = createLazyImportLoader(() => import("./skills-remote-DAVjOuiq.js"));
...
async function agentCommandInternal(opts, runtime = defaultRuntime, deps) {
	...
	try {
		...
		if (!isRawModelRun && acpResolution?.kind === "ready" && sessionKey) {
			...
			registerAgentRunContext(runId, suppressVisibleSessionEffects ? { isControlUiVisible: false } : { sessionKey });
		...
		const emptySkillsFilter = skillFilter !== void 0 && skillFilter.length === 0;
		const buildSkillsSnapshot = async () => {
			if (emptySkillsFilter) return createEmptySkillsSnapshot({
				skillFilter,
		...
		if (!isThinkingLevelSupported({
			...
			if (fallbackThinkLevel !== resolvedThinkLevel) {
				...
				if (sessionEntry && sessionStore && sessionKey && sessionEntry.thinkingLevel === previousThinkLevel && !suppressVisibleSessionEffects) {
					const entry = sessionEntry;
