...
export type ResolvedAgentSystemPromptConfig = Pick<AgentSystemPromptRenderParams, "ownerDisplay" | "ownerDisplaySecret" | "subagentDelegationMode" | "ttsHint" | "modelAliasLines" | "memoryCitationsMode" | "fsWorkspaceOnly">;
