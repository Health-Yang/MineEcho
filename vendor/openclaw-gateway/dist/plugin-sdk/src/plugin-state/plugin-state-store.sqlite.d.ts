...
export declare const MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN = 6000;
...
export declare function clearPluginStateSqliteStoreForTests(): void;
export declare function seedPluginStateSqliteEntriesForTests(entries: readonly PluginStateSeedEntryForTests[]): void;
