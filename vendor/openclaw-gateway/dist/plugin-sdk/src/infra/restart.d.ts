 ...
 */
export declare function emitGatewayRestart(reasonOverride?: string, intent?: GatewayRestartIntent): boolean;
 ...
 */
export declare function consumeGatewaySigusr1RestartIntent(): GatewayRestartIntent | null;
/**
