...
export declare class FollowupRunDeferredError extends Error {
    constructor(message?: string);
}
export declare function isFollowupRunDeferredError(error: unknown): error is FollowupRunDeferredError;
