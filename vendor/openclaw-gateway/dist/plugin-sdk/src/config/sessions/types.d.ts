...
export type SessionContextBudgetStatusRoute = "fits" | "compact_only" | "truncate_tool_results_only" | "compact_then_truncate";
...
export type LaneExecutionState = "active" | "draining" | "suspended" | "resuming" | "circuit_open" | "failed_handoff";
...
export declare function isTerminalSessionStatus(status: unknown): status is Exclude<NonNullable<SessionEntry["status"]>, "running">;
