...
export declare const doctorHealthConversionRules: readonly [{
    ...
    readonly contributionId: "doctor:tool-result-cap";
    readonly conversion: "detect-only";
    readonly target: readonly ["core/doctor/tool-result-cap"];
    readonly rule: "Detect explicit live tool-result cap overrides that are stale or ineffective; preserve deep-mode effective cap output as finding metadata.";
}, {
    readonly contributionId: "doctor:runtime-tool-schemas";
    readonly conversion: "detect-only";
    readonly target: readonly ["core/doctor/runtime-tool-schemas"];
    readonly rule: "Validate active agent tool schemas against the runtime tool projection path and report fatal schema blockers before a turn starts.";
}, {
    ...
    readonly contributionId: "doctor:heartbeat-template-repair";
    readonly conversion: "repair-backed-detect";
    readonly target: readonly ["core/doctor/heartbeat-template-repair"];
    readonly rule: "Detect legacy docs-wrapped heartbeat templates; repair only pure template wrappers and preserve user-authored heartbeat content.";
}, {
