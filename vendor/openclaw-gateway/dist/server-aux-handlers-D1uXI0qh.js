...
import { m as resolveSecretInputRef } from "./types.secrets-CtRQ27Ls.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-BALJ9TgI.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-CJUNH_hN.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-DQj4ycIE.js";
import { a as resolveSecretRefValue } from "./resolve-hHR0Z6wg.js";
...
import { d as buildPluginApprovalRequestMessage, l as approvalDecisionLabel, m as resolvePluginApprovalRequestAllowedDecisions, u as buildPluginApprovalExpiredMessage } from "./plugin-approvals-C9xbHKhZ.js";
import { n as channelRouteDedupeKey } from "./channel-route-Dvehdg4D.js";
import { n as getLoadedChannelPlugin } from "./registry-Be8exPcf.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-BGmuVWWz.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-oH5G9_TS.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-CCyqNOzR.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-CXQntGTT.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-D2165Scf.js";
import { r as createResolverContext } from "./runtime-shared-DUR4yKrc.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-UdgfPlGZ.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-DPevh0Zk.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-VKwGhlg-.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-CvpRi92u.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-Cs9jISl9.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-MGVAWGjJ.js";
import { l as roleScopesAllow } from "./pairing-token-BAYwqTCr.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-3ziNdlg5.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-DYGDzttF.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-y_pm988l.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-Di0PrW6i.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-C5yk9TFU.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-BUepK5Tw.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-CadRqAfJ.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
