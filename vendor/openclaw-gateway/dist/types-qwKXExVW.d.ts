import { i as OpenClawConfig, kn as CliBackendConfig } from "./types.openclaw-AW0IHsvN.js";
import { l as SecretInput } from "./types.secrets-tbFW-hY6.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-CH300rpt.js";
import { x as ToolLoopDetectionConfig } from "./types.tools-CnpvoH3X.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-DPpPP_Q_.js";
...
import { d as PluginKind, f as UnifiedModelCatalogEntry, p as UnifiedModelCatalogKind } from "./manifest-registry-Brx4o2lo.js";
import { n as ReasoningLevel, r as ThinkLevel } from "./thinking.shared-EYzuf-Uq.js";
import { a as SourceReplyDeliveryMode, n as GetReplyOptions } from "./get-reply-options.types-tz7CitlR.js";
import { t as ReplyPayload } from "./reply-payload-DVcklM6x.js";
import { S as HeartbeatToolResponse, _ as AgentRunTimeoutPhase, a as BlockReplyChunking, b as AcceptedSessionSpawn, d as ExecElevatedDefaults, g as EmbeddedRunLivenessState, i as PromptMode, p as EmbeddedPiCompactResult, r as RunEmbeddedPiAgentParams, v as MessagingToolSend, y as MessagingToolSourceReplyPayload } from "./params-Dt3_O5uS.js";
...
import { l as SessionSystemPromptReport, o as SessionContextBudgetStatus, s as SessionEntry } from "./types-DQR5UfEP.js";
...
import { n as SkillSnapshot, r as SkillTelemetrySource } from "./skills-BAwoWDip.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-BVKKEu7g.js";
import { E as OpenClawPluginHookOptions, L as WebFetchProviderPlugin, O as OpenClawPluginToolFactory, U as WebSearchProviderPlugin, k as OpenClawPluginToolOptions, o as PluginRuntimeCore } from "./types-core-CiUqduCn.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-D6uLRPVT.js";
import { f as MediaUnderstandingProvider } from "./types-nHJ6ji79.js";
import { l as ImageGenerationProvider } from "./types-CrZyCaVl.js";
import { s as VideoGenerationProvider } from "./types-BPJnl3Nh.js";
import { c as MusicGenerationProvider } from "./types-DdCcZoa-.js";
...
import { A as SpeechSynthesisRequest, C as SpeechProviderId, D as SpeechProviderResolveConfigContext, E as SpeechProviderPreparedSynthesis, F as SpeechTelephonySynthesisRequest, I as SpeechTelephonySynthesisResult, L as SpeechVoiceOption, M as SpeechSynthesisStreamRequest, N as SpeechSynthesisStreamResult, O as SpeechProviderResolveTalkConfigContext, S as SpeechProviderConfiguredContext, T as SpeechProviderPrepareSynthesisContext, _ as SpeechDirectiveTokenParseContext, j as SpeechSynthesisResult, k as SpeechProviderResolveTalkOverridesContext, v as SpeechDirectiveTokenParseResult, x as SpeechProviderConfig, y as SpeechListVoicesRequest } from "./tts-runtime.types-CB2-60c5.js";
import { n as DetachedTaskLifecycleRuntime } from "./detached-task-runtime-contract-iSLDk3y4.js";
import { c as EmbeddingProviderAdapter } from "./embedding-providers-DkT4Cx4A.js";
import { _ as ContextEngineRuntimeContext, g as ContextEnginePromptCacheInfo, l as ContextEngine, t as ContextEngineFactory, u as ContextEngineHostCapability } from "./registry-CddtAx6L.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-vGJaIOb6.js";
import { Ft as PluginNextTurnInjection, It as PluginNextTurnInjectionEnqueueResult, Jt as PluginConversationBindingRequestResult, Kt as PluginConversationBinding, Rt as PluginJsonValue, Xt as PluginConversationBindingResolvedEvent, et as PluginHookName, nn as PluginHookBeforeAgentStartResult, q as PluginHookHandlerMap, qt as PluginConversationBindingRequestParams, vt as PluginHookToolInputKind, yt as PluginHookToolKind } from "./hook-types-DEHbmiQj.js";
import { $o as OperatorScope, Bo as PluginSessionActionRegistration, Fo as PluginControlUiDescriptor, Go as PluginSessionExtensionRegistration, Ho as PluginSessionAttachmentParams, Io as PluginRunContextGetParams, Jo as PluginSessionTurnScheduleParams, Ko as PluginSessionSchedulerJobHandle, Lo as PluginRunContextPatch, Mo as PluginAgentEventEmitParams, No as PluginAgentEventEmitResult, Po as PluginAgentEventSubscriptionRegistration, Qo as PluginTrustedToolPolicyRegistration, Ro as PluginRuntimeLifecycleRegistration, Uo as PluginSessionAttachmentResult, Xo as PluginSessionTurnUnscheduleByTagResult, Yo as PluginSessionTurnUnscheduleByTagParams, Zo as PluginToolMetadataRegistration, qo as PluginSessionSchedulerJobRegistration } from "./index-DFDUKbHk.js";
import { n as ChannelPlugin } from "./types.public-DkG_i7qb.js";
import { n as GatewayRequestHandler } from "./types-DsHDS47m.js";
import { r as InternalHookHandler } from "./internal-hook-types-BwvTZGLB.js";
import { Vt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-CqEGq09I.js";
import { t as ProviderUsageSnapshot } from "./provider-usage.types-BGbkzahX.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-D_TXlqph.js";
...
declare function restoreRegisteredMemoryEmbeddingProviders(entries: RegisteredMemoryEmbeddingProvider[]): void;
declare function clearMemoryEmbeddingProviders(): void;
//#endregion
//#region src/agents/pi-embedded-runner/runtime.d.ts
type EmbeddedAgentRuntime = "pi" | "openclaw" | "auto" | (string & {});
...
//#endregion
export { OpenClawPluginService as $, ProviderThinkingProfile as $n, RealtimeVoiceToolCallEvent as $r, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, HookContext as Ai, ProviderResolvePromptOverlayContext as An, AgentToolResultMiddlewareHarness as Ar, ProviderAuthOptionBag as At, OpenClawPluginModule as B, MemoryEmbeddingBatchChunk as Bi, ProviderTransportTurnState as Bn, RealtimeVoiceBridgeCallbacks as Br, ProviderCatalogResult as Bt, OpenClawPluginApi as C, EmbeddedRunAttemptResult as Ci, ProviderReplaySanitizeMode as Cn, CliBackendThinkingLevel as Cr, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, AgentRuntimePlan as Di, ProviderResolveAuthProfileIdContext as Dn, AgentToolResultMiddleware as Dr, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, normalizeUsage as Ei, ProviderReplayToolCallIdMode as En, PluginTextTransforms as Er, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, runBeforeToolCallHook as Fi, ProviderRuntimeProviderConfig as Fn, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Fr, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, MemoryEmbeddingProviderCreateOptions as Gi, RealtimeVoiceProviderPlugin as Gn, RealtimeVoiceCloseReason as Gr, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, MemoryEmbeddingProvider as Hi, ProviderWebSocketSessionPolicy as Hn, RealtimeVoiceBridgeEvent as Hr, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, setBeforeToolCallDiagnosticsEnabled as Ii, ProviderSanitizeReplayHistoryContext as In, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as Ir, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, RegisteredMemoryEmbeddingProvider as Ji, UnifiedModelCatalogProviderContext as Jn, RealtimeVoiceProviderConfiguredContext as Jr, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, MemoryEmbeddingProviderCreateResult as Ki, SpeechProviderPlugin as Kn, RealtimeVoiceProviderCapabilities as Kr, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, wrapToolWithBeforeToolCallHook as Li, ProviderSystemPromptContributionContext as Ln, RealtimeVoiceAudioFormat as Lr, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, getBeforeToolCallPolicyDiagnosticState as Mi, ProviderResolveUsageAuthContext as Mn, AgentToolResultMiddlewareResult as Mr, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, hasBeforeToolCallPolicy as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, AgentToolResultMiddlewareRuntime as Nr, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, BuildAgentRuntimePlanParams as Oi, ProviderResolveDynamicModelContext as On, AgentToolResultMiddlewareContext as Or, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, isToolWrappedWithBeforeToolCallHook as Pi, ProviderResolvedUsageAuth as Pn, OpenClawAgentToolResult as Pr, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, restoreRegisteredMemoryEmbeddingProviders as Qi, ProviderThinkingPolicyContext as Qn, RealtimeVoiceTool as Qr, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, AgentHarnessTaskRuntimeScope as Ri, ProviderToolSchemaDiagnostic as Rn, RealtimeVoiceBargeInOptions as Rr, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, EmbeddedRunAttemptParams as Si, ProviderReplayPolicyContext as Sn, CliBackendResolveExecutionArgsContext as Sr, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, NormalizedUsage as Ti, ProviderReplaySessionState as Tn, PluginTextReplacement as Tr, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, MemoryEmbeddingProviderAdapter as Ui, ProviderWrapStreamFnContext as Un, RealtimeVoiceBrowserSession as Ur, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, MemoryEmbeddingBatchOptions as Vi, ProviderValidateReplayTurnsContext as Vn, RealtimeVoiceBridgeCreateRequest as Vr, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, MemoryEmbeddingProviderCallOptions as Wi, RealtimeTranscriptionProviderPlugin as Wn, RealtimeVoiceBrowserSessionCreateRequest as Wr, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, listRegisteredMemoryEmbeddingProviders as Xi, VideoGenerationProviderPlugin as Xn, RealtimeVoiceProviderResolveConfigContext as Xr, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, clearMemoryEmbeddingProviders as Yi, UnifiedModelCatalogProviderPlugin as Yn, RealtimeVoiceProviderId as Yr, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, registerMemoryEmbeddingProvider as Zi, ProviderDefaultThinkingPolicyContext as Zn, RealtimeVoiceRole as Zr, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, AgentHarnessSideQuestionParams as _i, ProviderPrepareRuntimeAuthContext as _n, CliBackendNormalizeConfigContext as _r, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeTranscriptionSession as ai, ProviderNormalizeToolSchemasContext as an, ProviderResolveSyntheticAuthContext as ar, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, AgentHarnessSupportContext as bi, ProviderReasoningOutputModeContext as bn, CliBackendPreparedExecution as br, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, ProviderSystemPromptContribution as ci, ProviderPlugin as cn, ProviderNormalizeConfigContext as cr, PluginCommandResult as ct, MigrationItemKind as d, AgentHarnessAttemptResult as di, ProviderPluginWizard as dn, CodexAppServerExtensionFactory as dr, PluginEmbeddingProvider as dt, RealtimeVoiceToolResultOptions as ei, ProviderModernModelPolicyContext as en, ProviderRuntimeModel as er, OpenClawPluginServiceContext as et, MigrationItemStatus as f, AgentHarnessCompactParams as fi, ProviderPluginWizardModelPicker as fn, CodexAppServerExtensionRuntime as fr, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, AgentHarnessResultClassification as gi, ProviderPrepareExtraParamsContext as gn, CliBackendNativeToolMode as gr, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, AgentHarnessResetParams as hi, ProviderPrepareDynamicModelContext as hn, CliBackendAuthEpochMode as hr, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeTranscriptionProviderResolveConfigContext as ii, ProviderNormalizeResolvedModelContext as in, ProviderResolveExternalOAuthProfilesContext as ir, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, ToolOutcomeObserver as ji, ProviderResolveTransportTurnStateContext as jn, AgentToolResultMiddlewareOptions as jr, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, BeforeToolCallPolicyDiagnosticState as ki, ProviderResolveNonInteractiveApiKeyParams as kn, AgentToolResultMiddlewareEvent as kr, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, AgentHarness as li, ProviderPluginCatalog as ln, ProviderResolveConfigApiKeyContext as lr, PluginConfigMigration as lt, MigrationProviderContext as m, AgentHarnessDeliveryDefaults as mi, ProviderPreferRuntimeResolvedModelContext as mn, CodexAppServerToolResultHandlerResult as mr, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeTranscriptionProviderConfiguredContext as ni, ProviderNonInteractiveApiKeyResult as nn, ProviderExternalOAuthProfile as nr, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, RealtimeTranscriptionSessionCallbacks as oi, ProviderNormalizeTransportContext as on, ProviderSyntheticAuthResult as or, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, AgentHarnessCompactResult as pi, ProviderPluginWizardSetup as pn, CodexAppServerToolResultEvent as pr, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, MemoryEmbeddingProviderRuntime as qi, TranscriptSourceProvider as qn, RealtimeVoiceProviderConfig as qr, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeTranscriptionProviderId as ri, ProviderNormalizeModelIdContext as rn, ProviderResolveExternalAuthProfilesContext as rr, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, RealtimeTranscriptionSessionCreateRequest as si, ProviderOAuthProfileIdRepair as sn, ProviderApplyConfigDefaultsContext as sr, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeTranscriptionProviderConfig as ti, ProviderNonInteractiveApiKeyCredentialParams as tn, ProviderExternalAuthProfile as tr, OpenClawPluginSessionApi as tt, MigrationItemAction as u, AgentHarnessAttemptParams as ui, ProviderPluginDiscovery as un, CodexAppServerExtensionContext as ur, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, AgentHarnessSideQuestionResult as vi, ProviderPreparedRuntimeAuth as vn, CliBackendPlugin as vr, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, PreemptiveCompactionRoute as wi, ProviderReplaySessionEntry as wn, CliBundleMcpMode as wr, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, CompactEmbeddedPiSessionParams as xi, ProviderReplayPolicy as xn, CliBackendResolveExecutionArgs as xr, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, AgentHarnessSupport as yi, ProviderReasoningOutputMode as yn, CliBackendPrepareExecutionContext as yr, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, resolveEmbeddedAgentRuntime as zi, ProviderTransformSystemPromptContext as zn, RealtimeVoiceBridge as zr, ProviderCatalogOrder as zt };