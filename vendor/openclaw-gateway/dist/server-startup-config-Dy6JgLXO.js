...
import { i as isNixMode } from "./paths-CQv1_CDw.js";
...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-BlARNTf3.js";
...
import { a as getActiveSecretsRuntimeSnapshot, l as setPreparedSecretsRuntimeSnapshotRefreshContext, o as getLiveSecretsRuntimeAuthStores, t as activateSecretsRuntimeSnapshotState } from "./runtime-state-CCyqNOzR.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-0hDKROo0.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-DBw8tWxq.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, o as resolveRefreshAgentDirs } from "./runtime-fast-path-DW5cIGn-.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-Di0PrW6i.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-BhQ3UdnH.js");
					...
					return await finishPreparedSnapshot(fastPath.snapshot, activationParams, { activateRuntimeSecretsSnapshot: (snapshot) => activateSecretsRuntimeSnapshotState({
						...
						refreshHandler: {
							...
							refresh: async ({ sourceConfig, includeAuthStoreRefs, preflightResult }) => {
								...
								const refreshed = coercePreflightSnapshot(preflightResult, sourceConfig) ?? await secretsRuntime.prepareSecretsRuntimeSnapshot({
									config: sourceConfig,
									env: fastPath.refreshContext.env,
									agentDirs: resolveRefreshAgentDirs(sourceConfig, fastPath.refreshContext),
									includeAuthStoreRefs: includeAuthStoreRefs ?? fastPath.refreshContext.includeAuthStoreRefs,
