...
import { f as pathScope } from "./fs-safe-JUdtLZkh.js";
import { p as resolveUserPath } from "./utils-B5r0V84N.js";
import { i as getRuntimeConfig } from "./io-BlARNTf3.js";
import { d as isImageProcessorUnavailableError, g as resizeToJpeg, l as getImageMetadata, o as buildImageResizeSideGrid, r as IMAGE_REDUCE_QUALITY_STEPS } from "./media-services-rb2QLp-y.js";
import { a as ensureMediaDir, u as saveMediaBuffer } from "./store-CkmEdlzm.js";
import "./string-coerce-runtime-qOd7_06l.js";
import { C as BrowserTabNotFoundError, E as toBrowserErrorResponse, L as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_AI_SNAPSHOT_MAX_CHARS, T as BrowserValidationError, W as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, _ as BrowserConflictError, b as BrowserProfileUnavailableError, d as parseBrowserHttpUrl, f as redactCdpUrl, n as assertCdpEndpointAllowed, p as withCdpSocket, v as BrowserError, w as BrowserTargetAmbiguousError, y as BrowserProfileNotFoundError } from "./cdp.helpers-TK-p0nR2.js";
import { a as DEFAULT_DOWNLOAD_DIR, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR } from "./config-ChFqwTWH.js";
import "./errors-DSXwEbUw.js";
import { i as isValidProfileName, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-D11avIMk.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-B83ker52.js";
import { t as movePathToTrash } from "./trash-DUbk2r6E.js";
import { n as normalizeString } from "./record-shared-CSP4p9a4.js";
import "./sdk-setup-tools-L0pdMJHg.js";
import { D as uploadChromeMcpFile, E as takeChromeMcpSnapshot, T as takeChromeMcpScreenshot, _ as navigateChromeMcpPage, a as closeChromeMcpTab, c as evaluateChromeMcpScript, f as getChromeMcpPid, l as fillChromeMcpElement, m as hoverChromeMcpElement, n as clickChromeMcpCoords, o as dragChromeMcpElement, r as clickChromeMcpElement, u as fillChromeMcpForm, x as resizeChromeMcpPage, y as pressChromeMcpKey } from "./chrome-mcp-D7raXa2f.js";
import { E as withBrowserNavigationPolicy, S as assertBrowserNavigationAllowed, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, b as resolveBrowserNavigationProxyMode, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, w as assertBrowserNavigationResultAllowed, y as ensureOutputDirectory } from "./chrome-BO50vsYp.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-HQWVvvJt.js";
import { c as ACT_MAX_CLICK_DELAY_MS, l as ACT_MAX_WAIT_TIME_MS, o as normalizeBrowserFormField, p as matchBrowserUrlPattern, r as getRoleSnapshotStats, u as normalizeActBoundedNonNegativeMs } from "./pw-role-snapshot-DbZq4sjl.js";
...
function resolveSnapshotPlan(params) {
	...
	return {
		...
		selectorValue,
		frameSelectorValue,
		timeoutMs: timeoutMsRaw !== void 0 && Number.isFinite(timeoutMsRaw) && timeoutMsRaw > 0 ? Math.max(1, Math.floor(timeoutMsRaw)) : void 0,
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-dw-cN6Sp.js");
