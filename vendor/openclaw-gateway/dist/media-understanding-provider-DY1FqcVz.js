...
import "./json-schema-runtime-CQLEgrLk.js";
import { i as FALLBACK_CODEX_MODELS, r as CODEX_PROVIDER_ID } from "./provider-catalog-DdDyatix.js";
import "./client-factory-B5I7lD3g.js";
import { l as resolveCodexAppServerRuntimeOptions } from "./config-ME2vVfAE.js";
...
import { r as readModelListResult } from "./models-D1PkD2KV.js";
import { l as isJsonObject } from "./client-D1m3kevQ.js";
import { r as buildCodexRuntimeThreadConfig } from "./thread-lifecycle-BSW5t26R.js";
...
async function runBoundedCodexVisionTurn(params) {
	...
	const client = params.options.clientFactory ? await params.options.clientFactory(appServer.start, params.profile) : await import("./shared-client-CbrZvr6T.js").then(({ createIsolatedCodexAppServerClient }) => createIsolatedCodexAppServerClient({
