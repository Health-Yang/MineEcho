...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-CwD1xLDF.js";
...
import { n as openUrl } from "./browser-open-DyI2pGXL.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BXpiSjzB.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-DBXtjZ0g.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DHLn4zdG.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CaoAMstS.js");
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BRtk1mlD.js");
