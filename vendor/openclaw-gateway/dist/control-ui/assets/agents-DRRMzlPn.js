import{f as e,i as t,p as n,t as r}from"./lit-runtime-DA0-mbwP.js";import{l as i,o as a,t as o}from"./string-coerce-Cl_fl99y.js";import{v as s}from"./markdown-runtime-2OdtbEyk.js";import{A as c,B as l,D as u,E as d,F as f,I as p,K as m,L as h,M as g,N as _,O as v,P as y,R as b,S as x,T as S,V as C,a as w,h as T,j as ee,k as te,n as ne,r as E,t as re,w as D,z as ie}from"./index-89Mm3xEP.js";import{r as O}from"./channel-config-extras-aRylKKxo.js";import{i as k,n as A,r as j,t as M}from"./skills-shared-Dslswc_Q.js";function ae(t){let{agent:r,configForm:i,agentFilesList:o,configLoading:s,configSaving:c,configDirty:l,onConfigReload:u,onConfigSave:m,onModelChange:v,onModelFallbacksChange:b,onSelectPanel:x}=t,S=!!(t.defaultId&&r.id===t.defaultId),C=_(i,r.id),w=r.model,T=(o&&o.agentId===r.id?o.workspace:null)||C.entry?.workspace||C.defaults?.workspace||r.workspace||`default`,te=C.entry?.model?p(C.entry?.model):C.defaults?.model?p(C.defaults?.model):p(w),ne=y(r.agentRuntime),E=p(C.defaults?.model??w),re=h(C.entry?.model),D=h(C.defaults?.model)||(E===`-`?null:ee(E))||(i?null:h(w)),ie=re??D??null,O=S?ie:re,k=f(C.entry?.model)??f(C.defaults?.model)??(i?null:f(w))??[],A=Array.isArray(C.entry?.skills)?C.entry?.skills:null,j=A?.length??null,M=!i||s||c,ae=e=>{let t=k.filter((t,n)=>n!==e);b(r.id,t)};return n`
    <section class="card">
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="agent-model-fields">
          <label class="field">
            <span>Primary model${S?` (default)`:``}</span>
            <select
              .value=${O??``}
              ?disabled=${M}
              @change=${e=>v(r.id,e.target.value||null)}
            >
              ${S?n` <option value="" ?selected=${!O}>Not set</option> `:n`
                    <option value="" ?selected=${!O}>
                      ${D?`Inherit default (${D})`:`Inherit default`}
                    </option>
                  `}
              ${d(i,ie??void 0,t.modelCatalog,O)}
            </select>
          </label>
          <div class="field">
            <span>Fallbacks</span>
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=g(t.value);n.length>0&&(b(r.id,[...k,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=g(t.value);n.length>0&&(b(r.id,[...k,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+q(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,ke($.defaults),$},$.getDefaults=Oe,$.defaults=I,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,ke($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Bt,$.TextRenderer=Vt,$.Lexer=Y,$.lexer=Y.lex,$.Tokenizer=zt,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,Y.lex;function Ht(e){let t=e.trim();return t?t.split(/\s+/).length:0}function Ut(e){return e.length===0?0:e.split(/\r?\n/).length}function Wt(e){return e<=0?a(`agents.files.emptyDraft`):a(`agents.files.minRead`,{count:String(Math.max(1,Math.round(e/220)))})}function Gt(e){let t=e.split(`.`).pop()?.trim().toLowerCase();return t===`md`||t===`markdown`?a(`agents.files.markdownPreview`):t?a(`agents.files.extensionPreview`,{ext:t.toUpperCase()}):a(`agents.files.preview`)}function Kt(e,t){let n=e.trim(),r=t?.trim();if(!n)return``;if(r&&n===r)return`.`;if(r&&n.startsWith(`${r}/`))return n.slice(r.length+1)||`.`;let i=n.split(/[\\/]+/);for(let e=i.length-1;e>=0;--e){let t=i[e];if(t)return t}return n}function qt(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`preview`}function Jt(e,t){if(!(e instanceof HTMLElement))return;let n=a(t?`agents.files.collapsePreview`:`agents.files.expandPreview`);e.classList.toggle(`is-fullscreen`,t),e.setAttribute(`aria-pressed`,String(t)),e.setAttribute(`aria-label`,n),e.setAttribute(`title`,n)}function Yt(e,t,r){return n`
    ...
    <section class="grid grid-cols-2">
      ...
      <section class="card">
        ...
        ${t.snapshot?e:n`
            ...
            `}
        ${r.length===0?n` <div class="muted" style="margin-top: 16px">${a(`agents.channels.empty`)}</div>`:n`
              <div class="list" style="margin-top: 16px;">
                ${r.map(r=>{let i=$t(r.accounts),o=i.total?a(`agents.channels.connectedCount`,{connected:String(i.connected),total:String(i.total)}):a(`agents.channels.noAccounts`),s=i.configured?a(`agents.channels.configuredCount`,{count:String(i.configured)}):a(`agents.channels.notConfigured`),c=i.total?a(`agents.channels.enabledCount`,{count:String(i.enabled)}):a(`common.disabled`),l=O({configForm:t.configForm,channelId:r.id,fields:Qt});return n`
                    <div class="list-item">
                      <div class="list-main">
                      ...
                      <div class="list-meta">
                        ...
                        ${i.configured===0?n`
                            ...
                            `:e}
                        ${l.length>0?l.map(e=>n`<div>${e.label}: ${e.value}</div>`):e}
                      </div>
                    </div>
                  `})}
              </div>
  ...
  `}function tn(t){let r=t.jobs.filter(e=>e.agentId===t.agentId);return n`
    <section class="grid grid-cols-2">
      ${Yt(t.context,a(`agents.context.schedulingSubtitle`),t.onSelectPanel)}
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          <div class="stat">
            ...
            <div class="stat-value">
              ${t.status?t.status.enabled?a(`common.yes`):a(`common.no`):a(`common.na`)}
            </div>
          </div>
          <div class="stat">
            <div class="stat-label">${a(`agents.cronPanel.jobs`)}</div>
            <div class="stat-value">${t.status?.jobs??a(`common.na`)}</div>
          </div>
          <div class="stat">
    ...
    <section class="card">
      ...
      ${r.length===0?n` <div class="muted" style="margin-top: 16px">${a(`agents.cronPanel.noJobs`)}</div>`:n`
            <div class="list" style="margin-top: 16px;">
              ${r.map(r=>n`
                  <div class="list-item">
                    <div class="list-main">
                      <div class="list-title">${r.name}</div>
                      ${r.description?n`<div class="list-sub">${r.description}</div>`:e}
                      <div class="chip-row" style="margin-top: 6px;">
                        <span class="chip">${ne(r)}</span>
                    ...
                    <div class="list-meta">
                      <div class="mono">${E(r)}</div>
                      <div class="muted">${re(r)}</div>
                      <button
                        class="btn btn--sm"
                        style="margin-top: 6px;"
                        ?disabled=${!r.enabled}
                        @click=${()=>t.onRunNow(r.id)}
                      >
  ...
  `}function nn(r){let i=r.agentFilesList?.agentId===r.agentId?r.agentFilesList:null,o=i?.files??[],c=r.agentFileActive??null,l=c?o.find(e=>e.name===c)??null:null,d=c?r.agentFileContents[c]??``:``,f=c?r.agentFileDrafts[c]??d:``,p=c?f!==d:!1,m=l?Ee($.parse(f,{gfm:!0,breaks:!0}),{sanitize:e=>s.sanitize(e)}):``,h=u(new TextEncoder().encode(f).length),g=Ht(f),_=Ut(f),v=l?Kt(l.path,i?.workspace):``,y=l?`agent-file-preview-title-${qt(l.name)}`:``,b=l?.missing?a(`agents.files.willCreateOnSave`):a(p?`agents.files.liveDraftPreview`:`agents.files.savedPreview`),S=l?.missing?`is-missing`:p?`is-dirty`:`is-synced`,C=l?.updatedAtMs?a(`agents.files.updated`,{time:x(l.updatedAtMs)}):l?.missing?a(`agents.files.notCreatedYet`):a(`agents.files.updatedUnknown`);return n`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
        ...
        <button
          class="btn btn--sm"
          ?disabled=${r.agentFilesLoading}
          @click=${()=>r.onLoadFiles(r.agentId)}
        >
          ${r.agentFilesLoading?a(`common.loading`):a(`common.refresh`)}
        </button>
      </div>
      ${i?n`<div class="muted mono" style="margin-top: 8px;">
            ${a(`agents.files.workspace`)}: <span>${i.workspace}</span>
          </div>`:e}
      ${r.agentFilesError?n`<div class="callout danger" style="margin-top: 12px;">
            ${r.agentFilesError}
          </div>`:e}
      ${i?o.length===0?n` <div class="muted" style="margin-top: 16px">${a(`agents.files.empty`)}</div> `:n`
              <div class="agent-tabs" style="margin-top: 14px;">
                ${o.map(t=>{let i=c===t.name,o=t.name.replace(/\.md$/i,``);return n`
                    <button
                      class="agent-tab ${i?`active`:``} ${t.missing?`agent-tab--missing`:``}"
                      @click=${()=>r.onSelectFile(t.name)}
                    >
                      ${o}${t.missing?n` <span class="agent-tab-badge">${a(`agents.files.missing`)}</span> `:e}
                    </button>
                  `})}
              </div>
              ${l?n`
                    <div class="agent-file-header" style="margin-top: 14px;">
                      ...
                      <div class="agent-file-actions">
                        ...
                        >
                          ${T.eye} ${a(`agents.files.preview`)}
                        </button>
                        <button
                          class="btn btn--sm"
                          ?disabled=${!p}
                          @click=${()=>r.onFileReset(l.name)}
                        >
                          ${a(`common.reset`)}
                        </button>
                        <button
                          class="btn btn--sm primary"
                          ?disabled=${r.agentFileSaving||!p}
                          @click=${()=>r.onFileSave(l.name)}
                        >
                          ${r.agentFileSaving?a(`common.saving`):a(`common.save`)}
                        </button>
                      </div>
                    </div>
                    ${l.missing?n`
                    ...
                    <label class="field agent-file-field" style="margin-top: 12px;">
                      ...
                      <textarea
                        ...
                        .value=${f}
                        @input=${e=>r.onFileDraftChange(l.name,e.target.value)}
                      ></textarea>
                    </label>
                    <dialog
                      ...
                      <div class="md-preview-dialog__panel">
                        <div class="md-preview-dialog__header">
                          ...
                          <div class="md-preview-dialog__actions">
                            ...
                            >
                              <span class="when-normal" aria-hidden="true">${T.maximize}</span
                            ...
                            >
                              <span aria-hidden="true">${T.x}</span>
                            </button>
                          </div>
                        </div>
                        <div class="md-preview-dialog__meta">
                          <div class="md-preview-dialog__chip ${S}">
                            <strong>${b}</strong>
                          </div>
                  ...
                  `:n` <div class="muted" style="margin-top: 16px">
  ...
  `}function rn(t){return t.length===0?e:n`
    <div class="agent-tool-badges">
      ${t.map(e=>n`<span class="agent-pill">${e}</span>`)}
    </div>
  `}function an(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId,i=[];return n===`plugin`&&r?i.push(`Plugin: ${r}`):n===`core`&&i.push(`Built-In`),t.optional&&i.push(`Optional`),i}function on(e){let t=an(e.section,e.tool);return e.activeEntry&&t.unshift(`Live Now`),t}function sn(e){return e.denied?`Disabled by agent override.`:e.allowed&&e.baseAllowed?`Enabled by the current profile.`:e.allowed?`Enabled by agent override.`:`Not included in the current profile.`}function cn(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId;return n===`plugin`&&r?`Plugin: ${r}`:`Built-In`}function ln(e){return e.denied?`Override Off`:e.allowed&&e.baseAllowed?`Enabled`:e.allowed?`Override On`:`Profile Off`}function un(e){return e.activeEntry?`Live Now`:e.runtimeSessionMatchesSelectedAgent?`Not Live`:`Other Agent`}function dn(e){return`agent-tool-${C(e).replace(/[^a-z0-9_-]+/g,`-`)}`}function fn(e,t,n=`${t}s`){return`${e} ${e===1?t:n}`}function pn(e){return(e??[]).flatMap(e=>e.tools)}var mn=12;function hn(e){let t=e.currentTarget;if(!(!(t instanceof HTMLDetailsElement)||t.open))for(let e of t.querySelectorAll(`.agent-tool-card[open]`))e.open=!1}function gn(e,t){let n=document.getElementById(t);if(!(n instanceof HTMLDetailsElement))return;e.preventDefault();let r=n.closest(`.agent-tools-group`);r&&(r.open=!0),n.open=!0;let i=new URL(window.location.href);i.hash=t,window.history.replaceState(null,``,i),requestAnimationFrame(()=>{let e=typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;n.scrollIntoView?.({block:`center`,behavior:e?`auto`:`smooth`}),n.querySelector(`summary`)?.focus()})}function _n(e){return e.source===`plugin`?e.pluginId?a(`agentTools.connectedSource`,{id:e.pluginId}):a(`agentTools.connected`):e.source===`channel`?e.channelId?a(`agentTools.channelSource`,{id:e.channelId}):a(`agentTools.channel`):a(`agentTools.builtIn`)}function vn(t){let r=_(t.configForm,t.agentId),i=r.entry?.tools??{},o=r.globalTools??{},s=i.profile??o.profile??`full`,c=ie(t.toolsCatalogResult),u=l(t.toolsCatalogResult),d=i.profile?`agent override`:o.profile?`global default`:`default`,f=Array.isArray(i.allow)&&i.allow.length>0,p=Array.isArray(o.allow)&&o.allow.length>0,m=!!t.configForm&&!t.configLoading&&!t.configSaving&&!f&&!(t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError),h=f?[]:Array.isArray(i.alsoAllow)?i.alsoAllow:[],g=f?[]:Array.isArray(i.deny)?i.deny:[],y=f?{allow:i.allow??[],deny:i.deny??[]}:b(s)??void 0,x=u.flatMap(e=>e.tools.map(e=>e.id)),S=e=>{let t=v(e,y),n=te(e,h),r=te(e,g);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},w=x.filter(e=>S(e).allowed).length,T=t.runtimeSessionMatchesSelectedAgent&&!t.toolsEffectiveError?pn(t.toolsEffectiveResult?.groups):[],ee=Array.from(new Map(T.map(e=>[C(e.id),e])).values()),ne=ee.slice(0,mn),E=Math.max(0,ee.length-ne.length),re=ee.length,D=new Map(T.map(e=>[C(e.id),e])),O=new Set(D.keys()),k=e=>e.toSorted((e,t)=>{let n=C(e.id),r=C(t.id),i=+!!O.has(n),a=+!!O.has(r);if(i!==a)return a-i;let o=+!!S(e.id).allowed,s=+!!S(t.id).allowed;return o===s?e.label.localeCompare(t.label):s-o}),A=(e,n)=>{let r=new Set(h.map(e=>C(e)).filter(e=>e.length>0)),i=new Set(g.map(e=>C(e)).filter(e=>e.length>0)),a=S(e).baseAllowed,o=C(e);n?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),t.onOverridesChange(t.agentId,[...r],[...i])},j=e=>{let n=new Set(h.map(e=>C(e)).filter(e=>e.length>0)),r=new Set(g.map(e=>C(e)).filter(e=>e.length>0));for(let t of x){let i=S(t).baseAllowed,a=C(t);e?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}t.onOverridesChange(t.agentId,[...n],[...r])};return n`
    <section class="card">
      <div class="agent-tools-header">
        <div class="agent-tools-header__intro">
          ...
          <div class="card-sub">
            ...
            <span class="mono">${w}/${x.length}</span> enabled.
          </div>
        </div>
        <div class="agent-tools-header__actions">
          <button class="btn btn--sm" ?disabled=${!m} @click=${()=>j(!0)}>
            Enable All
          </button>
          <button class="btn btn--sm" ?disabled=${!m} @click=${()=>j(!1)}>
            Disable All
          </button>
          <button
            class="btn btn--sm"
      ...
      ${p?n`
          ...
          `:e}
      ${t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError?n`
            <div class="callout info" style="margin-top: 12px">Loading runtime tool catalog…</div>
          `:e}
      ${t.toolsCatalogError?n`
            <div class="callout info" style="margin-top: 12px">
      ...
      <div class="agent-tools-overview">
        <div class="agent-tools-overview__primary">
          <div class="agent-tools-pane">
            ...
            ${t.runtimeSessionMatchesSelectedAgent?t.toolsEffectiveLoading&&!t.toolsEffectiveResult&&!t.toolsEffectiveError?n`
                    <div class="callout info" style="margin-top: 12px">
                      Loading available tools…
                    </div>
                  `:t.toolsEffectiveError?n`
                      <div class="callout info" style="margin-top: 12px">
                        Could not load available tools for this session.
                      </div>
                    `:(t.toolsEffectiveResult?.groups?.length??0)===0?n`
                        <div class="callout info" style="margin-top: 12px">
                          No tools are available for this session right now.
                        </div>
                      `:n`
                        <div class="agent-tools-runtime">
                          ${ne.map(e=>{let t=dn(e.id);return n`
                              <a
            ...
            <div class="agent-tools-buttons">
              ${c.map(e=>n`
                  <button
                    ...
                    ?disabled=${!m}
                    @click=${()=>t.onProfileChange(t.agentId,e.id,!0)}
                  >
                    ${e.label}
                  </button>
                `)}
      ...
      <div class="agent-tools-grid">
        ${u.map(r=>{let i=k(r.tools),a=r.tools.filter(e=>S(e.id).allowed).length,o=r.tools.filter(e=>O.has(C(e.id))).length,s=i.slice(0,4),c=Math.max(0,i.length-s.length);return n`
              ...
              <summary class="agent-tools-group__summary">
                <span class="agent-tools-group__summary-main">
                  <span class="agent-tools-group__title">
                    ${r.label}
                    ${r.source===`plugin`&&r.pluginId?n`<span class="agent-pill">Plugin: ${r.pluginId}</span>`:e}
                  </span>
                  <span class="agent-tools-group__preview" aria-label="Tool preview">
                    ${s.map(e=>n`<span class="mono" translate="no" title=${e.label}
                          >${e.label}</span
                        >`)}
                    ${c>0?n`<span>+${c} more</span>`:e}
                  </span>
                </span>
                <span class="agent-tools-group__counts">
                  <span>${fn(r.tools.length,`Tool`)}</span>
                  <span>${fn(a,`Enabled Tool`)}</span>
                  ${o>0?n`<span>${fn(o,`Live Tool`)}</span>`:e}
                </span>
              </summary>
              <div class="agent-tools-list agent-tools-list--stacked">
                ${i.map(i=>{let a=dn(i.id),o=S(i.id),s=D.get(C(i.id))??null,c=i.defaultProfiles??[],l=on({section:r,tool:i,activeEntry:s}),u=ln(o),d=un({activeEntry:s,runtimeSessionMatchesSelectedAgent:t.runtimeSessionMatchesSelectedAgent});return n`
                        ...
                        <div class="agent-tool-details-strip">
                          ...
                          ${c.length>0?n`
                                <div class="agent-tool-detail agent-tool-detail--inline">
                                  ...
                                  <div class="agent-tool-badges">
                                    ${c.map(e=>n`<span class="agent-pill">${e}</span>`)}
                                  </div>
                                </div>
                              `:e}
                          <div class="agent-tool-detail agent-tool-detail--inline">
                            ...
                            <div>
                              ${s?`Available now via ${_n(s)}.`:t.runtimeSessionMatchesSelectedAgent?`Not available in this chat session right now.`:`Switch chat to this agent to inspect live availability.`}
                            </div>
                          </div>
  ...
  `}function yn(t){let r=!!t.configForm&&!t.configLoading&&!t.configSaving,i=_(t.configForm,t.agentId),s=Array.isArray(i.entry?.skills)?i.entry?.skills:void 0,c=new Set(m(s??[])),l=s!==void 0,u=!!(t.report&&t.activeAgentId===t.agentId),d=u?t.report?.skills??[]:[],f=o(t.filter),p=f?d.filter(e=>o([e.name,e.description,e.source].join(` `)).includes(f)):d,h=k(p),g=l?d.filter(e=>c.has(e.name)).length:d.length,v=d.length;return n`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
          ...
          <div class="card-sub">
            ...
            ${v>0?n`<span class="mono">${g}/${v}</span>`:e}
          </div>
        </div>
      ...
      ${p.length===0?n` <div class="muted" style="margin-top: 16px">No skills found.</div> `:n`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${h.map(e=>bn(e,{agentId:t.agentId,allowSet:c,usingAllowlist:l,editable:r,onToggle:t.onToggle}))}
            </div>
          `}
    </section>
  `}function bn(e,t){return n`
    <details class="agent-skills-group" ?open=${!(e.id===`workspace`||e.id===`built-in`)}>
      ...
      <div class="list skills-grid">
        ${e.skills.map(e=>xn(e,{agentId:t.agentId,allowSet:t.allowSet,usingAllowlist:t.usingAllowlist,editable:t.editable,onToggle:t.onToggle}))}
      </div>
    </details>
  `}function xn(t,r){let i=r.usingAllowlist?r.allowSet.has(t.name):!0,a=M(t),o=A(t);return n`
    <div class="list-item agent-skill-row">
      <div class="list-main">
        <div class="list-title">${t.emoji?`${t.emoji} `:``}${t.name}</div>
        <div class="list-sub">${t.description}</div>
        ${j({skill:t})}
        ${a.length>0?n`<div class="muted" style="margin-top: 6px;">Missing: ${a.join(`, `)}</div>`:e}
        ${o.length>0?n`<div class="muted" style="margin-top: 6px;">Reason: ${o.join(`, `)}</div>`:e}
      </div>
      <div class="list-meta">
        <label class="cfg-toggle">
          <input
            ...
            .checked=${i}
            ?disabled=${!r.editable}
            @change=${e=>r.onToggle(r.agentId,t.name,e.target.checked)}
          />
          <span class="cfg-toggle__track"></span>
        </label>
      </div>
    </div>
  `}function Sn(t){let i=t.agentsList?.agents??[],o=t.agentsList?.defaultId??null,s=t.selectedAgentId??o??i[0]?.id??null,l=s?i.find(e=>e.id===s)??null:null,u=s&&t.agentSkills.agentId===s?t.agentSkills.report?.skills?.length??null:null,d=t.channels.snapshot?Object.keys(t.channels.snapshot.channelAccounts??{}).length:null,f=s?t.cron.jobs.filter(e=>e.agentId===s).length:null,p={files:t.agentFiles.list?.files?.length??null,skills:u,channels:d,cron:f||null};return n`
      ...
      <section class="agents-toolbar">
        <div class="agents-toolbar-row">
          <div class="agents-control-select">
            ...
            >
              ${i.length===0?n` <option value="">${a(`agents.noAgents`)}</option> `:i.map(e=>n`
                      <option value=${e.id} ?selected=${e.id===s}>
                        ${c(e)}${D(e.id,o)?` (${D(e.id,o)})`:``}
                      </option>
                    `)}
            </select>
          </div>
          <div class="agents-toolbar-actions">
            ${l?n`
                  <button
                    ...
                    @click=${()=>void navigator.clipboard.writeText(l.id)}
                  ...
                  <button
                    ...
                    class="btn btn--sm btn--ghost"
                    ?disabled=${!!(o&&l.id===o)}
                    @click=${()=>t.onSetDefault(l.id)}
                    title=${o&&l.id===o?a(`agents.alreadyDefaultTitle`):a(`agents.setDefaultTitle`)}
                  >
                    ${o&&l.id===o?a(`agents.default`):a(`agents.setDefault`)}
                  </button>
                `:e}
            <button
        ...
        ${t.error?n`<div class="callout danger" style="margin-top: 8px;">${t.error}</div>`:e}
      </section>
      <section class="agents-main">
        ${l?n`
              ${Cn(t.activePanel,e=>t.onSelectPanel(e),p)}
              ${t.activePanel===`overview`?r(l.id,ae({agent:l,basePath:t.basePath,defaultId:o,configForm:t.config.form,agentFilesList:t.agentFiles.list,agentIdentity:t.agentIdentityById[l.id]??null,agentIdentityError:t.agentIdentityError,agentIdentityLoading:t.agentIdentityLoading,configLoading:t.config.loading,configSaving:t.config.saving,configDirty:t.config.dirty,modelCatalog:t.modelCatalog,onConfigReload:t.onConfigReload,onConfigSave:t.onConfigSave,onModelChange:t.onModelChange,onModelFallbacksChange:t.onModelFallbacksChange,onSelectPanel:t.onSelectPanel})):e}
              ${t.activePanel===`files`?nn({agentId:l.id,agentFilesList:t.agentFiles.list,agentFilesLoading:t.agentFiles.loading,agentFilesError:t.agentFiles.error,agentFileActive:t.agentFiles.active,agentFileContents:t.agentFiles.contents,agentFileDrafts:t.agentFiles.drafts,agentFileSaving:t.agentFiles.saving,onLoadFiles:t.onLoadFiles,onSelectFile:t.onSelectFile,onFileDraftChange:t.onFileDraftChange,onFileReset:t.onFileReset,onFileSave:t.onFileSave}):e}
              ${t.activePanel===`tools`?vn({agentId:l.id,configForm:t.config.form,configLoading:t.config.loading,configSaving:t.config.saving,configDirty:t.config.dirty,toolsCatalogLoading:t.toolsCatalog.loading,toolsCatalogError:t.toolsCatalog.error,toolsCatalogResult:t.toolsCatalog.result,toolsEffectiveLoading:t.toolsEffective.loading,toolsEffectiveError:t.toolsEffective.error,toolsEffectiveResult:t.toolsEffective.result,runtimeSessionKey:t.runtimeSessionKey,runtimeSessionMatchesSelectedAgent:t.runtimeSessionMatchesSelectedAgent,onProfileChange:t.onToolsProfileChange,onOverridesChange:t.onToolsOverridesChange,onConfigReload:t.onConfigReload,onConfigSave:t.onConfigSave}):e}
              ${t.activePanel===`skills`?yn({agentId:l.id,report:t.agentSkills.report,loading:t.agentSkills.loading,error:t.agentSkills.error,activeAgentId:t.agentSkills.agentId,configForm:t.config.form,configLoading:t.config.loading,configSaving:t.config.saving,configDirty:t.config.dirty,filter:t.agentSkills.filter,onFilterChange:t.onSkillsFilterChange,onRefresh:t.onSkillsRefresh,onToggle:t.onAgentSkillToggle,onClear:t.onAgentSkillsClear,onDisableAll:t.onAgentSkillsDisableAll,onConfigReload:t.onConfigReload,onConfigSave:t.onConfigSave}):e}
              ${t.activePanel===`channels`?en({context:S(l,t.config.form,t.agentFiles.list,o,t.agentIdentityById[l.id]??null),configForm:t.config.form,snapshot:t.channels.snapshot,loading:t.channels.loading,error:t.channels.error,lastSuccess:t.channels.lastSuccess,onRefresh:t.onChannelsRefresh,onSelectPanel:t.onSelectPanel}):e}
              ${t.activePanel===`cron`?tn({context:S(l,t.config.form,t.agentFiles.list,o,t.agentIdentityById[l.id]??null),agentId:l.id,jobs:t.cron.jobs,status:t.cron.status,loading:t.cron.loading,error:t.cron.error,onRefresh:t.onCronRefresh,onRunNow:t.onCronRunNow,onSelectPanel:t.onSelectPanel}):e}
            `:n`
              <div class="card">
  ...
  `}function Cn(t,r,i){return n`
    <div class="agent-tabs">
      ${[{id:`overview`,label:a(`agents.tabs.overview`)},{id:`files`,label:a(`agents.tabs.files`)},{id:`tools`,label:a(`agents.tabs.tools`)},{id:`skills`,label:a(`agents.tabs.skills`)},{id:`channels`,label:a(`agents.tabs.channels`)},{id:`cron`,label:a(`agents.tabs.cronJobs`)}].map(a=>n`
          <button
            class="agent-tab ${t===a.id?`active`:``}"
            type="button"
            @click=${()=>r(a.id)}
          >
            ${a.label}${i[a.id]==null?e:n`<span class="agent-tab-count">${i[a.id]}</span>`}
          </button>
        `)}
    </div>
  `}export{Sn as renderAgents};
//# sourceMappingURL=agents-DRRMzlPn.js.map