...
import { s as resolveConfigPath, y as resolveStateDir } from "./paths-CQv1_CDw.js";
...
import { t as DEFAULT_AGENT_ID } from "./session-key-yaI3D3Bl.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DV6oZsbJ.js";
import { i as resolveSandboxConfigForAgent } from "./config-DTzdayJb.js";
import { l as isInterpreterLikeAllowlistPattern } from "./risks-CYZU6_fX.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-BDxhjUKW.js";
...
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-D7XM5Ot2.js";
...
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-DV2wL4Jd.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-Dq0gsJUk.js";
...
async function loadReadOnlyChannelPlugins() {
	readOnlyChannelPluginsModulePromise ??= import("./read-only-BwzWnMSv.js");
...
function findClaudeCliBackendConfig(backends) {
	...
	for (const [key, backend] of Object.entries(backends)) if (normalizeProviderId(key) === "claude-cli") return backend;
}
