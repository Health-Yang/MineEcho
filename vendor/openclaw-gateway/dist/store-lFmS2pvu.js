...
import { _ as resolveOAuthDir, v as resolveOAuthPath, y as resolveStateDir } from "./paths-CQv1_CDw.js";
...
import { d as normalizeSecretInputString, o as coerceSecretRef } from "./types.secrets-CtRQ27Ls.js";
import { r as normalizeProviderId } from "./provider-id-nh-uBdZ_.js";
import { t as asFiniteNumber } from "./number-coercion-CZ-2BQ9V.js";
import { n as saveJsonFile, t as loadJsonFile } from "./json-file-DTvSUa2e.js";
...
import { a as replaceRuntimeAuthProfileStoreSnapshots$1, i as hasRuntimeAuthProfileStoreSnapshot, n as getRuntimeAuthProfileStoreSnapshot, o as setRuntimeAuthProfileStoreSnapshot, s as cloneAuthProfileStore, t as clearRuntimeAuthProfileStoreSnapshots$1 } from "./runtime-snapshots-DOjW6jJR.js";
import { a as resolveLegacyAuthStorePath, r as resolveAuthStorePath, t as resolveAuthStatePath } from "./path-resolve-DsZZvktq.js";
import { a as MINIMAX_CLI_PROFILE_ID, c as OPENAI_CODEX_DEFAULT_PROFILE_ID, i as EXTERNAL_CLI_SYNC_TTL_MS, l as log$1, n as CLAUDE_CLI_PROFILE_ID, t as AUTH_STORE_LOCK_OPTIONS } from "./constants-0i5hheAU.js";
import { S as resolveExternalAuthProfilesWithPlugins } from "./provider-runtime-CGENk1Ok.js";
import { t as ensureAuthStoreFile } from "./paths-BHBcS2M8.js";
import { t as asBoolean } from "./boolean-CZag3-H2.js";
import { n as readCachedAuthProfileStore, r as writeCachedAuthProfileStore, t as clearLoadedAuthStoreCache } from "./store-cache-DDUV_77R.js";
import "./source-check-D-qOGbI1.js";
...
function emitKeychainOnlyMigrationHintOnce(profileId) {
	...
	log$1.warn("Legacy Codex OAuth credentials are stored only in macOS Keychain on this host. Headless paths cannot prompt for Keychain access; run `openclaw doctor --fix` from an interactive terminal to migrate them back to inline auth-profiles.json credentials.", { profileId });
}
...
//#endregion
export { shouldReplaceStoredOAuthCredential as A, readManagedExternalCliCredential as C, isSafeToAdoptBootstrapOAuthIdentity as D, hasUsableOAuthCredential as E, readClaudeCliCredentialsCached as F, readCodexCliCredentialsCached as I, readGeminiCliCredentialsCached as L, evaluateStoredCredentialEligibility as M, hasUsableOAuthCredential$1 as N, isSafeToAdoptMainStoreOAuthIdentity as O, resolveTokenExpiryState as P, readExternalCliFallbackCredential as S, hasMatchingOAuthIdentity as T, isLegacyOAuthRef as _, findPersistedAuthProfileCredential as a, loadLegacyOAuthSidecarMaterial as b, loadAuthProfileStoreForSecretsRuntime as c, resolvePersistedAuthProfileOwnerAgentDir as d, saveAuthProfileStore as f, loadPersistedAuthProfileStore as g, coercePersistedAuthProfileStore as h, ensureAuthProfileStoreWithoutExternalProfiles as i, DEFAULT_OAUTH_REFRESH_MARGIN_MS as j, shouldBootstrapFromExternalCliCredential as k, loadAuthProfileStoreWithoutExternalProfiles as l, buildPersistedAuthProfileSecretsStore as m, ensureAuthProfileStore as n, loadAuthProfileStore as o, updateAuthProfileStoreWithLock as p, ensureAuthProfileStoreForLocalUpdate as r, loadAuthProfileStoreForRuntime as s, clearRuntimeAuthProfileStoreSnapshots as t, replaceRuntimeAuthProfileStoreSnapshots as u, isLegacyOAuthSidecarPayload as v, areOAuthCredentialsEquivalent as w, resolveLegacyOAuthSidecarPath as x, legacyOAuthSidecarTestUtils as y };
