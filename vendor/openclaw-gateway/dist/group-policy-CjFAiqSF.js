...
import { c as jsonResult, f as readNumberParam, g as readStringParam, i as createActionGate, p as readReactionParams } from "./common-BooMjDNL.js";
...
import { n as IMESSAGE_ACTIONS, r as IMESSAGE_ACTION_NAMES, t as describeIMessageMessageTool } from "./message-tool-api-ChfCUx-T.js";
import "./client-bpCbHKc9.js";
import { t as getCachedIMessagePrivateApiStatus } from "./private-api-status-hXzk6Zzf.js";
import { c as parseIMessageTarget } from "./targets-BQLF_yw-.js";
import { r as rememberIMessageReplyCache, t as findLatestIMessageEntryForChat } from "./monitor-reply-cache-CT4PzuVs.js";
import "./probe-CrhccjPS.js";
//#region extensions/imessage/src/actions.ts
const loadIMessageActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-D8X1k7uw.js"), "imessageActionsRuntime");
	...
	handleAction: async ({ action, params, cfg, accountId, toolContext }) => {
		...
		const assertPrivateApiEnabled = async () => {
			if (privateApiStatus?.available !== true) {
				const { probeIMessagePrivateApi } = await import("./probe-DTaZkVT_.js");
