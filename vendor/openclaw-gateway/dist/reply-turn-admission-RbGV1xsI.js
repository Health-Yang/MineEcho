...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-CudANNo3.js";
...
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { l as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-D_ZjwTES.js";
import { u as resolveOpenAIRuntimeProviderForPi } from "./openai-codex-routing-CnBPb3N4.js";
...
import { b as resolveGroupSessionKey, u as updateSessionStore } from "./store-B5j4GKkg.js";
...
import { l as resolvePersistedOverrideModelRef } from "./model-selection-DF4MbMUd.js";
import { d as sanitizeUserFacingText, i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE } from "./sanitize-user-facing-text-BHbpuv3O.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-BO6PBwHx.js";
...
import { d as logSessionTurnCreated } from "./diagnostic-BDsaMZfL.js";
...
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-mi4zS0hh.js";
import { d as isContextOverflowError, g as isLikelyContextOverflowError, u as isCompactionFailureError, y as isTransientHttpError } from "./errors-DuGAmFy8.js";
...
import { l as resolveCliRuntimeExecutionProvider, s as listLegacyRuntimeModelProviderAliases } from "./model-runtime-aliases-DXHvPXsy.js";
import "./selection-C4e-Qn9W.js";
...
import { L as isMessagingToolSendAction } from "./attempt.tool-run-context-TMML7ez9.js";
import { p as parseReplyDirectives } from "./payloads-BSIGv16L.js";
import { a as runWithModelFallback, c as LiveSessionModelSwitchError, t as isFallbackSummaryError } from "./model-fallback--w47Y_pS.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-CcGfjIYt.js";
...
import { n as buildAgentRuntimeOutcomePlan } from "./build-Dyj3J0Vc.js";
import { i as resolveSilentReplyPolicy, n as isReplyProfilerEnabled, r as resolveCurrentTurnImages } from "./reply-timing-tracker-K6eWTXRB.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CltXvVte.js";
import { t as runCliAgent } from "./cli-runner-tzUho6Xj.js";
...
import { n as createBlockReplyContentKey } from "./block-reply-pipeline-B4EyBBJL.js";
			...
			run: async (provider, model, runOptions) => {
				...
				const { sessionRuntimeOverride, cliExecutionProvider } = agentTurnTiming.measureSync("fallback_resolve_runtime", () => {
					...
					return {
						...
						cliExecutionProvider: resolvedSessionRuntimeOverride === "pi" ? provider : (resolvedSessionRuntimeOverride && isCliProvider(resolvedSessionRuntimeOverride, runtimeConfig) ? resolvedSessionRuntimeOverride : void 0) ?? resolveCliRuntimeExecutionProvider({
							provider,
							cfg: runtimeConfig,
							agentId: params.followupRun.run.agentId,
							modelId: model,
				...
				return (async () => {
					...
					try {
						...
						const result = await agentTurnTiming.measure("embedded_run", () => runEmbeddedPiAgent({
							...embeddedContext,
...
//#endregion
export { resolveSessionRuntimeOverrideForProvider as a, runCliAgentWithLifecycle as c, resolveRunAfterAutoFallbackPrimaryProbeRecheck as i, resolveReplyTurnKind as n, runAgentTurnWithFallback as o, buildKnownAgentRunFailureReplyPayload as r, normalizeReplyPayloadDirectives as s, admitReplyTurn as t };
