...
declare function fetchConfiguredLocalOriginWithSsrFGuard({
  configuredLocalOriginBaseUrl,
  ...params
}: GuardedFetchConfiguredLocalOriginOptions): Promise<GuardedFetchResult>;
//#endregion
export { fetchConfiguredLocalOriginWithSsrFGuard as a, withStrictGuardedFetchMode as c, GuardedFetchResult as i, withTrustedEnvProxyGuardedFetchMode as l, GuardedFetchMode as n, fetchWithSsrFGuard as o, GuardedFetchOptions as r, retainSafeHeadersForCrossOriginRedirectHeaders as s, GUARDED_FETCH_MODE as t, withTrustedExplicitProxyGuardedFetchMode as u };