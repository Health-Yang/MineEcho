...
import { i as formatLookupMiss } from "./error-format-ZFU1PhmU.js";
import { S as pruneStaleEntries, t as loadSessionStore } from "./store-load-Di_AfnVx.js";
...
import { A as deleteTaskFlowRecordById, D as updateTaskNotifyPolicyById, H as updateFlowRecordByIdExpectedRevision, I as listTaskFlowRecords, P as getTaskFlowById, m as listTasksForFlowId, s as getTaskById } from "./task-registry-B2oVolww.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-BwpoHlXv.js";
import "./runtime-internal-DvzGU0Fr.js";
import { t as cancelDetachedTaskRunById } from "./task-executor-DCw5dRWs.js";
import { i as resolveCronStorePath, n as loadCronStoreSync } from "./store-Dd-tb17i.js";
import { a as summarizeTaskAuditFindings, i as summarizeRetainedLostTaskAuditFindings, n as listTaskAuditFindings } from "./task-registry.audit-Z_ZqEQCW.js";
import { a as getInspectableTaskRegistrySummary, c as previewTaskRegistryMaintenance, i as getInspectableTaskAuditSummary, l as reconcileInspectableTasks, p as runTaskRegistryMaintenance, s as getTaskRegistryMaintenanceDiagnostics, t as configureTaskRegistryMaintenance, u as reconcileTaskLookupToken } from "./task-registry.maintenance-BrckPBoY.js";
import { n as listTaskFlowAuditFindings, r as summarizeTaskFlowAuditFindings, t as buildTaskSystemAuditFindings } from "./tasks-audit-system-BDtbBlHw.js";
...
async function tasksMaintenanceCommand(opts, runtime) {
	...
	if (retainedLostAfter.count > 0) runtime.log(info(`Retained lost tasks: ${retainedLostAfter.count} retained until ${retainedLostAfter.nextCleanupAfter ? new Date(retainedLostAfter.nextCleanupAfter).toISOString() : "cleanupAfter"}; maintenance will prune after cleanupAfter.`));
