...
async function loadAgentCliCommand() {
	return (await import("./agent-via-gateway-BDchs9k_.js")).agentCliCommand;
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-B8cf7x0j.js")).agentsAddCommand;
}
async function loadAgentsBindCommand() {
	return (await import("./agents.commands.bind-CYOOvFk9.js")).agentsBindCommand;
}
async function loadAgentsBindingsCommand() {
	return (await import("./agents.commands.bind-CYOOvFk9.js")).agentsBindingsCommand;
}
async function loadAgentsUnbindCommand() {
	return (await import("./agents.commands.bind-CYOOvFk9.js")).agentsUnbindCommand;
}
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-Ba9UwNKW.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-BbdVJm-q.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-CGhV2Wu1.js")).agentsListCommand;
}
async function loadCreateDefaultDeps() {
	return (await import("./deps-DomsiLn4.js")).createDefaultDeps;
}
