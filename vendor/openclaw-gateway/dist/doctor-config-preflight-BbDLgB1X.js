...
import { f as resolveHomeDir } from "./utils-B5r0V84N.js";
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-BlARNTf3.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { t as note } from "./note-C22zwxbl.js";
import { r as noteIncludeConfinementWarning } from "./doctor-config-analysis-DeGjsqpJ.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-B0c3vGuV.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-D4lfsb9b.js");
