...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-BsfWgA0I.js";
...
import { m as sanitizeAgentId, p as resolveThreadSessionKeys, r as buildAgentMainSessionKey } from "./session-key-yaI3D3Bl.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BfxErZq2.js";
import { t as createNonExitingRuntime } from "./runtime-yzlkhCoS.js";
import { r as getChildLogger } from "./logger-xjL_xnHy.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-DZ-ifL5z.js";
...
import { n as mutateConfigFile } from "./mutate-CxD4vMnm.js";
import { u as fireAndForgetHook } from "./hook-runner-global-CjzahG2G.js";
...
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-DZXdqwOo.js";
import { P as resolveSessionStoreEntry } from "./store-load-Di_AfnVx.js";
import { u as updateSessionStore } from "./store-B5j4GKkg.js";
import { d as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-DxGLLD67.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-cdgltU-p.js";
...
import { i as isExplicitCommandTurn } from "./command-turn-context-Cqhb6nXp.js";
...
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-ye5B62pZ.js";
...
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-Cic-rjWp.js";
...
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-CF5xczph.js";
import { n as MediaFetchError } from "./fetch-C_mdbFEd.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-D6qfvE07.js";
import { t as resolveAckReaction } from "./identity-BFeakJ9C.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-B3ut6ovI.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-D9iphjyK.js";
...
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-lrMOhQXC.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-Brl2piP4.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Dqn1ebZ6.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-Cx6g3XKE.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-DfPJQFtF.js";
...
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-BhctI43w.js";
...
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-CvpRi92u.js";
...
import "./config-mutation-QvIbhDJM.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-CDfA5slF.js";
import "./reply-chunking-MZjv6icV.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-Cyw7nhJQ.js";
import { o as createMessageReceiveContext } from "./channel-outbound-DuRkxH3q.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Dr3f0mtP.js";
import "./runtime-config-snapshot-Dqpmi9u5.js";
import "./model-session-runtime-BFuHqjP7.js";
import "./media-runtime-BndVydhQ.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-BJ9sblon.js";
import "./conversation-runtime-lk48Xn3h.js";
import "./text-chunking-CWOBXxG4.js";
import "./agent-runtime-BrG2cky1.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-B34TJs0o.js";
import "./security-runtime-SX8TzrnK.js";
import "./agent-harness-runtime-BFJ9rqEd.js";
import "./hook-runtime-DcihP_30.js";
import "./channel-mention-gating-SYhaNsUS.js";
import "./markdown-table-runtime-D0twI-Sd.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-DFEisKKp.js";
...
import { n as formatModelsAvailableHeader } from "./commands-models-C6O6StZ4.js";
import "./command-auth-native-BNjLa7IR.js";
import "./command-primitives-runtime-CQCwkBpn.js";
import "./command-status-FXs-nLk9.js";
import "./command-detection-CoKu7zKe.js";
import "./command-surface-MOva__US.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-DCx_VUbe.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-BMv7lXQV.js";
import "./channel-ingress-runtime-DiD_0kO1.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BQ_p8VVd.js";
import { t as loadSessionStore } from "./session-store-runtime-w-H-NASb.js";
import { t as createClaimableDedupe } from "./persistent-dedupe-VkBV7ovp.js";
import "./models-provider-runtime-txmWhPlK.js";
import "./skill-commands-runtime-BXfuK_wP.js";
import "./native-command-config-runtime-oYe-usYI.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-C_ZhcPiL.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-Bj4f--pA.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BiFNs5Sh.js";
import { A as resolveTelegramReplyId, C as resolveTelegramBotHasTopicsEnabled, D as resolveTelegramForumThreadId, E as resolveTelegramForumFlag, F as buildSenderLabel, G as expandTelegramAllowFromWithAccessGroups, H as renderTelegramTextEntities, I as buildSenderName, J as normalizeAllowFrom, K as resolveTelegramDmAllow, L as extractTelegramLocation, M as resolveTelegramThreadSpec, N as shouldUseTelegramDmThreadSession, O as resolveTelegramGroupAllowFromContext, P as withResolvedTelegramForumFlag, R as getTelegramTextParts, T as resolveTelegramDirectPeerId, V as normalizeForwardedContext, W as resolveTelegramPrimaryMedia, X as resolveTelegramEffectiveDmPolicy, Y as normalizeDmAllowFromWithStore, _ as buildTypingThreadParams, a as createTelegramMessageCache, b as isTelegramCommandsAllowFromConfigured, d as buildTelegramGroupFrom, f as buildTelegramGroupPeerId, g as buildTelegramThreadParams, h as buildTelegramRoutingTarget, i as buildTelegramReplyChain, j as resolveTelegramStreamMode, k as resolveTelegramMessageForumFlagHint, l as TelegramPairingStoreReadError, m as buildTelegramParentPeer, p as buildTelegramInboundOriginTarget, q as isSenderAllowed, r as buildTelegramConversationContext, s as resolveTelegramMessageCachePath, u as buildGroupLabel, v as describeReplyTarget, w as resolveTelegramCommandAuthorization, x as loadTelegramPairingStoreIfNeeded, y as extractTelegramForumFlag, z as hasBotMention } from "./message-cache-CwsZzz1b.js";
import { t as resolveTelegramInlineButtons } from "./button-types-2wGRZKBe.js";
import { a as renderTelegramHtmlText, n as markdownToTelegramChunks } from "./format-J75sUhHZ.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-Dg-k6KpC.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-BwE_w-au.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-GC-oxF9T.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-BU4Cxdlg.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-eGWaYRQb.js";
import { A as getOrCreateAccountThrottler, C as asTelegramClientFetch, D as resolveTelegramOutboundClientTimeoutFloorSeconds, E as resolveTelegramClientTimeoutSeconds, M as apiThrottler, N as sequentialize, S as buildInlineKeyboard, T as resolveTelegramClientTimeoutMinimumSeconds, a as editMessageTelegram, g as recordSentMessage, j as Bot, k as withTelegramApiErrorLogging, w as createTelegramClientFetch, x as recordOutboundMessageForPromptContext } from "./send-C2dmqXHG.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-Dn5p-zgq.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-BK1MnlUu.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-Dv_zL-pr.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-BC7Embai.js");
...
function resolveDispatchTelegramContext(params) {
	...
	if (threadSpec === params.context.threadSpec || threadSpec.scope !== "forum") return params.context;
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BESqSm-j.js")).defaultTelegramBotDeps;
									...
									deliver: async (payload, info) => {
										...
										for (const segment of segments) {
											...
											if (segment.lane === "answer" && info.kind === "tool") {
												...
												if (canRepresentAsTransientProgress && streamMode === "progress" && answerLane.stream) continue;
												await prepareAnswerLaneForToolProgress();
											}
											...
											if (info.kind === "final") await emitPreviewFinalizedHook(result);
