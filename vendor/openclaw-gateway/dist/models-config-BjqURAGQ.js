...
import { a as createConfigRuntimeEnv } from "./state-dir-dotenv-BrGdeAwo.js";
...
import { c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir } from "./agent-scope-config-BfxErZq2.js";
...
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-DKunDhdX.js";
...
import { i as getRuntimeConfig, s as projectConfigOntoRuntimeSourceSnapshot } from "./io-BlARNTf3.js";
...
import { h as resolveOwningPluginIdsForProvider } from "./plugin-auto-enable-CWrd66LC.js";
import { E as resolveProviderConfigApiKeyWithPlugin, m as normalizeProviderConfigWithPlugin, n as applyProviderNativeStreamingUsageCompatWithPlugin } from "./provider-runtime-CGENk1Ok.js";
import { n as ensureAuthProfileStore } from "./store-lFmS2pvu.js";
import { f as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-BuXkxoPc.js";
import { g as resolveNonEnvSecretRefHeaderValueMarker, h as resolveNonEnvSecretRefApiKeyMarker, m as resolveEnvSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-BxvoYSZo.js";
import { a as runProviderStaticCatalog, i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-BrQR1AsV.js";
import { a as normalizeHeaderValues, c as resolveMissingProviderApiKey, i as normalizeConfiguredProviderApiKey, n as createProviderAuthResolver, o as normalizeResolvedEnvApiKey, s as resolveApiKeyFromProfiles, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-Ulzq2N3I.js";
...
async function resolvePluginImplicitProviders(ctx, providers, order) {
	...
	for (const provider of byOrder[order]) {
		...
		const result = ctx.providerDiscoveryEntriesOnly === true && provider.staticCatalog ? await runProviderStaticCatalog({
			provider,
			config: catalogConfig,
