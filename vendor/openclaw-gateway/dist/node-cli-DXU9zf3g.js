...
import { n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, s as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-Bw8YdiuF.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-fxgOq8OC.js";
...
import { f as resolveApprovalAuditTrustPath, m as resolveCommandResolutionFromArgv, w as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-DV6oZsbJ.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-BZ2rj2l2.js";
import "./config-BtNBbhZb.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-ZFU1PhmU.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-C7Bcq3eA.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BOx8Uavc.js";
import { t as parsePort } from "./parse-port-BkxG8hjZ.js";
...
import { n as GatewayClient } from "./client-D_fPrX3v.js";
import { t as ConnectErrorDetailCodes } from "./connect-error-details-Co08hq5R.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-m_Q1TDFZ.js";
...
import "./exec-wrapper-resolution-DMo9rajN.js";
import { c as describeInterpreterInlineEval } from "./risks-CYZU6_fX.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-DzyDSIpj.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-BDxhjUKW.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DW9-Jxq4.js";
import { t as formatHelpExamples } from "./help-format-DXVAk021.js";
import { n as detectPolicyInlineEval } from "./policy-Z0zw-8i4.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-ByhmoDQa.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-Dte0g1_j.js";
import { t as resolveNodeService } from "./node-service-XrKMxWhh.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-DGTbTAuF.js");
