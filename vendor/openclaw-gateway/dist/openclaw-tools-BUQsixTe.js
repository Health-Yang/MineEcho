...
import { l as redactToolPayloadText } from "./redact-9hVaCauP.js";
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-B1vnNUyG.js";
import { o as isRecord, r as asOptionalObjectRecord } from "./record-coerce-Btbek4uV.js";
import { i as formatErrorMessage } from "./errors-BsfWgA0I.js";
import { t as createLazyImportLoader } from "./lazy-promise-Djskx0qC.js";
import { _ as uniqueStrings, g as sortUniqueStrings, v as uniqueValues } from "./string-normalization-B8G0vlWE.js";
import { m as FsSafeError } from "./path-BlG8lhgR.js";
import { A as canonicalPathFromExistingAncestor, S as hasEncodedFileUrlSeparator, T as trySafeFileURLToPath } from "./fs-safe-JUdtLZkh.js";
import { a as root } from "./secure-temp-dir-XAWcZnE2.js";
import { h as isWindowsDrivePath } from "./archive-CdsVsET0.js";
import { c as isRecord$1, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-B5r0V84N.js";
import { n as findNormalizedProviderValue, r as normalizeProviderId } from "./provider-id-nh-uBdZ_.js";
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-C697EEaR.js";
import { _ as resolveSessionAgentId, a as resolveAgentEffectiveModelPrimary, o as resolveAgentExecutionContract, v as resolveSessionAgentIds } from "./agent-scope-CudANNo3.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey, r as isCronRunSessionKey, u as parseThreadSessionSuffix } from "./session-key-utils-AmKO9Roj.js";
import { n as normalizeAccountId } from "./account-id-B0YIFDpA.js";
import { c as isValidAgentId, d as resolveAgentIdFromSessionKey, l as normalizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, v as toAgentStoreSessionKey } from "./session-key-yaI3D3Bl.js";
...
import { i as resolveManifestContractOwnerPluginId, y as getCurrentPluginMetadataSnapshot } from "./plugin-registry-BALJ9TgI.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-BtpHXlhR.js";
import { t as privateFileStore } from "./private-file-store-DUBa54Tt.js";
import { t as createSubsystemLogger } from "./subsystem-1gTaEPwP.js";
import { t as logDebug } from "./logger-Bcz1IQSW.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BlARNTf3.js";
import { n as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-DRIYGASz.js";
import { n as modelKey } from "./model-ref-shared-CwD1xLDF.js";
import { t as applyMergePatch } from "./merge-patch-BKbUL9Ms.js";
import { p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-DKulK0JL.js";
...
import { n as isRestartEnabled } from "./commands.flags-Jvw1brW1.js";
import { o as normalizeChannelId } from "./registry-49GbU2k5.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BxgIUTRt.js";
import { i as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-NW6lw3Ys.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-Co08hq5R.js";
import { r as annotateInterSessionPromptText } from "./input-provenance-D_ZjwTES.js";
import "./operator-scopes-DGvgHuOd.js";
import { r as isAdminOnlyMethod } from "./method-scopes-BnJ64Q8O.js";
import { r as callGateway } from "./call-D_O83KsN.js";
import { p as scheduleGatewaySigusr1Restart } from "./restart-BMCHYmJL.js";
import { i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-BhX2UsCC.js";
import { h as synthesizeMediaGenerationCatalogEntries, m as listMediaGenerationProviderModels } from "./loader-ChBMT90m.js";
import { k as listRegisteredPluginAgentPromptGuidance } from "./command-registration-DKP4-Wk7.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-yG8tB5AA.js";
import { t as SsrFBlockedError } from "./ssrf-DcS_PaqX.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CjzahG2G.js";
import { a as resolveContextEngine } from "./registry-DxH_0Os-.js";
import { i as hasInternalHookListeners, m as triggerInternalHook } from "./internal-hooks-CeA6cnAD.js";
...
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-D3ilNvO8.js";
import { h as stringifyRouteThreadId } from "./channel-route-Dvehdg4D.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-B9zntlj0.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-DZXdqwOo.js";
import { D as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-Di_AfnVx.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Be8exPcf.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BACvRceP.js";
import { u as updateSessionStore } from "./store-B5j4GKkg.js";
import "./plugins-BGmuVWWz.js";
import { n as mergeSessionEntry } from "./types-D7s3-R_6.js";
import { t as extractDeliveryInfo } from "./delivery-info-xWCUU9hC.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DppuT-pZ.js";
import "./sessions-Ct4mpWsk.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-CGENk1Ok.js";
import { i as buildModelAliasIndex, x as resolveModelRefFromString } from "./model-selection-shared-BuXkxoPc.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-l_jinpMc.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BjqURAGQ.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-aCWhd_zB.js";
import { p as resolveSubagentSpawnModelSelection, s as resolveDefaultModelForAgent } from "./model-selection-DF4MbMUd.js";
...
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-B2oVolww.js";
import { n as extractTextFromChatContent } from "./chat-content-BNTcXm1Z.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-2wJnWxyF.js";
import "./runtime-internal-DvzGU0Fr.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BOScrQoy.js";
import { d as queueEmbeddedPiMessageWithOutcomeAsync, i as formatEmbeddedPiQueueFailureSummary, m as resolveActiveEmbeddedRunSessionId } from "./runs-p1TN18LG.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-BpOBzvOi.js";
import { f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes, x as jsonUtf8Bytes } from "./session-utils.fs-D_Qde0sG.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CoyiWxvX.js";
import { _ as resolveSessionModelIdentityRef, m as resolveGatewaySessionStoreTarget, n as deriveSessionTitle, u as pruneLegacyStoreKeys } from "./session-utils-CmwnszsS.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-DePW2OSL.js";
import { S as describeUpdatePlanTool, _ as describeSessionStatusTool, b as describeSessionsSendTool, d as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, f as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, g as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, h as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, m as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, p as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, s as CRON_TOOL_DISPLAY_SUMMARY, u as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, v as describeSessionsHistoryTool, x as describeSessionsSpawnTool, y as describeSessionsListTool } from "./tool-catalog-Bxn5jw8h.js";
import "./tool-policy-CY4w5sXw.js";
...
import { a as resolveSubagentCapabilities, c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, l as findAcpUnsupportedInheritedToolDeny, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CeOcBGcI.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BHGQ7y-R.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-BO5sRfPm.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-UfWLr3a3.js";
import { a as resolvePluginTools } from "./tools-Ciw2IILF.js";
import { t as canonicalizeBase64 } from "./base64-D03BM6T6.js";
import { l as getImageMetadata } from "./media-services-rb2QLp-y.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images--Qb2n-mo.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BCy4bTc9.js";
import { D as listChannelSupportedActions, T as listAllChannelSupportedActions, h as wrapToolWithBeforeToolCallHook, l as isToolWrappedWithBeforeToolCallHook } from "./pi-tools.before-tool-call-BEgB-RpB.js";
...
import { c as jsonResult, f as readNumberParam, g as readStringParam$1, l as normalizeToolModelOverride, m as readStringArrayParam, n as ToolInputError, r as asToolParamsRecord, y as readSnakeCaseParamRaw } from "./common-BooMjDNL.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-WWlz8UU2.js";
import "./auth-profiles-BqdzLfrX.js";
import { n as resolveApiKeyForProfile } from "./oauth-BjbnMzpU.js";
import { n as listProfilesForProvider } from "./profile-list-CYDPCn6S.js";
import { i as resolveAuthProfileOrder } from "./order-Df4RKtkA.js";
import { a as getCustomProviderApiKey, i as getApiKeyForModel } from "./model-auth-DEXDfJh7.js";
import { c as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-r0bvLe6M.js";
import "./pi-bundle-mcp-tools-Dx9OBYuL.js";
import { g as mediaUrlsFromGeneratedAttachments, h as formatGeneratedAttachmentLines, i as loadSessionEntryByKey, t as deliverSubagentAnnouncement, u as formatAgentInternalEventsForPrompt } from "./subagent-announce-delivery-DK-Ub9gW.js";
import { n as extractAssistantText } from "./pi-embedded-utils-Co_Vyn6I.js";
import { i as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback--w47Y_pS.js";
import "./delivery-context-DMGHXaoo.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BgXXPpNN.js";
import { a as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CCyqNOzR.js";
import { n as createTranscriptsTool, r as resolveTranscriptsConfig } from "./transcripts-tool-DjkJsjBh.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-CboDitAF.js";
import { a as resolveSpawnedWorkspaceInheritance, n as mapToolContextToSpawnedRunMetadata, o as resolveSubagentAllowedTargetIds, r as normalizeSpawnedRunMetadata, s as resolveSubagentTargetPolicy, t as resolveRequesterOriginForChild } from "./spawn-requester-origin-DRzgz0AK.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DH2sN7dl.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-DGYm_6bU.js";
import { r as stripToolMessages } from "./chat-history-text-BUSxe-g7.js";
import { c as resolveCronCreationDelivery, t as normalizeHttpWebhookUrl } from "./webhook-url-Bch1Wp-U.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-BZxiuyCR.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-ClZNIJau.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Dv4nxjit.js";
import { a as normalizeDurationToClosestMax, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, p as throwCapabilityGenerationFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-PyiD84A7.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BSAiBPyQ.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-icyhwXhC.js";
...
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CWwsLZO_.js";
import { i as normalizeInboundPathRoots } from "./inbound-path-policy-DEbcUBWg.js";
import { r as getDefaultLocalRoots } from "./local-media-access-BLpt3hx9.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-rVREwwzk.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-F9sI0NBZ.js";
import { a as hasProviderAuthForTool, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-3EkwrMQ1.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CZ_wh5_j.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-jGpIhksC.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-BW3nHwRY.js";
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-DmfFElQ5.js";
import { n as normalizeMediaProviderId } from "./provider-id-G438zoYW.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CPIahe2_.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DJQhxkgx.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CQe_3Ls7.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-xgbd-uNN.js";
import { s as resolveTimeoutMs } from "./resolve-D2ot8x6-.js";
import "./media-understanding-Dy8I26Ln.js";
import { a as resolveBundledStaticCatalogModel, i as bundledStaticCatalogProviderUsesRuntimeAugment, n as resolveModelAsync } from "./model-D1xkjWU8.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-C4tgSG2t.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-ufNpKgWJ.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CC7zWwhc.js";
import { a as POLL_CREATION_PARAM_DEFS, i as stripFormattedReasoningMessage, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, r as resolveAllowedMessageActions, t as getToolResult } from "./message-action-runner-3Mr0o4wi.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-BD4054a9.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BEOIjx2Q.js";
import { t as parseTimeoutMs } from "./parse-timeout-Dy07gDgv.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-Dds_kWB0.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-1wEmOXrF.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-Cj-9oVO_.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-jsF3RKPy.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BI6tRq9Y.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-CTaFNJ2U.js";
import { i as resolveNestedAgentLaneForSession, t as AGENT_LANE_SUBAGENT } from "./lanes-ReZ09_e4.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DO7Iqhxb.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-Ce77h8ss.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-lrMOhQXC.js";
import { p as registerSubagentRun, r as countActiveRunsForSession } from "./subagent-registry-J8FQ56_P.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-CrY3-yco.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-QXgo5JGG.js";
...
import { n as buildSubagentList } from "./subagent-list--KX0rj4A.js";
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-B3qodcg-.js";
import { k as textToSpeech } from "./tts-runtime-DJIgAVUc.js";
import "./tts-Bcr0yUeq.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-czgsaKdz.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-DZ5VgTjb.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-De9O9_DK.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-DjKXXY5B.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-n7LUcc7B.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-pZDHsjC4.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-Cc3zrgzI.js";
import { i as runWebSearch } from "./runtime-KbtzJr_A.js";
import "./web-search-provider-common-DIMW2VWH.js";
...
function normalizeMutationPathLikeUpstreamWrite(pathParam) {
...
function resolveFileMutationPath(root, pathParam) {
...
function readWriteToolParams(params) {
	const record = getToolParamsRecord(params);
	return {
		pathParam: readStringParam(record, "path", "file_path", "filePath", "filepath", "file"),
		content: typeof record?.content === "string" ? record.content : void 0
	};
}
...
function buildWriteSuccessResult(pathParam, content) {
	return {
		isError: false,
		content: [{
			type: "text",
...
async function readOriginalWriteState(absolutePath, content, options) {
	if (!options.statFile) return { state: "unknown" };
	...
	if (stat.size !== contentBytes) return {
		state: "different",
		beforeStat: stat
	};
	if (stat.size > WRITE_PRECHECK_READ_LIMIT_BYTES) return {
		state: "unknown",
		beforeStat: stat
	};
	try {
		return {
			state: await options.readFile(absolutePath) === content ? "same" : "different",
			beforeStat: stat
		};
	} catch {
		return {
...
async function didWriteMetadataChange(absolutePath, beforeStat, options) {
	if (!beforeStat || !options.statFile) return false;
	let afterStat;
	try {
...
function wrapEditToolWithRecovery(base, options) {
	return {
		...
		execute: async (toolCallId, params, signal, onUpdate) => {
			...
			const absolutePath = typeof pathParam === "string" ? resolveFileMutationPath(options.root, pathParam) : void 0;
			let originalContent;
...
*/
function wrapWriteToolWithRecovery(base, options) {
	return {
		...base,
		execute: async (toolCallId, params, signal, onUpdate) => {
			const { pathParam, content } = readWriteToolParams(params);
			const absolutePath = typeof pathParam === "string" && typeof content === "string" ? resolveFileMutationPath(options.root, pathParam) : void 0;
			const precheck = absolutePath && typeof content === "string" ? await readOriginalWriteState(absolutePath, content, options) : { state: "unknown" };
			try {
				return await base.execute(toolCallId, params, signal, onUpdate);
			} catch (err) {
				if (!isWriteRecoveryCandidate(err, signal) || typeof absolutePath !== "string" || typeof pathParam !== "string" || typeof content !== "string") throw err;
				let currentContent;
				try {
					currentContent = await options.readFile(absolutePath);
				} catch {}
				const changed = precheck.state === "different" || precheck.state === "unknown" && await didWriteMetadataChange(absolutePath, precheck.beforeStat, options);
				if (currentContent === content && changed) return buildWriteSuccessResult(pathParam, content);
				throw err;
			}
		}
	};
...
function createSandboxedWriteTool(params) {
	return wrapToolParamValidation(wrapWriteToolWithRecovery(createWriteTool(params.root, { operations: createSandboxWriteOperations(params) }), {
		root: params.root,
...
function createHostWorkspaceWriteTool(root, options) {
	return wrapToolParamValidation(wrapWriteToolWithRecovery(createWriteTool(root, { operations: createHostWriteOperations(root, options) }), {
		root,
		readFile: (absolutePath) => fs$1.readFile(absolutePath, "utf-8"),
		statFile: async (absolutePath) => {
			let stat;
			try {
				stat = await fs$1.stat(absolutePath);
			} catch (err) {
...
async function tryDeliverMediaGenerationFailureDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-BAP2Xw9P.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-r-1q-YVn.js");
}
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-D695uQ5B.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-CHAszD8e.js");
...
async function startAgentRun(params) {
	try {
		...
		if (activeRunSessionId && fallbackSessionKey && messageText) {
			...
			let queueOutcome = await queueEmbeddedPiMessageWithOutcomeAsync(activeRunSessionId, messageText, queueOptions);
			if (!queueOutcome.queued && queueOutcome.reason === "transcript_commit_wait_unsupported") {
				...
				queueOutcome = await queueEmbeddedPiMessageWithOutcomeAsync(activeRunSessionId, messageText, bestEffortQueueOptions);
			}
			...
			try {
				...
				const queueSummary = formatEmbeddedPiQueueFailureSummary(queueOutcome) ?? "active run queue rejected";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-B0uikOPb.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-8ee1VkR0.js"));
...
//#endregion
export { stripProviderPrefix as C, isParentOwnedBackgroundAcpSession as D, setEmbeddedMode as E, isStrictAgenticSupportedProviderModel as S, isEmbeddedMode as T, wrapToolWorkspaceRootGuard as _, generateMusic as a, resolveOpenClawPluginToolsForOptions as b, buildActiveImageGenerationTaskPromptContextForSession as c, createHostWorkspaceWriteTool as d, createOpenClawReadTool as f, wrapToolMemoryFlushAppendOnlyWrite as g, createSandboxedWriteTool as h, buildActiveMusicGenerationTaskPromptContextForSession as i, findActiveSessionTask as l, createSandboxedReadTool as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, createSandboxedEditTool as p, triggerSessionPatchHook as r, listSupportedMusicGenerationModes as s, createOpenClawTools as t, createHostWorkspaceEditTool as u, wrapToolWorkspaceRootGuardWithOptions as v, REQUIRED_PARAM_GROUPS as w, isStrictAgenticExecutionContractActive as x, sniffMimeFromBase64 as y };
