...
import { N as SessionSendPolicyAction, P as SessionSendPolicyConfig, t as AgentElevatedAllowFromConfig } from "./types.base-DFyTixvq.js";
import { n as ConfiguredProviderRequest } from "./types.provider-request-C3q5IfeY.js";
...
type ExecToolConfig = {
  /** Exec host routing (default: auto). */host?: "auto" | "sandbox" | "gateway" | "node"; /** Exec security mode (default: full; sandbox host defaults to deny). */
