...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-BfxErZq2.js";
...
import { p as normalizeThinkLevel } from "./thinking-DKulK0JL.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-Dq-Us-KM.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-DGvgHuOd.js";
import { r as callGateway, u as randomIdempotencyKey } from "./call-D_O83KsN.js";
import { E as registerMemoryEmbeddingProvider, w as listMemoryEmbeddingProviders } from "./loader-ChBMT90m.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DppuT-pZ.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-lFmS2pvu.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-DF4MbMUd.js";
import { n as loadModelCatalog } from "./model-catalog-D4xiPrTf.js";
import { l as getImageMetadata, s as convertHeicToJpeg } from "./media-services-rb2QLp-y.js";
...
import { t as buildExplicitSessionIdSessionKey } from "./session-D_iBBJQp.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-CQe_3Ls7.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-CC7zWwhc.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsPersona, d as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsProvider, u as listSpeechVoices, w as setTtsPersona } from "./tts-runtime-DJIgAVUc.js";
import "./tts-Bcr0yUeq.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-De9O9_DK.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-KbtzJr_A.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DRDZYvBl.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-CqmJB1hs.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CsIXN6vZ.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-BO68mL93.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CZ6hioKm.js";
...
import { t as collectOption } from "./helpers-DLIOLl7Z.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-Bed3XYZn.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-BIfjwldf.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-wL8kxNqY.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-Cq1-2maA.js");
