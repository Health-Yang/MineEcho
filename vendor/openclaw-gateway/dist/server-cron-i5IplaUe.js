...
import { a as isSubagentSessionKey, c as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-AmKO9Roj.js";
import { d as resolveAgentIdFromSessionKey, f as resolveEventSessionKey, l as normalizeAgentId, v as toAgentStoreSessionKey } from "./session-key-yaI3D3Bl.js";
...
import { i as getRuntimeConfig, z as resolveCronMaxConcurrentRuns } from "./io-BlARNTf3.js";
...
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-896o98eb.js";
...
import { t as archiveRemovedSessionTranscripts, u as updateSessionStore } from "./store-B5j4GKkg.js";
...
import { a as failTaskRunByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BOScrQoy.js";
import { t as abortAndDrainEmbeddedPiRun } from "./runs-p1TN18LG.js";
import "./session-utils.fs-D_Qde0sG.js";
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-A8IXCaWE.js";
...
import { s as resolveFailoverReasonFromError } from "./failover-error-wBZizcCn.js";
import { a as summarizeCronRunDiagnostics, i as normalizeCronRunDiagnostics, n as createCronRunDiagnosticsFromError } from "./run-diagnostics-b2gqBBla.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-CGtDW323.js";
import { a as saveCronStore, i as resolveCronStorePath, o as cronSchedulingInputsEqual, r as loadCronStoreWithConfigJobs } from "./store-Dd-tb17i.js";
import { r as resolveMainScopedEventSessionKey } from "./event-session-routing-BV_pYWUi.js";
import { a as resolveCronDeliverySessionKey, o as resolveCronNotificationSessionKey, r as isInvalidCronSessionTargetIdError, s as resolveCronSessionTargetSessionKey, t as normalizeHttpWebhookUrl } from "./webhook-url-Bch1Wp-U.js";
import { n as normalizeOptionalAgentId } from "./normalize-BeEpz-n8.js";
import { n as normalizeCronJobInput } from "./normalize-BZxiuyCR.js";
import { t as buildOutboundSessionContext } from "./session-context-BklLDvOT.js";
import { t as sendDurableMessageBatch } from "./send-y6Pn3hrc.js";
import "./runtime-CzzF-KF1.js";
import "./pi-embedded-DHh5YEOO.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CuUPFHIR.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-RJBYmQkt.js";
...
function hasUnsupportedStringPayloadKind(candidate) {
	const payload = candidate.payload;
	if (!isRecord(payload)) return false;
	const kind = payload.kind;
	return typeof kind === "string" && kind.trim() !== "" && kind !== "systemEvent" && kind !== "agentTurn";
}
...
async function ensureLoaded(state, opts) {
	...
	const jobs = [];
	const preservedInvalidPersistedJobs = [];
	for (const [index, job] of loadedJobs.entries()) {
		...
		if (invalidReason) {
			if (invalidReason === "invalid-payload" && hasUnsupportedStringPayloadKind(rawConfigJob)) preservedInvalidPersistedJobs.push({
				index,
				job: rawConfigJob
			});
