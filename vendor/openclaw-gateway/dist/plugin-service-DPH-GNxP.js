...
import { p as resolveExistingPathsWithinRoot } from "./fs-safe-JUdtLZkh.js";
import { i as getRuntimeConfig } from "./io-BlARNTf3.js";
import { Ii as ErrorCodes, Li as errorShape } from "./protocol-BkfNT2Bp.js";
import { c as jsonResult, g as readStringParam, s as imageResultFromFile } from "./common-BooMjDNL.js";
import { t as callGatewayTool } from "./gateway-WWlz8UU2.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-1wEmOXrF.js";
import { i as wrapExternalContent } from "./external-content-DjKXXY5B.js";
import "./string-coerce-runtime-qOd7_06l.js";
import { n as startLazyPluginServiceModule } from "./plugin-runtime-B34TJs0o.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-7dlnrPMy.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-pWq0E7xD.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-DXUf-iIC.js";
import { n as withTimeout } from "./sdk-security-runtime-Dqw5_35t.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-TK-p0nR2.js";
...
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-DTvU7Zc7.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-CtHStyXP.js";
import { r as getBrowserProfileCapabilities } from "./target-id-HQWVvvJt.js";
...
async function executeSnapshotAction(params) {
	...
	const snapshotTimeoutMs = normalizePositiveTimeoutMs(input.timeoutMs) ?? 2e4;
	const snapshotQuery = {
		...format ? { format } : {},
		targetId,
		limit,
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-GefxbDV9.js"),
