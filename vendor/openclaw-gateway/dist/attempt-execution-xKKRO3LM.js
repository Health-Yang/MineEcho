...
import { c as readErrorName } from "./errors-BsfWgA0I.js";
...
import { a as resolveSessionTranscriptFile, i as readTailAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-DxGLLD67.js";
...
import { r as formatAcpErrorChain } from "./errors-CInk1Uju.js";
import { t as FailoverError } from "./failover-error-wBZizcCn.js";
import { l as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DXHvPXsy.js";
import { at as appendUserTurnTranscriptMessage, dt as buildUsageWithNoCost, n as resolveAvailableAgentHarnessPolicy } from "./selection-C4e-Qn9W.js";
...
import { t as normalizeReplyPayload } from "./normalize-reply-DAoXiiEx.js";
import "./skills-AlUGzl4g.js";
import { r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-BwvOVpab.js";
...
import { n as persistSessionEntry } from "./run-context-B6eKqAFL.js";
import { i as resolveFallbackRetryPrompt, n as claudeCliSessionTranscriptHasContent, t as buildClaudeCliFallbackContextPrelude } from "./attempt-execution.helpers-DDq1oO2F.js";
import { t as clearCliSessionInStore } from "./session-store-C4u6Buay.js";
...
async function persistTextTurnTranscript(params) {
	...
	try {
		...
		if (userMessage || promptText) await appendUserTurnTranscriptMessage({
			...
			...userMessage ? { message: userMessage } : { input: {
				text: promptText,
				timestamp: Date.now()
			} },
			updateMode: "none"
