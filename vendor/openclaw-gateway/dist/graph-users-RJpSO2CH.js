...
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, u as normalizeResolvedSecretInputString } from "./types.secrets-CtRQ27Ls.js";
import { n as privateFileStoreSync } from "./private-file-store-DUBa54Tt.js";
import { u as isPrivateIpAddress } from "./ssrf-DcS_PaqX.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-BJ6AORAh.js";
import "./ssrf-runtime-C8F9j9mo.js";
import "./security-runtime-SX8TzrnK.js";
import "./provider-http-CDs6F6rL.js";
import { t as getMSTeamsRuntime } from "./runtime-api-8IP8gIq_.js";
import { n as refreshMSTeamsDelegatedTokens } from "./oauth.token-DPu5u7kG.js";
...
async function loadMSTeamsSdk() {
	msTeamsSdkPromise ??= Promise.all([import("./dist-Cd1tflIV.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-DO1SU6jG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([appsModule, apiModule]) => ({
		App: appsModule.App,
...
//#endregion
export { isAllowedBotFrameworkServiceUrl as A, extractInlineImageCandidates as B, buildUserAgent as C, formatUnknownError as D, formatMSTeamsSendErrorHint as E, IMG_SRC_RE as F, normalizeContentType as G, isDownloadableAttachment as H, applyAuthorizationHeaderForUrl as I, resolveMediaSsrfPolicy as J, readNestedString as K, encodeGraphShareId as L, tryNormalizeBotFrameworkServiceUrl as M, ATTACHMENT_TAG_RE as N, isRevokedProxyError as O, GRAPH_ROOT as P, tryBuildGraphSharesUrlForSharedLink as Q, estimateBase64DecodedBytes as R, loadMSTeamsSdkWithAuth as S, classifyMSTeamsSendError as T, isLikelyImageAttachment as U, inferPlaceholder as V, isUrlAllowed as W, safeFetchWithPolicy as X, resolveRequestUrl as Y, safeHostForUrl as Z, resolveMSTeamsStorePath as _, fetchGraphJson as a, createMSTeamsAdapter as b, normalizeQuery as c, postGraphJson as d, resolveGraphToken as f, saveDelegatedTokens as g, resolveMSTeamsCredentials as h, fetchGraphAbsoluteUrl as i, normalizeBotFrameworkServiceUrl as j, describeBotFrameworkServiceUrlHost as k, patchGraphJson as l, loadDelegatedTokens as m, deleteGraphRequest as n, listChannelsForTeam as o, hasConfiguredMSTeamsCredentials as p, resolveAttachmentFetchPolicy as q, escapeOData as r, listTeamsByName as s, searchGraphUsers as t, postGraphBetaJson as u, readAccessToken as v, ensureUserAgentHeader as w, createMSTeamsTokenProvider as x, createBotFrameworkJwtValidator as y, extractHtmlFromAttachment as z };
