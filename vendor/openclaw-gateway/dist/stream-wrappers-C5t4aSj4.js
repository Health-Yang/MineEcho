import { a as normalizeLowercaseStringOrEmpty, i as normalizeFastMode, p as readStringValue } from "./string-coerce-DKw2K5wM.js";
...
import { n as createAnthropicThinkingPrefillPayloadWrapper, t as composeProviderStreamWrappers, y as stripTrailingAnthropicAssistantPrefillWhenThinking } from "./provider-stream-shared-B1wEfslJ.js";
...
function mergeAnthropicBetaHeader(headers, betas) {
	...
	const values = uniqueStrings([...existingKey ? parseHeaderList(merged[existingKey]) : [], ...betas]);
...
function createAnthropicBetaHeadersWrapper(baseStreamFn, betas) {
	...
	return (model, context, options) => {
		...
		const allBetas = uniqueStrings([...isOauth ? PI_AI_OAUTH_ANTHROPIC_BETAS : PI_AI_DEFAULT_ANTHROPIC_BETAS, ...effectiveBetas]);
