...
import { a as isSubagentSessionKey, i as isCronSessionKey, l as parseRawSessionConversationRef } from "./session-key-utils-AmKO9Roj.js";
import { d as resolveSelectedOpenAIPiRuntimeProvider } from "./openai-codex-routing-CnBPb3N4.js";
import { g as drainPluginNextTurnInjectionContext } from "./loader-ChBMT90m.js";
import { c as joinPresentTextSegments } from "./hook-runner-global-CjzahG2G.js";
import { N as buildPluginAgentTurnPrepareContext } from "./runtime-B5Ug58ea.js";
import { n as derivePromptTokens } from "./usage-Detu9Td-.js";
import { c as buildActiveImageGenerationTaskPromptContextForSession, i as buildActiveMusicGenerationTaskPromptContextForSession, n as buildActiveVideoGenerationTaskPromptContextForSession } from "./openclaw-tools-BUQsixTe.js";
import { l as listRunningSessions } from "./bash-process-registry-DU_0t2zf.js";
import { o as deriveSessionName } from "./bash-tools.shared-CWGWJRLL.js";
...
import { c as resolveEffectiveToolFsWorkspaceOnly } from "./local-roots-D6qfvE07.js";
import { n as normalizeStructuredPromptSection } from "./prompt-cache-stability-BpSRjx-n.js";
import { n as prependSystemPromptAdditionAfterCacheBoundary } from "./system-prompt-cache-boundary-JukSqUUt.js";
import { t as hasOpenAICompatibleConversationTurn } from "./openai-compatible-conversation-turn-DeJLw3P5.js";
import { t as resolveBoundAgentIdForSession } from "./session-agent-binding-NnF3aOCw.js";
...
function resolveEmbeddedCompactionTarget(params) {
	...
	const resolveRuntimeProvider = (targetProvider, authProfileId) => {
		...
		return runtimeProvider === targetProvider ? void 0 : runtimeProvider;
	};
	if (!override) {
...
async function resolvePromptBuildHookResult(params) {
	...
	return {
		...
		prependSystemContext: joinPresentTextSegments([wrapPluginSystemContextSection(promptBuildResult?.prependSystemContext), wrapPluginSystemContextSection(legacyResult?.prependSystemContext)]),
		appendSystemContext: joinPresentTextSegments([wrapPluginSystemContextSection(promptBuildResult?.appendSystemContext), wrapPluginSystemContextSection(legacyResult?.appendSystemContext)])
	};
}
...
function resolvePromptSubmissionSkipReason(params) {
	...
	return hasOpenAICompatibleConversationTurn(params.messages) ? "blank_user_prompt" : "empty_prompt_history_images";
}
...
//#endregion
export { listActiveProcessSessionReferences as _, prependSystemPromptAddition as a, resolvePromptBuildHookResult as c, shouldInjectHeartbeatPrompt as d, shouldWarnOnOrphanedUserRepair as f, resolveContextEngineCapabilities as g, wrapPluginSystemContextSection as h, mergeOrphanedTrailingUserPrompt as i, resolvePromptModeForSession as l, resolveEmbeddedCompactionTarget as m, buildAfterTurnRuntimeContextFromUsage as n, resolveAttemptFsWorkspaceOnly as o, buildEmbeddedCompactionRuntimeContext as p, forgetPromptBuildDrainCacheForRun as r, resolveAttemptPrependSystemContext as s, buildAfterTurnRuntimeContext as t, resolvePromptSubmissionSkipReason as u, buildAgentHookContextChannelFields as v };
