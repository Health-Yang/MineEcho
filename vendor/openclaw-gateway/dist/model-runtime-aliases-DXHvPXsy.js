...
import { i as normalizeStaticProviderModelId } from "./model-ref-shared-CwD1xLDF.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-5VCl4fwR.js";
import { t as resolveModelRuntimePolicy } from "./model-runtime-policy-Bes-9Q2C.js";
...
function isCliRuntimeAliasForProvider(params) {
	...
	return CLI_RUNTIME_BY_PROVIDER.has(`${normalizeProviderId(provider)}:${normalizeProviderId(runtime)}`);
}
...
//#endregion
export { isLegacyRuntimeModelProvider as a, migrateLegacyRuntimeModelRef as c, isCliRuntimeProvider as i, resolveCliRuntimeExecutionProvider as l, isCliRuntimeAlias as n, legacyRuntimeModelAliasRequiresRuntimePolicy as o, isCliRuntimeAliasForProvider as r, listLegacyRuntimeModelProviderAliases as s, areRuntimeModelRefsEquivalent as t, shouldPreferActiveRuntimeAliasAuthLabel as u };
