...
import { i as normalizeHyphenSlug } from "./string-normalization-B8G0vlWE.js";
import { s as normalizeSessionPeerId } from "./session-key-utils-AmKO9Roj.js";
import { d as resolveAgentIdFromSessionKey } from "./session-key-yaI3D3Bl.js";
import { s as writeTextAtomic } from "./json-files-za1pmDfK.js";
import { t as createSubsystemLogger } from "./subsystem-1gTaEPwP.js";
import { i as getRuntimeConfig } from "./io-BlARNTf3.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields, t as deliveryContextFromChannelRoute } from "./delivery-context.shared-B9zntlj0.js";
import { g as isSessionStoreTempArtifactName, h as isSessionArchiveArtifactName, i as resolveSessionFilePath, m as isPrimarySessionTranscriptFileName, p as isCompactionCheckpointTranscriptFileName, u as resolveStorePath, y as isTrajectorySessionArtifactName } from "./paths-DZXdqwOo.js";
import { A as getFileStatSnapshot, N as normalizeStoreSessionKey, P as resolveSessionStoreEntry, S as pruneStaleEntries, T as shouldRunSessionEntryMaintenance, _ as takeMutableSessionStoreCache, b as getActiveSessionMaintenanceWarning, d as cloneSessionStoreRecord, f as dropSessionStoreObjectCache, g as setSerializedSessionStore, h as isSessionStoreCacheEnabled, i as readSessionEntry, m as getSerializedSessionStore, n as normalizeSessionStore, o as resolveMaintenanceConfig, p as dropSessionStoreSnapshotCache, r as readSessionEntries, s as collectSessionMaintenancePreserveKeys, t as loadSessionStore, u as clearSessionStoreCaches, v as writeSessionStoreCache, w as shouldPreserveMaintenanceEntry, x as pruneQuotaSuspensions, y as capEntryCount } from "./store-load-Di_AfnVx.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-BvERA_Zw.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-Be8exPcf.js";
...
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-D7s3-R_6.js";
...
async function pruneUnreferencedSessionArtifacts(params) {
	...
	const removableFiles = files.filter((file) => {
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup-BSTFYX_l.js");
...
//#endregion
export { resolveSessionArtifactCanonicalPathsForEntry as C, pruneUnreferencedSessionArtifacts as S, deriveSessionOrigin as _, readSessionUpdatedAt as a, resolveGroupSessionKey as b, saveSessionStore as c, updateSessionStoreEntry as d, upsertSessionEntry as f, deriveSessionMetaPatch as g, deriveGroupSessionPatch as h, patchSessionEntry as i, updateLastRoute as l, drainSessionStoreWriterQueuesForTest as m, getSessionEntry as n, recordSessionMetaFromInbound as o, clearSessionStoreCacheForTest as p, listSessionEntries as r, runQuotaSuspensionMaintenance as s, archiveRemovedSessionTranscripts as t, updateSessionStore as u, snapshotSessionOrigin as v, enforceSessionDiskBudget as x, buildGroupDisplayName as y };
