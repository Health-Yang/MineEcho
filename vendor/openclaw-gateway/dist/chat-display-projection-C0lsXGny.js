...
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase } from "./chat-message-content-CeOacmio.js";
import "./internal-runtime-context-DftY0OXU.js";
import { g as stripEnvelopeFromMessages } from "./session-utils.fs-D_Qde0sG.js";
import { i as stripInlineDirectiveTagsForDisplay } from "./directive-tags-DBD-mk-0.js";
import { n as HEARTBEAT_PROMPT } from "./heartbeat-CFoWrjC8.js";
...
function projectChatDisplayMessages(messages, options) {
	return sanitizeChatHistoryMessages(mergeTtsSupplementMessages(filterVisibleProjectedHistoryMessages(toProjectedMessages(sanitizeChatHistoryMessages(mirrorMessageToolVisibleReplies(options?.stripEnvelope === false ? messages : stripEnvelopeFromMessages(messages)), Number.MAX_SAFE_INTEGER)))), options?.maxChars ?? 8e3);
}
...
//#endregion
export { projectRecentChatDisplayMessages as a, projectChatDisplayMessages as i, isToolHistoryBlockType as n, resolveEffectiveChatHistoryMaxChars as o, projectChatDisplayMessage as r, sanitizeChatHistoryMessages as s, DEFAULT_CHAT_HISTORY_TEXT_MAX_CHARS as t };
