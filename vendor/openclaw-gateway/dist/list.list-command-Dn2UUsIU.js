...
import { i as normalizeProviderIdForAuth } from "./provider-id-nh-uBdZ_.js";
...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-BALJ9TgI.js";
...
import { s as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-CnBPb3N4.js";
...
import { v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvAuthLookupMaps } from "./model-auth-markers-BxvoYSZo.js";
...
import { c as hasSyntheticLocalProviderAuthConfig, l as hasUsableCustomProviderApiKey } from "./model-auth-DEXDfJh7.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-DkSSKqzU.js";
import { n as loadModelsConfigWithSource } from "./load-config-C2PLLq-r.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-CdwW3EBf.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-rZlofQs0.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-CqeHmFwP.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-Cc2JCRt2.js"),
		import("./agent-scope-DKcDOg84.js"),
		import("./workspace-BChXC8wi.js")
	]);
