...
import { n as disposeRegisteredAgentHarnesses } from "./registry-CA-J0IzZ.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CeA6cnAD.js";
import { r as closePluginStateSqliteStore } from "./plugin-state-store-BVbTs5d2.js";
import { i as listChannelPlugins } from "./registry-Be8exPcf.js";
...
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-Yp6H5_aR.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-BTKvwiKu.js";
...
function abortActiveRunsForRestart(params) {
	let aborted = 0;
	for (const [runId, entry] of listRestartDrainRuns(params.chatAbortControllers)) if (abortChatRunById({
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-B-IANm8f.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-CAb-1YL6.js");
