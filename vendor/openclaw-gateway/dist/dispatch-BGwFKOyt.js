...
import { n as isAcpSessionKey } from "./session-key-utils-AmKO9Roj.js";
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BfxErZq2.js";
import { c as measureDiagnosticsTimelineSpan, l as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-Bb8bov-r.js";
...
import { g as normalizeVerboseLevel } from "./thinking-DKulK0JL.js";
import "./message-channel-core-NW6lw3Ys.js";
import { u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { n as getGlobalPluginRegistry, t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CjzahG2G.js";
...
import { P as resolveSessionStoreEntry, i as readSessionEntry, t as loadSessionStore } from "./store-load-Di_AfnVx.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-Be8exPcf.js";
import { b as resolveGroupSessionKey, d as updateSessionStoreEntry } from "./store-B5j4GKkg.js";
import { t as normalizeChatType } from "./chat-type-DeA3YwAD.js";
import { t as appendAssistantMessageToSessionTranscript } from "./transcript-DxGLLD67.js";
...
import { i as resolveSourceReplyVisibilityPolicy, t as isExplicitSourceReplyCommand } from "./source-reply-delivery-mode-hCdT_qdg.js";
import { p as replyRunRegistry } from "./reply-run-registry-BYXDUcCT.js";
import { g as markDiagnosticSessionProgress, i as logMessageDispatchStarted, r as logMessageDispatchCompleted, s as logMessageReceived } from "./diagnostic-BDsaMZfL.js";
...
import { c as toPluginInboundClaimEvent, i as toInternalMessageReceivedContext, l as toPluginMessageContext, n as deriveInboundMessageHookContext, s as toPluginInboundClaimContext, u as toPluginMessageReceivedEvent } from "./message-hook-mappers-Cic-rjWp.js";
import { o as isOutboundDeliveryError } from "./deliver-BbjUzZ_K.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-swpu2tGD.js";
import { D as isParentOwnedBackgroundAcpSession } from "./openclaw-tools-BUQsixTe.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-CeOcBGcI.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./pi-tools.policy-Y73YR7fr.js";
import { i as selectAgentHarness } from "./selection-C4e-Qn9W.js";
import { n as normalizeTtsAutoMode } from "./tts-auto-mode-jJO08bho.js";
import { i as shouldCleanTtsDirectiveText, r as shouldAttemptTtsPayload, t as resolveConfiguredTtsMode } from "./tts-config-CXHI7o_x.js";
import { a as buildPluginBindingUnavailableText, b as touchConversationBindingRecord, c as hasShownPluginBindingFallbackNotice, d as markPluginBindingFallbackNoticeShown, h as toPluginConversationBinding, n as buildPluginBindingDeclinedText, r as buildPluginBindingErrorText, u as isPluginOwnedSessionBindingRecord, y as resolveConversationBindingRecord } from "./conversation-binding-jzFwkanA.js";
...
import { t as createDiagnosticMessageLifecycle } from "./message-lifecycle-BpJ7cDQs.js";
import { r as matchPluginCommand } from "./commands-Ctnxt50B.js";
import { n as resolveSendPolicy } from "./send-policy-BUg-fAPA.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-CPLN_vjJ.js";
import { r as findCommandByNativeName } from "./commands-registry-Brl2piP4.js";
import { n as isReplyProfilerEnabled } from "./reply-timing-tracker-K6eWTXRB.js";
import { a as resolveSessionRuntimeOverrideForProvider, n as resolveReplyTurnKind, t as admitReplyTurn } from "./reply-turn-admission-RbGV1xsI.js";
...
import { d as resolveEffectiveReplyRoute, l as withFullRuntimeReplyConfig, t as resolveRunTypingPolicy } from "./typing-policy-D-Om1RIk.js";
import { n as commitInboundDedupe, r as releaseInboundDedupe, t as claimInboundDedupe } from "./inbound-dedupe-D9KGViI9.js";
import { n as createReplyDispatcherWithTyping, r as waitForReplyDispatcherIdle, t as createReplyDispatcher } from "./reply-dispatcher-DmOOpho9.js";
	...
	*/
	...
	try {
		...
		const sendFinalPayload = async (payload, options = {}) => {
			...
			throwIfFinalDeliveryAborted();
			const result = await routeReplyToOriginating(normalizedPayload, { abortSignal });
			if (result) {
		...
		const shouldAllowQuietDirectNativeProgressCallbacks = (options) => options?.requiresToolSummaryVisibility === true && params.replyOptions?.suppressDefaultToolProgressMessages === true && chatType === "direct";
		...
		const shouldForwardProgressCallback = (options) => {
			if (options?.requiresToolSummaryVisibility === true && !shouldSendToolSummaries() && !shouldAllowQuietDirectNativeProgressCallbacks(options)) return false;
		...
		if (!suppressDelivery) {
			if (resolveConfiguredTtsMode(cfg, {
				...
				if (ttsSyntheticReply.mediaUrl) {
					...
					throwIfDispatchOperationAborted();
					const result = await routeReplyToOriginating(normalizedTtsOnlyPayload, { abortSignal: getDispatchAbortSignal() });
					if (result) {
