...
import { f as readLoggingConfig, s as redactSensitiveText, t as getDefaultRedactPatterns } from "./redact-9hVaCauP.js";
...
import { w as resolvePluginControlPlaneFingerprint, y as getCurrentPluginMetadataSnapshot } from "./plugin-registry-BALJ9TgI.js";
import { r as emitFailoverEvent } from "./diagnostic-events-CNGydBWO.js";
import { t as createSubsystemLogger } from "./subsystem-1gTaEPwP.js";
import { z as resolveCronMaxConcurrentRuns } from "./io-BlARNTf3.js";
...
import { p as normalizeEmbeddedAgentRuntime } from "./openai-codex-routing-CnBPb3N4.js";
import { t as resolveAgentHarnessPolicy } from "./policy-vFgV2Ptr.js";
import { r as getRegisteredAgentHarness } from "./registry-CA-J0IzZ.js";
import { d as updateSessionStoreEntry } from "./store-B5j4GKkg.js";
import "./sessions-Ct4mpWsk.js";
import { t as isPluginProvidersLoadInFlight } from "./providers.runtime-BSu6EH34.js";
import { t as hasAnyAuthProfileStoreSource } from "./source-check-D-qOGbI1.js";
import { i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-BuXkxoPc.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-l_jinpMc.js";
import "./model-selection-resolve-CVP499hv.js";
...
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-BHbpuv3O.js";
import { h as setCommandLaneConcurrency, u as isCommandLaneTaskTimeoutError } from "./command-queue-fCeWoVd6.js";
import { g as isLikelyContextOverflowError, r as classifyProviderRuntimeFailureKind } from "./errors-DuGAmFy8.js";
import { a as isNonProviderRuntimeCoordinationError, i as isFailoverError, n as coerceToFailoverError, o as isTimeoutError, r as describeFailoverError, t as FailoverError } from "./failover-error-wBZizcCn.js";
import { n as isCliRuntimeAlias } from "./model-runtime-aliases-DXHvPXsy.js";
import "./pi-embedded-helpers-Bj4nONRY.js";
import { i as externalCliDiscoveryForProviders } from "./external-cli-discovery-CeB9kE8m.js";
import { t as redactIdentifier } from "./redact-identifier-BI6BTlLC.js";
import { i as resolveStoredSessionKeyForSessionId } from "./session-D_iBBJQp.js";
...
async function runFallbackAttempt(params) {
	...
	if (runResult.ok) {
		...
		if (classifiedError) {
			if (isTerminalAbort(params.abortSignal)) throw classifiedError;
...
async function assertModelFallbackCandidateHarnessAvailable(params) {
	...
	const normalizedAgentRuntimeOverride = agentRuntimeOverride === void 0 ? void 0 : normalizeEmbeddedAgentRuntime(agentRuntimeOverride);
	...
	if (agentRuntime === "auto" || agentRuntime === "pi" || agentRuntime === "codex" && agentRuntimeSource === "implicit") return;
...
//#endregion
export { runWithModelFallback as a, LiveSessionModelSwitchError as c, buildApiErrorObservationFields as d, buildTextObservationFields as f, runWithImageModelFallback as i, MissingAgentHarnessError as l, resolveImageFallbackCandidates as n, resolveSessionSuspensionReason as o, shouldSuppressRawErrorConsoleSuffix as p, resolveImageFallbackDefaultProvider as r, suspendSession as s, isFallbackSummaryError as t, shouldAllowCooldownProbeForReason as u };
