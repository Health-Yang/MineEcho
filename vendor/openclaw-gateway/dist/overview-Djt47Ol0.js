import { d as resolveGatewayPort, s as resolveConfigPath } from "./paths-CQv1_CDw.js";
...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-BfxErZq2.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-CHAszD8e.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
