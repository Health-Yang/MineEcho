...
import { l as normalizeStringEntries, n as normalizeAtHashSlug } from "./string-normalization-B8G0vlWE.js";
import { y as truncateUtf16Safe } from "./utils-B5r0V84N.js";
import { r as normalizeProviderId } from "./provider-id-nh-uBdZ_.js";
import { C as hasSessionAutoModelFallbackProvenance, _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-CudANNo3.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-AmKO9Roj.js";
import { l as normalizeAgentId, r as buildAgentMainSessionKey, u as normalizeMainKey } from "./session-key-yaI3D3Bl.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-BYXB4T7J.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BfxErZq2.js";
import { c as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-Bb8bov-r.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-OP3BJTaQ.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-DKulK0JL.js";
import "./config-BtNBbhZb.js";
import { a as normalizeAnyChannelId } from "./registry-49GbU2k5.js";
import "./message-channel-core-NW6lw3Ys.js";
import { r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { r as annotateInterSessionPromptText, s as isInterSessionInputProvenance } from "./input-provenance-D_ZjwTES.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-codex-routing-CnBPb3N4.js";
import { t as resolveAgentHarnessPolicy } from "./policy-vFgV2Ptr.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-CA-J0IzZ.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CjzahG2G.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CeA6cnAD.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-896o98eb.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-B9zntlj0.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DZXdqwOo.js";
import { C as resolveMaintenanceConfigFromInput, D as parseSessionThreadInfoFast, P as resolveSessionStoreEntry, t as loadSessionStore } from "./store-load-Di_AfnVx.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-lQzPIJ_8.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-Be8exPcf.js";
import { b as resolveGroupSessionKey, g as deriveSessionMetaPatch, u as updateSessionStore } from "./store-B5j4GKkg.js";
import { t as normalizeChatType } from "./chat-type-DeA3YwAD.js";
import "./plugins-BGmuVWWz.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-D7s3-R_6.js";
import { c as resolveSessionLifecycleTimestamps } from "./sessions-Ct4mpWsk.js";
...
import { d as resolveAndPersistSessionFile } from "./transcript-DxGLLD67.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-BuXkxoPc.js";
...
import { r as normalizeCommandBody } from "./commands-registry-normalize-Ccb5CgSd.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BI25CDaQ.js";
import { t as hasControlCommand } from "./command-detection-BHZ65i3a.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-hCdT_qdg.js";
import { a as enqueueSystemEvent } from "./system-events-BbV9wJlR.js";
import { c as isReplyRunActiveForSessionId, h as waitForReplyRunEndBySessionId, i as abortReplyRunBySessionId, l as isReplyRunStreamingForSessionId, m as resolveActiveReplyRunSessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS } from "./reply-run-registry-BYXDUcCT.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BpOBzvOi.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-Cmy1_JK9.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-fCeWoVd6.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-Da0m6i2H.js";
import { n as getSessionBindingService } from "./session-binding-service-C_ndVxi-.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-Cic-rjWp.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-CH35LESg.js";
import { ct as resolvePersistedUserTurnText, kt as isReasoningTagProvider, ot as buildPersistedUserTurnMediaInputsFromFields, st as createUserTurnTranscriptRecorder } from "./selection-C4e-Qn9W.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-CFoWrjC8.js";
import { v as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-6Y-UzS6M.js";
...
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CvvVq7hM.js";
import { s as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-r0bvLe6M.js";
import "./pi-bundle-mcp-tools-Dx9OBYuL.js";
import { P as collectTextContentBlocks } from "./attempt.tool-run-context-TMML7ez9.js";
import "./delivery-context-DMGHXaoo.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawn-requester-origin-DRzgz0AK.js";
import { s as getMediaDir } from "./store-CkmEdlzm.js";
import { t as resolveQueueSettings } from "./queue-BguXrIlu.js";
...
import { r as getCliSessionBinding } from "./cli-session-BwvOVpab.js";
import { a as resolveSilentReplySettings, r as resolveCurrentTurnImages, t as createReplyTimingTracker } from "./reply-timing-tracker-K6eWTXRB.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CMrrA67a.js";
import { i as hasInboundMedia } from "./agent-turn-attachments-CzlU34xK.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CeJuZogi.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy, u as isSystemEventProvider } from "./typing-policy-D-Om1RIk.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-D-KZ2Pn7.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Dqn1ebZ6.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-CqaziysJ.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-Cx6g3XKE.js";
...
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-CkY-lK7L.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-q2m2nbxn.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-CvHmSrUY.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-ChTHwLyw.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-rYcusjRF.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-BhctI43w.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-DTUmN7Nf.js";
import { t as resolveFastModeState } from "./fast-mode-DA48mzi5.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-gIQhOtlv.js";
...
import { t as isDirectiveOnly } from "./directive-handling.directive-only-D7cGtZtc.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-Dq3XSudY.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-D8zH9MuQ.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-Bs5SwtjB.js";
import { t as extractExplicitGroupId } from "./group-id-BtVMd22R.js";
import { t as formatElevatedUnavailableMessage } from "./elevated-unavailable-C-moe1kp.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CKOiB0xZ.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-CM3yKutB.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-Bm4bJ7b-.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CgGTncWM.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DywjWPyn.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CShukRyj.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DhpUs179.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-DQz-ckUb.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-DC_fg00V.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-DWqrBD5N.js"));
...
const skillCommandsRuntimeLoader$1 = createLazyImportLoader(() => import("./skill-commands.runtime.js"));
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await loadSkillCommandsRuntime$1()).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DJegVhx8.js"));
...
const MESSAGE_TOOL_DELIVERY_HINT = "Delivery: Final assistant text is not automatically delivered in this run. Use the `message` tool to send user-visible output.";
...
async function runPreparedReply(params) {
	...
	const resolveActiveEmbeddedSessionId = (sessionFile = preparedSessionState.sessionFile) => piRuntime?.resolveActiveEmbeddedRunSessionId(sessionKey) ?? piRuntime?.resolveActiveEmbeddedRunSessionIdBySessionFile?.(sessionFile);
	...
	const resolveQueueBusyState = () => {
		...
		if (!activeSessionId || !piRuntime && !replyOperationActiveSessionId) return {
		...
		return {
			activeSessionId,
			isActive: embeddedActiveSessionId != null && (piRuntime?.isEmbeddedPiRunActive(embeddedActiveSessionId) ?? false) || replyOperationActive,
			isStreaming: embeddedActiveSessionId != null && (piRuntime?.isEmbeddedPiRunStreaming(embeddedActiveSessionId) ?? false) || replyOperationActiveSessionId != null && isReplyRunStreamingForSessionId(replyOperationActiveSessionId)
		};
	};
	...
	if (isActive && activeRunQueueAction === "run-now") {
		const queueState = await resolvePreparedReplyQueueState({
			...
			waitForActiveRunEnd: (activeRunSessionId) => isReplyRunActiveForSessionId(activeRunSessionId) ? waitForReplyRunEndBySessionId(activeRunSessionId, REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS) : piRuntime?.waitForEmbeddedPiRunEnd(activeRunSessionId) ?? Promise.resolve(void 0),
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-DMKRRIvB.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-XBxnity-.js"));
...
async function getReplyFromConfig(ctx, opts, configOverride) {
		...
		if (opts?.isHeartbeat) {
			...
			if (heartbeatPending.shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionStoreEntry } = await import("./sessions-ZYN_EQ32.js");
	...
	if (!hasResolvedHeartbeatModelOverride && !(hasSessionModelOverride && !staleHeartbeatAutoFallbackOverride) && resolvedChannelModelOverride) {
