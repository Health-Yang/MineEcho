...
import { i as redactSensitiveFieldValue, l as redactToolPayloadText } from "./redact-9hVaCauP.js";
...
import { t as appendRegularFile } from "./regular-file-BFvcwX3y.js";
import { p as resolveUserPath } from "./utils-B5r0V84N.js";
import { v as resolveSessionAgentIds } from "./agent-scope-CudANNo3.js";
...
import { a as emitTrustedDiagnosticEvent, b as freezeDiagnosticTraceContext, d as onInternalDiagnosticEvent, o as emitTrustedDiagnosticEventWithPrivateData, s as hasPendingInternalDiagnosticEvent, v as createDiagnosticTraceContextFromActiveScope } from "./diagnostic-events-CNGydBWO.js";
...
import { s as appendSessionTranscriptMessage } from "./transcript-DxGLLD67.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-cdgltU-p.js";
import { d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-B48uOlVM.js";
import { t as asBoolean } from "./boolean-CZag3-H2.js";
import { g as setActiveEmbeddedRun, r as clearActiveEmbeddedRun } from "./runs-p1TN18LG.js";
import { o as normalizeUsage } from "./usage-Detu9Td-.js";
...
import { n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun } from "./bootstrap-files-_8BLxDNp.js";
import { a as getBeforeToolCallPolicyDiagnosticState } from "./pi-tools.before-tool-call-BEgB-RpB.js";
import { r as markAuthProfileBlockedUntil } from "./usage-Dii4DVpK.js";
...
import { t as buildEmbeddedAttemptToolRunContext, x as runAgentCleanupStep } from "./attempt.tool-run-context-TMML7ez9.js";
...
import { a as isCodexAppServerConnectionClosedError, i as isCodexAppServerApprovalRequest, l as isJsonObject, r as compareCodexAppServerVersions, s as MIN_CODEX_SANDBOX_EXEC_SERVER_APP_SERVER_VERSION } from "./client-D1m3kevQ.js";
import { C as defaultCodexAppInventoryCache, D as projectContextEngineAssemblyForCodex, O as resolveCodexContextEngineProjectionMaxChars, T as sanitizeCodexHistoryImagePayloads, _ as buildCodexPluginThreadConfigInputFingerprint, a as buildDeveloperInstructions, c as buildTurnCollaborationMode, d as isContextEngineBindingCompatible, g as buildCodexPluginThreadConfig, h as isCodexAppServerProfilerEnabled, i as buildContextEngineBinding, k as resolveCodexContextEngineProjectionReserveTokens, l as buildTurnStartParams, m as startOrResumeThread, n as areCodexDynamicToolFingerprintsCompatible, u as codexDynamicToolsFingerprint, v as mergeCodexThreadConfigs, y as shouldBuildCodexPluginThreadConfig } from "./thread-lifecycle-BSW5t26R.js";
import { i as readCodexAppServerBinding, t as clearCodexAppServerBinding } from "./session-binding-T1l8KnfH.js";
import { n as CODEX_CONTROL_METHODS } from "./request-B6CRiGBO.js";
import { g as shouldRefreshCodexRateLimitsForUsageLimitMessage, h as resolveCodexUsageLimitResetAtMs, i as readCodexNotificationTurnId, m as formatCodexUsageLimitErrorMessage, n as isCodexNotificationForTurn, r as readCodexNotificationThreadId, s as formatCodexDisplayText, t as describeCodexNotificationCorrelation } from "./notification-correlation-CPVVt7gD.js";
import { c as retireSharedCodexAppServerClientIfCurrent, d as resolveCodexAppServerAuthAccountCacheKey, f as resolveCodexAppServerAuthProfileId, h as resolveCodexAppServerHomeDir, m as resolveCodexAppServerFallbackApiKeyCacheKey, n as clearSharedCodexAppServerClientIfCurrent, p as resolveCodexAppServerAuthProfileIdForAgent, s as releaseLeasedSharedCodexAppServerClient, u as refreshCodexAppServerAuthTokens } from "./shared-client-CPEodqad.js";
import { i as resolveCodexNativeExecutionPolicy } from "./sandbox-guard-BkGRFhmz.js";
import { t as buildCodexPluginAppCacheKey } from "./plugin-app-cache-key-DbF215K2.js";
import { a as resolveCodexDynamicToolsLoading, i as normalizeCodexDynamicToolName, n as filterCodexDynamicTools, r as isForcedPrivateQaCodexRuntime, t as createCodexDynamicToolBridge } from "./dynamic-tools-C2_yTrQT.js";
import { a as handleCodexAppServerElicitationRequest, c as emitDynamicToolTerminalDiagnostic, i as buildCodexNativeHookRelayDisabledConfig, l as handleCodexAppServerApprovalRequest, n as CODEX_NATIVE_HOOK_RELAY_EVENTS, o as emitDynamicToolErrorDiagnostic, r as buildCodexNativeHookRelayConfig, s as emitDynamicToolStartedDiagnostic, t as filterToolsForVisionInputs } from "./vision-tools-BPO59kv1.js";
import { t as ensureCodexComputerUse } from "./computer-use-CgFAJux1.js";
...
var CodexAppServerEventProjector = class {
	...
	handleRawResponseItemCompleted(params) {
		...
		if (!item || readString$5(item, "role") !== "assistant") return;
...
function buildCodexAppServerPromptTimeoutOutcome(params) {
	...
	if (!params.turnCompletionIdleTimedOut || params.result.itemLifecycle.completedCount === 0 && !completionIdleTimeoutHadPotentialSideEffects) return;
	return {
...
async function rotateOversizedCodexAppServerStartupBinding(params) {
	...
	if (params.contextEngineActive === true && hasContextEngineThreadBootstrapProjection(binding)) {
		log.debug("codex app-server deferring native transcript size guard for context-engine thread bootstrap", {
...
async function runCodexAppServerAttempt(params, options = {}) {
	...
	const handleNotification = async (notification) => {
		...
		if (isCurrentTurnNotification) {
			...
			if (notification.method === "item/completed" && activeTurnItemIds.size === 0) scheduleTerminalDynamicToolReleaseCheck();
		}
...
function resolveCodexAppServerExecutionCwd(params) {
	return params.environment && params.nativeToolSurfaceEnabled ? params.environment.cwd : params.effectiveWorkspace;
}
...
function addNodeShellDynamicToolsIfNeeded(filteredTools, allTools, input) {
	...
	for (const toolName of ["exec", "process"]) {
		...
		if (next.some((tool) => normalizeCodexDynamicToolName(tool.name) === toolName)) continue;
		const tool = allTools.find((candidate) => normalizeCodexDynamicToolName(candidate.name) === toolName);
		if (!tool) continue;
