...
import { d as resolveGatewayPort, f as resolveIncludeRoots, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH } from "./paths-CQv1_CDw.js";
...
import "./daemon-cli-CTh32gza.js";
import { E as pathExists } from "./fs-safe-JUdtLZkh.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-B5r0V84N.js";
import { r as resolveConfigEnvVars } from "./env-substitution-DbLVJ2ZZ.js";
...
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-CA3xEreb.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-Db9FQc7C.js";
import { a as readJsonIfExists, m as writeJson } from "./json-files-za1pmDfK.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-CzzsKZJi.js";
import { a as resolveDefaultPluginNpmDir } from "./install-paths-HdtNIDW3.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CQGWoRBr.js";
import { o as resolvePackageExtensionEntries } from "./manifest-CLXJII1a.js";
import { r as validatePackageExtensionEntriesForInstall } from "./package-entry-resolution-SshuVvTg.js";
...
import { c as resolveOfficialExternalPluginInstall, r as getOfficialExternalPluginCatalogManifest, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-sotRjC8t.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-DKunDhdX.js";
import { r as runCommandWithTimeout } from "./exec-Db1qwHgx.js";
import { F as asResolvedSourceConfig, I as asRuntimeConfig, o as parseConfigJson5, p as readSourceConfigBestEffort, q as createPreUpdateConfigSnapshot, u as readConfigFileSnapshot } from "./io-BlARNTf3.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-BV-e8pNZ.js";
import { a as resolveConfigIncludes } from "./includes-DwAz1VP4.js";
...
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-D2h8JiiC.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-DBsNZxvl.js";
...
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-C3CTI4Oh.js";
import { n as runDaemonInstall } from "./install-UpLSLyqQ.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-D-bJeCP8.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-BBFXUWT7.js";
import { u as trimLogTail } from "./restart-sentinel-DePW2OSL.js";
...
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-CLs4Bs9X.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DGstwDWv.js";
import { t as formatHelpExamples } from "./help-format-DXVAk021.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-DTf3q6zq.js";
...
import { i as updateNpmInstalledPlugins, n as resolveTrustedSourceLinkedOfficialNpmSpec, r as syncPluginsForUpdateChannel, t as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./update-CzNBSXcN.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-Bmkl1XTP.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-n4Zaugtt.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-o3G4WLdG.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CZtMMRV9.js";
import { t as doctorCommand } from "./doctor-BBLOduLz.js";
import { n as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, r as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-D5uJdFHk.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-D760FO7o.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-DgekYLmM.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-DNsBJ8sR.js";
import { n as pruneStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-C11i_LHR.js";
...
function parseTimeoutMsOrExit(timeout) {
	...
	if (!/^\d+$/u.test(trimmed) || !Number.isSafeInteger(seconds) || seconds <= 0 || seconds > MAX_SAFE_TIMEOUT_SECONDS) {
...
async function repairManagedNpmOpenClawPeerLinks(params) {
	try {
		...
		return {
			changes: result.repaired > 0 ? [`Repaired OpenClaw host peer link(s) for ${result.repaired} managed npm plugin package(s).`] : [],
			warnings: []
		};
	} catch (err) {
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-CKv0Vy5c.js");
