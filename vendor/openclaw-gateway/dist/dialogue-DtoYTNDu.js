import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-2gwLjSTA.js";
import { r as loadCrestodianOverview } from "./overview-Djt47Ol0.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-q7FWnxlI.js")).planCrestodianCommand)({
		input,
		overview
	});
