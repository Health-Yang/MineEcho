...
import { V as formatMemoryDreamingDay } from "./dreaming-DT202ka-.js";
import "./string-coerce-runtime-qOd7_06l.js";
import "./security-runtime-SX8TzrnK.js";
import "./memory-core-host-status-CZR2A80t.js";
import { n as appendMemoryHostEvent } from "./events-CF3L1QFD.js";
import "./memory-host-events-DX6lDtXv.js";
...
function buildPromotionSection(candidates, nowMs, timezone) {
	...
	for (const candidate of candidates) {
		...
		lines.push(`- ${snippet.replace(/^- +/, "")} [score=${candidate.score.toFixed(3)} recalls=${candidate.recallCount} avg=${candidate.avgScore.toFixed(3)} source=${source}]`);
	}
	lines.push("");
	return lines.join("\n");
}
