...
import { a as requireGatewayClientScope } from "./command-gates-BvihYTM5.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-Bpi21I_h.js";
//#region src/auto-reply/reply/commands-acp.ts
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-DJ7_lIst.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-PwU36771.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-AEw2LoeR.js"));
