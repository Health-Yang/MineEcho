...
declare const ProtocolSchemas: {
  ...
  PluginApprovalRequestParams: import("typebox").TObject<{
    ...
    actions: import("typebox").TOptional<import("typebox").TArray<import("typebox").TObject<{
      kind: import("typebox").TString;
      label: import("typebox").TString;
      style: import("typebox").TString;
      decision: import("typebox").TOptional<import("typebox").TString>;
      commandTemplate: import("typebox").TString;
    }>>>;
    agentId: import("typebox").TOptional<import("typebox").TString>;
    sessionKey: import("typebox").TOptional<import("typebox").TString>;
    ...
    timeoutMs: import("typebox").TOptional<import("typebox").TInteger>;
    twoPhase: import("typebox").TOptional<import("typebox").TBoolean>;
    keepPendingWithoutRoute: import("typebox").TOptional<import("typebox").TBoolean>;
  }>;
...
//#endregion
export { CronStatusParams as $, ToolsEffectiveParams as $n, SessionsResetParams as $t, ChannelsStatusParams as A, TalkSessionCancelTurnParams as An, NodePairRemoveParams as At, ConfigPatchParams as B, TalkSessionTurnResult as Bn, PluginsSessionActionResult as Bt, ArtifactsDownloadResult as C, TalkClientToolCallParams as Cn, NodeEventResult as Ct, ArtifactsListResult as D, TalkModeParams as Dn, NodePairApproveParams as Dt, ArtifactsListParams as E, TalkConfigResult as En, NodeListParams as Et, CommandEntry as F, TalkSessionJoinResult as Fn, NodePendingEnqueueParams as Ft, CronAddParams as G, TasksCancelResult as Gn, SessionOperationEvent as Gt, ConfigSchemaResponse as H, TalkSpeakResult as Hn, PresenceEntry as Ht, CommandsListParams as I, TalkSessionOkResult as In, NodePendingEnqueueResult as It, CronListParams as J, TasksListParams as Jn, SessionsDeleteParams as Jt, CronGetParams as K, TasksGetParams as Kn, SessionsCleanupParams as Kt, CommandsListResult as L, TalkSessionSteerParams as Ln, NodePresenceAlivePayload as Lt, ChannelsStopParams as M, TalkSessionCreateParams as Mn, NodePairVerifyParams as Mt, ChatEvent as N, TalkSessionCreateResult as Nn, NodePendingDrainParams as Nt, ChannelsLogoutParams as O, TalkSessionAppendAudioParams as On, NodePairListParams as Ot, ChatInjectParams as P, TalkSessionJoinParams as Pn, NodePendingDrainResult as Pt, CronRunsParams as Q, ToolsCatalogResult as Qn, SessionsPreviewParams as Qt, ConfigApplyParams as R, TalkSessionSubmitToolResultParams as Rn, NodePresenceAliveReason as Rt, ArtifactsDownloadParams as S, TalkClientSteerParams as Sn, NodeEventParams as St, ArtifactsGetResult as T, TalkConfigParams as Tn, NodeInvokeResultParams as Tt, ConfigSetParams as U, TaskSummary as Un, RequestFrame as Ut, ConfigSchemaParams as V, TalkSpeakParams as Vn, PollParams as Vt, ConnectParams as W, TasksCancelParams as Wn, ResponseFrame as Wt, CronRunLogEntry as X, TickEvent as Xn, SessionsListParams as Xt, CronRemoveParams as Y, TasksListResult as Yn, SessionsDescribeParams as Yt, CronRunParams as Z, ToolsCatalogParams as Zn, SessionsPatchParams as Zt, AgentsListParams as _, TalkAgentControlResult as _n, MIN_CLIENT_PROTOCOL_VERSION as _r, ExecApprovalsSnapshot as _t, AgentWaitParams as a, SkillsDetailParams as an, WakeParams as ar, EnvironmentSummary as at, AgentsUpdateResult as b, TalkClientCreateParams as bn, LogsTailParams as bt, AgentsDeleteParams as c, SkillsSearchParams as cn, WizardCancelParams as cr, EnvironmentsStatusParams as ct, AgentsFilesGetParams as d, SkillsUpdateParams as dn, WizardStartParams as dr, EventFrame as dt, SessionsResolveParams as en, ToolsEffectiveResult as er, CronUpdateParams as et, AgentsFilesGetResult as f, SkillsUploadBeginParams as fn, WizardStartResult as fr, ExecApprovalGetParams as ft, AgentsFilesSetResult as g, StateVersion as gn, ProtocolSchemas as gr, ExecApprovalsSetParams as gt, AgentsFilesSetParams as h, Snapshot as hn, WizardStep as hr, ExecApprovalsGetParams as ht, AgentSummary as i, SkillsBinsResult as in, UpdateStatusParams as ir, EnvironmentStatus as it, ChannelsStatusResult as j, TalkSessionCloseParams as jn, NodePairRequestParams as jt, ChannelsStartParams as k, TalkSessionCancelOutputParams as kn, NodePairRejectParams as kt, AgentsDeleteResult as l, SkillsSearchResult as ln, WizardNextParams as lr, EnvironmentsStatusResult as lt, AgentsFilesListResult as m, SkillsUploadCommitParams as mn, WizardStatusResult as mr, ExecApprovalResolveParams as mt, AgentIdentityParams as n, ShutdownEvent as nn, ToolsInvokeResult as nr, DevicePairListParams as nt, AgentsCreateParams as o, SkillsDetailResult as on, WebLoginStartParams as or, EnvironmentsListParams as ot, AgentsFilesListParams as p, SkillsUploadChunkParams as pn, WizardStatusParams as pr, ExecApprovalRequestParams as pt, CronJob as q, TasksGetResult as qn, SessionsCompactParams as qt, AgentIdentityResult as r, SkillsBinsParams as rn, UpdateRunParams as rr, DevicePairRejectParams as rt, AgentsCreateResult as s, SkillsInstallParams as sn, WebLoginWaitParams as sr, EnvironmentsListResult as st, AgentEvent as t, SessionsUsageParams as tn, ToolsInvokeParams as tr, DevicePairApproveParams as tt, AgentsFileEntry as u, SkillsStatusParams as un, WizardNextResult as ur, ErrorShape as ut, AgentsListResult as v, TalkCatalogParams as vn, MIN_PROBE_PROTOCOL_VERSION as vr, GatewayFrame as vt, ArtifactsGetParams as w, TalkClientToolCallResult as wn, NodeInvokeParams as wt, ArtifactSummary as x, TalkClientCreateResult as xn, LogsTailResult as xt, AgentsUpdateParams as y, TalkCatalogResult as yn, PROTOCOL_VERSION as yr, HelloOk as yt, ConfigGetParams as z, TalkSessionTurnParams as zn, PluginsSessionActionParams as zt };