...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-DHnXdmOi.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-PKOjhlmb.js");
	const { buildPluginSnapshotReport } = await import("./status-DfZA70es.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-ClWiJY9a.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-BQX1hTEh.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-ChxFJdHQ.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-gzSCCDkz.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-BJUzvU9k.js");
