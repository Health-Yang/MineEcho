...
import { p as resolveUserPath, s as ensureDir } from "./utils-B5r0V84N.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload } from "./a2ui-shared-SdVpoFYC.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-D5DrNrY9.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-B9CX3lUo.js");
