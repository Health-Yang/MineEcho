...
import { o as isActiveHarnessContextEngine } from "./context-engine-lifecycle-DxaBy-g1.js";
import "./string-coerce-runtime-qOd7_06l.js";
import { t as buildCodexUserMcpServersThreadConfigPatch } from "./bundle-mcp-codex-EHW4Bwi6.js";
import "./codex-mcp-projection-DAb2uitE.js";
...
import { d as resolveCodexPluginsPolicy, r as codexSandboxPolicyForTurn, t as CODEX_PLUGINS_MARKETPLACE_NAME } from "./config-ME2vVfAE.js";
import { n as assertCodexThreadResumeResponse, r as assertCodexThreadStartResponse } from "./protocol-validators-DtjYmUw_.js";
import { a as isCodexAppServerConnectionClosedError, l as isJsonObject, n as CodexAppServerRpcError } from "./client-D1m3kevQ.js";
import { n as CODEX_GPT5_HEARTBEAT_PROMPT_OVERLAY } from "./prompt-overlay-Bwxl2pyR.js";
import { r as isModernCodexModel } from "./provider-BYy3I4d-.js";
import { i as readCodexAppServerBinding, n as isCodexAppServerNativeAuthProfile, o as writeCodexAppServerBinding, t as clearCodexAppServerBinding } from "./session-binding-T1l8KnfH.js";
import "node:path";
...
function createCodexThreadLifecycleTimingTracker(options = {}) {
	...
	return {
		...
		logIfSlow(params) {
			...
			didLog = true;
			log.warn(`codex app-server thread lifecycle timings runId=${params.runId} sessionId=${params.sessionId} sessionKey=${params.sessionKey ?? "unknown"} action=${params.action} totalMs=${summary.totalMs} stages=${formatSpans(summary)}`, {
				runId: params.runId,
