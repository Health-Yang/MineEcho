...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-CtRQ27Ls.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BJ6AORAh.js";
import "./ssrf-runtime-C8F9j9mo.js";
import "./retry-runtime-B_Q5PQi7.js";
import "./secret-input-runtime-wsOujrkc.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DZUtZWk6.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-ClybcKPN.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-CEyMBA_e.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BAH-LFMj.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CDr_bywm.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-s5SoJ2pR.js"), import("./logging-CdUDgB2Y.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-OD1ap3Pw.js").then((credentialsReadModule) => ({
