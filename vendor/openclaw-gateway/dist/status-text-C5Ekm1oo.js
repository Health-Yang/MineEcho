...
import { o as toAgentModelListLike } from "./model-input-C697EEaR.js";
import { _ as resolveSessionAgentId, u as resolveAgentModelFallbacksOverride } from "./agent-scope-CudANNo3.js";
...
import { t as areRuntimeModelRefsEquivalent, u as shouldPreferActiveRuntimeAliasAuthLabel } from "./model-runtime-aliases-DXHvPXsy.js";
...
import { t as resolveModelAuthLabel } from "./model-auth-label-B9dWtxzm.js";
import { o as resolveUsageProviderId } from "./provider-usage.shared-CbVyc11B.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-DbOmaJ1o.js";
import { r as formatUsageWindowSummary } from "./provider-usage-SZRZ9SnK.js";
import { t as loadProviderUsageSummary } from "./provider-usage.load-BkFKp7GX.js";
...
function loadAgentHarnessSelectionRuntime() {
	return agentHarnessSelectionRuntimePromise ??= import("./selection-Br6b8why.js");
}
...
async function buildStatusText(params) {
	...
	if (shouldPreferActiveRuntimeAliasAuthLabel({
		runtimeAliasModelEquivalent: areRuntimeModelRefsEquivalent(modelRefs.selected.label, modelRefs.active.label),
