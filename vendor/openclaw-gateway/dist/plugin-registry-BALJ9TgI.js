...
import { i as resolvePluginCacheInputs } from "./discovery-DHnXdmOi.js";
import { p as resolveUserPath } from "./utils-B5r0V84N.js";
import { r as normalizeProviderId } from "./provider-id-nh-uBdZ_.js";
import { a as setCurrentPluginMetadataSnapshotState, i as getCurrentPluginMetadataSnapshotState, r as clearCurrentPluginMetadataSnapshotState } from "./plugin-metadata-lifecycle-BqWfg4Sp.js";
import { c as isInstalledPluginEnabled, f as hasOptionalMissingPluginManifestFile, g as hashJson, h as fileSignatureMatches, i as refreshPersistedInstalledPluginIndex, m as resolveInstalledPluginIndexPolicyHash, p as extractPluginInstallRecordsFromInstalledPluginIndex, r as readPersistedInstalledPluginIndexSync, s as getInstalledPluginRecord, t as inspectPersistedInstalledPluginIndex, u as loadInstalledPluginIndexWithDiscovery } from "./installed-plugin-index-store-Db9FQc7C.js";
import { i as normalizePluginsConfigWithResolver } from "./config-normalization-shared-DJ4ZPlpG.js";
import { n as resolveBundledPluginsDir } from "./bundled-dir-C63ilfb7.js";
import { r as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CQGWoRBr.js";
import { n as resolveInstalledManifestRegistryIndexFingerprint, t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-DKunDhdX.js";
...
//#endregion
export { fingerprintPluginDiscoveryContext as C, setCurrentPluginMetadataSnapshot as S, resolvePluginDiscoveryContext as T, captureCurrentPluginMetadataSnapshotState as _, resolveManifestContractPluginIds as a, isReusableCurrentPluginMetadataSnapshot as b, resolveProviderOwners as c, inspectPluginRegistry as d, isPluginEnabled as f, createPluginRegistryIdNormalizer as g, refreshPluginRegistry as h, resolveManifestContractOwnerPluginId as i, DISABLE_PERSISTED_PLUGIN_REGISTRY_ENV as l, loadPluginRegistrySnapshotWithMetadata as m, loadPluginManifestRegistryForPluginRegistry as n, resolveManifestContractPluginIdsByCompatibilityRuntimePath as o, loadPluginRegistrySnapshot as p, normalizePluginsConfigWithRegistry as r, resolvePluginContributionOwners as s, listPluginContributionIds as t, getPluginRecord as u, clearCurrentPluginMetadataSnapshot as v, resolvePluginControlPlaneFingerprint as w, restoreCurrentPluginMetadataSnapshotState as x, getCurrentPluginMetadataSnapshot as y };
