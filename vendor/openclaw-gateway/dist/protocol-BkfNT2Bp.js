...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-CtRQ27Ls.js";
import { i as SINGLE_VALUE_FILE_REF_ID, n as FILE_SECRET_REF_ID_INVALID_ESCAPE_JSON_SCHEMA_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-DArhJvB2.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BxgIUTRt.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-D_ZjwTES.js";
import { i as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-C9xbHKhZ.js";
...
const PluginApprovalActionTemplateSchema = Type.Object({
	...
	decision: Type.Optional(Type.String({ enum: [
		"allow-once",
		"allow-always",
		"deny"
	] })),
...
const PluginApprovalRequestParamsSchema = Type.Object({
	...
	actions: Type.Optional(Type.Array(PluginApprovalActionTemplateSchema, {
		minItems: 1,
		maxItems: 6
	})),
	agentId: Type.Optional(Type.String()),
...
//#endregion
export { validateExecApprovalsGetParams as $, AgentsFilesSetParamsSchema as $a, ConfigSchemaResponseSchema as $i, validateWizardNextParams as $n, NodePairVerifyParamsSchema as $r, validateSessionsSendParams as $t, validateConfigSchemaParams as A, TalkSessionOkResultSchema as Aa, EnvironmentStatusSchema as Ai, validateTalkSessionOkResult as An, SessionsPluginPatchParamsSchema as Ar, validateRequestFrame as At, validateCronUpdateParams as B, ArtifactsDownloadParamsSchema as Ba, CronJobSchema as Bi, validateToolsCatalogParams as Bn, WebPushUnsubscribeParamsSchema as Br, validateSessionsCompactionListParams as Bt, validateChatSendParams as C, TalkSessionCancelOutputParamsSchema as Ca, SnapshotSchema as Ci, validateTalkSessionCancelOutputParams as Cn, MessageActionParamsSchema as Co, SessionsCompactionListParamsSchema as Cr, validatePluginApprovalRequestParams as Ct, validateConfigPatchParams as D, TalkSessionCreateResultSchema as Da, ExecApprovalResolveParamsSchema as Di, validateTalkSessionCreateResult as Dn, parseSessionLabel as Do, SessionsDescribeParamsSchema as Dr, validatePluginsUiDescriptorsParams as Dt, validateConfigGetParams as E, TalkSessionCreateParamsSchema as Ea, ExecApprovalRequestParamsSchema as Ei, validateTalkSessionCreateParams as En, WakeParamsSchema as Eo, SessionsDeleteParamsSchema as Er, validatePluginsSessionActionResult as Et, validateCronListParams as F, TalkSpeakParamsSchema as Fa, EnvironmentsStatusResultSchema as Fi, validateTalkSpeakParams as Fn, SessionsUsageParamsSchema as Fr, validateSessionsAbortParams as Ft, validateDeviceTokenRevokeParams as G, AgentsCreateResultSchema as Ga, CronStatusParamsSchema as Gi, validateWakeParams as Gn, NodeEventResultSchema as Gr, validateSessionsListParams as Gt, validateDevicePairListParams as H, ArtifactsListParamsSchema as Ha, CronRemoveParamsSchema as Hi, validateToolsInvokeParams as Hn, PluginsSessionActionParamsSchema as Hr, validateSessionsCreateParams as Ht, validateCronRemoveParams as I, TalkSpeakResultSchema as Ia, ErrorCodes as Ii, validateTalkSpeakResult as In, PushTestParamsSchema as Ir, validateSessionsCleanupParams as It, validateEnvironmentsStatusParams as J, AgentsFileEntrySchema as Ja, ConfigGetParamsSchema as Ji, validateWebPushSubscribeParams as Jn, NodePairApproveParamsSchema as Jr, validateSessionsPatchParams as Jt, validateDeviceTokenRotateParams as K, AgentsDeleteParamsSchema as Ka, CronUpdateParamsSchema as Ki, validateWebLoginStartParams as Kn, NodeInvokeParamsSchema as Kr, validateSessionsMessagesSubscribeParams as Kt, validateCronRunParams as L, WebLoginStartParamsSchema as La, errorShape as Li, validateTasksCancelParams as Ln, PushTestResultSchema as Lr, validateSessionsCompactParams as Lt, validateConnectParams as M, TalkSessionSubmitToolResultParamsSchema as Ma, EnvironmentsListParamsSchema as Mi, validateTalkSessionSubmitToolResultParams as Mn, SessionsResetParamsSchema as Mr, validateSecretsResolveParams as Mt, validateCronAddParams as N, TalkSessionTurnParamsSchema as Na, EnvironmentsListResultSchema as Ni, validateTalkSessionTurnParams as Nn, SessionsResolveParamsSchema as Nr, validateSecretsResolveResult as Nt, validateConfigSchemaLookupParams as O, TalkSessionJoinParamsSchema as Oa, ExecApprovalsGetParamsSchema as Oi, validateTalkSessionJoinParams as On, AGENT_INTERNAL_EVENT_TYPE_TASK_COMPLETION as Oo, SessionsListParamsSchema as Or, validatePollParams as Ot, validateCronGetParams as P, TalkSessionTurnResultSchema as Pa, EnvironmentsStatusParamsSchema as Pi, validateTalkSessionTurnResult as Pn, SessionsSendParamsSchema as Pr, validateSendParams as Pt, validateExecApprovalResolveParams as Q, AgentsFilesListResultSchema as Qa, ConfigSchemaParamsSchema as Qi, validateWizardCancelParams as Qn, NodePairRequestParamsSchema as Qr, validateSessionsResolveParams as Qt, validateCronRunsParams as R, WebLoginWaitParamsSchema as Ra, CronAddParamsSchema as Ri, validateTasksGetParams as Rn, WebPushSubscribeParamsSchema as Rr, validateSessionsCompactionBranchParams as Rt, validateChatInjectParams as S, TalkSessionAppendAudioParamsSchema as Sa, PresenceEntrySchema as Si, validateTalkSessionAppendAudioParams as Sn, AgentParamsSchema as So, SessionsCompactionGetParamsSchema as Sr, validateNodeRenameParams as St, validateConfigApplyParams as T, TalkSessionCloseParamsSchema as Ta, ExecApprovalGetParamsSchema as Ti, validateTalkSessionCloseParams as Tn, SendParamsSchema as To, SessionsCreateParamsSchema as Tr, validatePluginsSessionActionParams as Tt, validateDevicePairRejectParams as U, AgentSummarySchema as Ua, CronRunParamsSchema as Ui, validateUpdateRunParams as Un, PluginsSessionActionResultSchema as Ur, validateSessionsDeleteParams as Ut, validateDevicePairApproveParams as V, ArtifactsGetParamsSchema as Va, CronListParamsSchema as Vi, validateToolsEffectiveParams as Vn, WebPushVapidPublicKeyParamsSchema as Vr, validateSessionsCompactionRestoreParams as Vt, validateDevicePairRemoveParams as W, AgentsCreateParamsSchema as Wa, CronRunsParamsSchema as Wi, validateUpdateStatusParams as Wn, PluginsUiDescriptorsParamsSchema as Wr, validateSessionsDescribeParams as Wt, validateExecApprovalGetParams as X, AgentsFilesGetResultSchema as Xa, ConfigSchemaLookupParamsSchema as Xi, validateWebPushUnsubscribeParams as Xn, NodePairRejectParamsSchema as Xr, validateSessionsPreviewParams as Xt, validateEventFrame as Y, AgentsFilesGetParamsSchema as Ya, ConfigPatchParamsSchema as Yi, validateWebPushTestParams as Yn, NodePairListParamsSchema as Yr, validateSessionsPluginPatchParams as Yt, validateExecApprovalRequestParams as Z, AgentsFilesListParamsSchema as Za, ConfigSchemaLookupResultSchema as Zi, validateWebPushVapidPublicKeyParams as Zn, NodePairRemoveParamsSchema as Zr, validateSessionsResetParams as Zt, validateChannelsStatusParams as _, TalkClientToolCallParamsSchema as _a, HelloOkSchema as _i, validateTalkClientToolCallResult as _n, ToolsEffectiveParamsSchema as _o, TasksListResultSchema as _r, validateNodePairVerifyParams as _t, validateAgentsCreateParams as a, CommandsListResultSchema as aa, NodePresenceAlivePayloadSchema as ai, validateSkillsStatusParams as an, ModelsListParamsSchema as ao, WizardNextResultSchema as ar, validateModelsListParams as at, validateChatEvent as b, TalkConfigResultSchema as ba, ShutdownEventSchema as bi, validateTalkEvent as bn, AgentIdentityParamsSchema as bo, SessionsCompactParamsSchema as br, validateNodePendingEnqueueParams as bt, validateAgentsFilesListParams as c, ChannelsStatusParamsSchema as ca, ChatHistoryParamsSchema as ci, validateSkillsUploadChunkParams as cn, SkillsInstallParamsSchema as co, WizardStatusParamsSchema as cr, validateNodeEventResult as ct, validateAgentsUpdateParams as d, TalkAgentControlResultSchema as da, LogsTailParamsSchema as di, validateTalkCatalogParams as dn, SkillsStatusParamsSchema as do, TaskSummarySchema as dr, validateNodeListParams as dt, ConfigSetParamsSchema as ea, NodePendingAckParamsSchema as ei, validateSessionsUsageParams as en, AgentsFilesSetResultSchema as eo, validateWizardStartParams as er, validateExecApprovalsNodeGetParams as et, validateArtifactsDownloadParams as f, TalkCatalogParamsSchema as fa, LogsTailResultSchema as fi, validateTalkCatalogResult as fn, SkillsUpdateParamsSchema as fo, TasksCancelParamsSchema as fr, validateNodePairApproveParams as ft, validateChannelsStartParams as g, TalkClientSteerParamsSchema as ga, GatewayFrameSchema as gi, validateTalkClientToolCallParams as gn, ToolsCatalogParamsSchema as go, TasksListParamsSchema as gr, validateNodePairRequestParams as gt, validateChannelsLogoutParams as h, TalkClientCreateResultSchema as ha, EventFrameSchema as hi, validateTalkClientSteerParams as hn, SkillsUploadCommitParamsSchema as ho, TasksGetResultSchema as hr, validateNodePairRemoveParams as ht, validateAgentWaitParams as i, CommandsListParamsSchema as ia, NodePendingEnqueueResultSchema as ii, validateSkillsSearchParams as in, AgentsUpdateResultSchema as io, WizardNextParamsSchema as ir, validateMessageActionParams as it, validateConfigSetParams as j, TalkSessionSteerParamsSchema as ja, EnvironmentSummarySchema as ji, validateTalkSessionSteerParams as jn, SessionsPreviewParamsSchema as jr, validateResponseFrame as jt, validateConfigSchemaLookupResult as k, TalkSessionJoinResultSchema as ka, ExecApprovalsSetParamsSchema as ki, validateTalkSessionJoinResult as kn, SessionsPatchParamsSchema as kr, validatePushTestParams as kt, validateAgentsFilesSetParams as l, ChannelsStatusResultSchema as la, ChatInjectParamsSchema as li, validateSkillsUploadCommitParams as ln, SkillsSearchParamsSchema as lo, WizardStatusResultSchema as lr, validateNodeInvokeParams as lt, validateArtifactsListParams as m, TalkClientCreateParamsSchema as ma, ErrorShapeSchema as mi, validateTalkClientCreateResult as mn, SkillsUploadChunkParamsSchema as mo, TasksGetParamsSchema as mr, validateNodePairRejectParams as mt, validateAgentIdentityParams as n, UpdateStatusParamsSchema as na, NodePendingDrainResultSchema as ni, validateSkillsDetailParams as nn, AgentsListResultSchema as no, ProtocolSchemas as nr, validateExecApprovalsSetParams as nt, validateAgentsDeleteParams as o, ChannelsLogoutParamsSchema as oa, NodePresenceAliveReasonSchema as oi, validateSkillsUpdateParams as on, SkillsDetailParamsSchema as oo, WizardStartParamsSchema as or, validateNodeDescribeParams as ot, validateArtifactsGetParams as p, TalkCatalogResultSchema as pa, ConnectParamsSchema as pi, validateTalkClientCreateParams as pn, SkillsUploadBeginParamsSchema as po, TasksCancelResultSchema as pr, validateNodePairListParams as pt, validateEnvironmentsListParams as q, AgentsDeleteResultSchema as qa, ConfigApplyParamsSchema as qi, validateWebLoginWaitParams as qn, NodeListParamsSchema as qr, validateSessionsMessagesUnsubscribeParams as qt, validateAgentParams as r, COMMAND_DESCRIPTION_MAX_LENGTH as ra, NodePendingEnqueueParamsSchema as ri, validateSkillsInstallParams as rn, AgentsUpdateParamsSchema as ro, WizardCancelParamsSchema as rr, validateLogsTailParams as rt, validateAgentsFilesGetParams as s, ChannelsStartParamsSchema as sa, ChatEventSchema as si, validateSkillsUploadBeginParams as sn, SkillsDetailResultSchema as so, WizardStartResultSchema as sr, validateNodeEventParams as st, formatValidationErrors as t, UpdateRunParamsSchema as ta, NodePendingDrainParamsSchema as ti, validateSkillsBinsParams as tn, AgentsListParamsSchema as to, validateWizardStatusParams as tr, validateExecApprovalsNodeSetParams as tt, validateAgentsListParams as u, ChannelsStopParamsSchema as ua, ChatSendParamsSchema as ui, validateTalkAgentControlResult as un, SkillsSearchResultSchema as uo, WizardStepSchema as ur, validateNodeInvokeResultParams as ut, validateChannelsStopParams as v, TalkClientToolCallResultSchema as va, RequestFrameSchema as vi, validateTalkConfigParams as vn, ToolsInvokeParamsSchema as vo, SessionsAbortParamsSchema as vr, validateNodePendingAckParams as vt, validateCommandsListParams as w, TalkSessionCancelTurnParamsSchema as wa, StateVersionSchema as wi, validateTalkSessionCancelTurnParams as wn, PollParamsSchema as wo, SessionsCompactionRestoreParamsSchema as wr, validatePluginApprovalResolveParams as wt, validateChatHistoryParams as x, TalkEventSchema as xa, TickEventSchema as xi, validateTalkModeParams as xn, AgentIdentityResultSchema as xo, SessionsCompactionBranchParamsSchema as xr, validateNodePresenceAlivePayload as xt, validateChatAbortParams as y, TalkConfigParamsSchema as ya, ResponseFrameSchema as yi, validateTalkConfigResult as yn, AgentEventSchema as yo, SessionsCleanupParamsSchema as yr, validateNodePendingDrainParams as yt, validateCronStatusParams as z, ArtifactSummarySchema as za, CronGetParamsSchema as zi, validateTasksListParams as zn, WebPushTestParamsSchema as zr, validateSessionsCompactionGetParams as zt };
