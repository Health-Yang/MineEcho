...
import { f as parseConfiguredModelVisibilityEntries, r as buildConfiguredModelCatalog } from "./model-selection-shared-BuXkxoPc.js";
...
import { d as resolveReasoningDefault, l as resolvePersistedOverrideModelRef } from "./model-selection-DF4MbMUd.js";
...
import { n as createModelVisibilityPolicy, t as RUNTIME_MODEL_VISIBILITY_NORMALIZATION } from "./model-visibility-policy-CTaFNJ2U.js";
...
import "./model-selection-directive-BiHjvMxK.js";
...
async function createModelSelectionState(params) {
	...
	if (staleHeartbeatAutoFallbackOverride) {
		...
		const normalizedDirectOverride = directStoredOverride ? normalizeRuntimeModelRef(directStoredOverride.provider, directStoredOverride.model) : null;
	...
	const skipStoredOverride = params.skipStoredModelOverride === true || params.hasResolvedHeartbeatModelOverride === true || staleHeartbeatAutoFallbackOverride && storedOverride?.source === "session";
