...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, k as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-86ytN5P4.js";
...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-CgMHHnyc.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-DLIOLl7Z.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-CdXj2sGN.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-zkHD0rxB.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-CGhV2Wu1.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-Dn2UUsIU.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-wL8kxNqY.js"));
...
const routedCommandDefinitions = {
	health: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { healthCommand } = await import("./health-Dx3dF9fN.js");
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-DiQ8qbTe.js");
			...
			const { statusCommand } = await import("./status-DbIm60Td.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-BdpqyJkp.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-BgxFE6IE.js");
	...
	"tasks-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksListJsonCommand } = await import("./tasks-json-GTShfaAB.js");
	...
	"tasks-audit": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksAuditJsonCommand } = await import("./tasks-json-GTShfaAB.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-e5FWg7Qg.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-B24bm6H6.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-BV5x6N-8.js");
