import { a as isLegacyParentWritableUpdateDoctorPass } from "./update-phase-D5uJdFHk.js";
...
async function runGatewayConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-AcbdTMGN.js");
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-C9kuCpAc.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores } = await import("./doctor-auth-flat-profiles-BPMN1HuM.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-bCX1IZPZ.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-DJJ-hbs5.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-DIMjHwwW.js");
	const { buildGatewayConnectionDetails } = await import("./call-CHAszD8e.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runGatewayAuthHealth(ctx) {
	const { resolveSecretInputRef } = await import("./types.secrets-C6QHBKMB.js");
	const { resolveGatewayAuth } = await import("./auth-CKvzrOPA.js");
	const { note } = await import("./note-B39bnFR7.js");
	const { randomToken } = await import("./onboard-helpers-I7ctqu94.js");
...
async function runCommandOwnerHealth(ctx) {
	const { noteCommandOwnerHealth } = await import("./doctor-command-owner-BRR5Tv7B.js");
	noteCommandOwnerHealth(ctx.cfg);
}
async function runStructuredHealthRepairs(ctx) {
	if (!ctx.prompter.shouldRepair) return;
	const { registerCoreHealthChecks } = await import("./doctor-core-checks-DyZG5iTr.js");
	const { registerBundledHealthChecks } = await import("./bundled-health-checks-CwhfLm-u.js");
	const { listHealthChecks } = await import("./health-check-registry-CMeHRv7N.js");
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-liQ48KiD.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-DKcDOg84.js");
	const { note } = await import("./note-B39bnFR7.js");
	...
	const checks = listHealthChecks().filter((check) => !LEGACY_POSITIONAL_REPAIR_CHECK_IDS.has(check.id));
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-DUh3NMv1.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-D4lfsb9b.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-BDfeUlGa.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-Cfln7_sR.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	if (!ctx.prompter.shouldRepair) return;
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-C9lJYKZc.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runStateIntegrityHealth(ctx) {
	const { noteStateIntegrity } = await import("./doctor-state-integrity-BwsYjrZU.js");
	await noteStateIntegrity(ctx.cfg, ctx.prompter, ctx.configPath);
}
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-Boai5SpI.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runSessionLocksHealth(ctx) {
	const { noteSessionLockHealth } = await import("./doctor-session-locks-BxFDHWfp.js");
...
async function runSessionTranscriptsHealth(ctx) {
	const { noteSessionTranscriptHealth } = await import("./doctor-session-transcripts-kXzC2Jju.js");
	await noteSessionTranscriptHealth({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runSessionSnapshotsHealth(ctx) {
	const { noteSessionSnapshotHealth } = await import("./doctor-session-snapshots-CcZThvyt.js");
...
async function runConfigAuditScrubHealth(ctx) {
	const { maybeScrubConfigAuditLog } = await import("./doctor-config-audit-scrub-NTO8tir7.js");
	await maybeScrubConfigAuditLog({ shouldRepair: ctx.prompter.shouldRepair });
}
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./doctor-cron-DlW4mU8f.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-DTzdbe3f.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-D9ZJHYSp.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-BbWpa1qX.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-Do4RvW8l.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-D7XM1Uhb.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-DS6WPXoQ.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-BDlEJrqs.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { loadModelCatalog } = await import("./model-catalog-BG4aGsfT.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-B5nPU-92.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runToolResultCapHealth(ctx) {
	const { resolveAgentContextLimits } = await import("./agent-scope-DKcDOg84.js");
	const { normalizeAgentId } = await import("./session-key-CNV8zQ99.js");
	const targets = [];
	...
	const { DEFAULT_CONTEXT_TOKENS } = await import("./defaults-RurGC76M.js");
	const { loadModelCatalog, findModelCatalogEntry } = await import("./model-catalog-BG4aGsfT.js");
	const { resolveContextWindowInfo } = await import("./context-window-guard-D3YdM8zY.js");
	const { resolveDefaultModelForAgent, modelKey } = await import("./model-selection-B5nPU-92.js");
	const { buildToolResultCapDoctorAdvice } = await import("./doctor-tool-result-cap-advice-ClyGR22a.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-CSglnosx.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BDzBQGYk.js");
	const { note } = await import("./note-B39bnFR7.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-BeZmbRLK.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-D7mJijL0.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-bL9O2L_W.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatTemplateRepairHealth(ctx) {
	const { maybeRepairHeartbeatTemplate } = await import("./doctor-heartbeat-template-repair-DG2CvBjn.js");
...
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-C3wMA0zy.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-C-zmv4n7.js");
...
async function runWhatsappResponsivenessHealth(ctx) {
	const { noteWhatsappResponsivenessHealth } = await import("./doctor-whatsapp-responsiveness-BTqfhRPQ.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-BDkw_pp5.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-D6OdkIae.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-TOiPFkkp.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-AcbdTMGN.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-I7ctqu94.js");
	const { replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-NsVlIej4.js");
	const { shortenHomePath } = await import("./utils-D-IGQFBQ.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-DKcDOg84.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-BwsYjrZU.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-CtsEZniL.js");
	const { note } = await import("./note-B39bnFR7.js");
	const workspaceDir = resolveAgentWorkspaceDir(ctx.cfg, resolveDefaultAgentId(ctx.cfg));
...
function formatRuntimeToolSchemaFindings(findings) {
...
async function runRuntimeToolSchemasHealth(ctx) {
	const { registerCoreHealthChecks } = await import("./doctor-core-checks-DyZG5iTr.js");
	const { getHealthCheck } = await import("./health-check-registry-CMeHRv7N.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-DKcDOg84.js");
	const { note } = await import("./note-B39bnFR7.js");
	registerCoreHealthChecks();
