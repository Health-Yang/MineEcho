...
import { t as addGatewayRunCommand } from "./run-command-DnR652YP.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-Bl6y_xj5.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-Dx3dF9fN.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-Kwtzc8vZ.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-D9w3lHxy.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./health-style-DgsRgSYJ.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-D1oj1ipQ.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-BIGZDpBb.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-BeBoxI4A.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-XJaIAJAS.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-BVeaajaV.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayTransportErrorJson } = await import("./call-CHAszD8e.js");
