...
import { E as resolveExecApprovalAllowedDecisions } from "./exec-approvals-oH5G9_TS.js";
...
import { a as supportsNativeExecApprovalClient, n as listNativeExecApprovalClientLabels, t as describeNativeExecApprovalClientSetup } from "./exec-approval-surface-D47_T3ze.js";
...
function normalizeActionDescriptors(raw) {
	...
	for (const value of raw) {
		...
		const style = record.style === "primary" || record.style === "secondary" || record.style === "success" || record.style === "danger" ? record.style : void 0;
		if (!label || !command || !style) continue;
		const decision = record.decision === "allow-once" || record.decision === "allow-always" || record.decision === "deny" ? record.decision : void 0;
		actions.push({
...
function getExecApprovalReplyMetadata(payload) {
	...
	const severity = record.severity === "info" || record.severity === "warning" || record.severity === "critical" ? record.severity : void 0;
