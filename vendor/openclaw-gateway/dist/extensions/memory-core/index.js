...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-D2YDlCw7.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-g6nPES_q.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CD7H6J8w.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-CV4JdLhj.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-fs7uJAM5.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-DqAjuzaZ.js");
