...
import { _ as normalizeLogLevel, r as getChildLogger } from "../../logger-xjL_xnHy.js";
import { a as shouldLogVerbose } from "../../globals-DZ-ifL5z.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-DKulK0JL.js";
...
import { c as saveSessionStore, d as updateSessionStoreEntry, f as upsertSessionEntry, i as patchSessionEntry, n as getSessionEntry, r as listSessionEntries, u as updateSessionStore } from "../../store-B5j4GKkg.js";
...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-BuXkxoPc.js";
...
import { m as listTasksForFlowId } from "../../task-registry-B2oVolww.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-BwpoHlXv.js";
import "../../runtime-internal-DvzGU0Fr.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-DCw5dRWs.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-BUQsixTe.js";
import { l as ensureAgentWorkspace } from "../../workspace-BxBAoMrZ.js";
import { g as resizeToJpeg, l as getImageMetadata } from "../../media-services-rb2QLp-y.js";
...
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-BI6tRq9Y.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-De9O9_DK.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-KbtzJr_A.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-BFXFWfvK.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-Cmfay0aK.js";
import { r as isVoiceCompatibleAudio } from "../../audio-DmM7QcAU.js";
import { t as createRuntimeTaskFlow } from "../../runtime-taskflow-Dx60CPYT.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-pi.runtime-CxUEpzId.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner--uLRaqec.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-ClDIMXi4.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-BaxQUh_i.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-D096Fvw8.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-BkqDRDGa.js"), (m) => m.createRuntimeLlm({
