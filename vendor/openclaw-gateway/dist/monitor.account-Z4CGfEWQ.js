...
import { l as normalizeAgentId$1 } from "./session-key-yaI3D3Bl.js";
...
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./streaming-Bpx5ncw8.js";
...
import { t as createReplyPrefixContext } from "./reply-prefix-BF22-8Yl.js";
...
import { i as installRequestBodyLimitGuard } from "./http-body-BdNDpkYn.js";
import "./ssrf-runtime-C8F9j9mo.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-BJ9sblon.js";
...
import { n as createPersistentDedupe } from "./persistent-dedupe-VkBV7ovp.js";
import "./webhook-ingress-UeOF0INQ.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-Bii1opsG.js";
import { t as buildFeishuConversationId } from "./conversation-id-Ce5ncscM.js";
import { i as resolveReceiveIdType } from "./targets-CgTiDHPN.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-Csfea-c8.js";
import { _ as readString, b as normalizeCommentFileType, d as encodeQuery, f as extractReplyText, g as parseCommentContentElements, h as normalizeString, l as resolveFeishuRuntimeAccount, m as isRecord$1, y as buildFeishuCommentTarget } from "./accounts-DFpq_zoM.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-D_dvCL26.js";
import { a as resolveFeishuGroupConversationIngressAccess, c as resolveFeishuReplyPolicy, i as resolveFeishuGroupConfig, n as normalizeFeishuAllowEntry, o as resolveFeishuGroupSenderActivationIngressAccess, r as resolveFeishuDmIngressAccess, t as hasExplicitFeishuGroupConfig } from "./policy-BsJU7snd.js";
import { t as getFeishuRuntime } from "./runtime-CjGuNoJc.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-D-7Cq9bW.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-CpPhdBue.js";
import "./runtime-api-Bn99tck9.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-BB9NHzC6.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-BN2P9HS3.js";
import { a as feishuWebhookRateLimiter, c as wsClients, i as botOpenIds, l as fetchBotIdentityForMonitor, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as httpServers, r as botNames, s as recordWebhookStatus, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS } from "./monitor.state-DGa6IuVW.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-ClTjSH16.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-ClTjSH16.js");
