...
import { _ as resolveOAuthDir } from "./paths-CQv1_CDw.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-BZ7XNDP2.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-DKcDOg84.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-BLNIq-m-.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-BK3lZCHB.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-m-fjs0UJ.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Dk_hudBL.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-Bp0vcmWd.js");
