...
import { u as normalizeResolvedSecretInputString } from "./types.secrets-CtRQ27Ls.js";
...
import { t as createRealtimeTranscriptionWebSocketSession } from "./realtime-transcription-QUk1hF_O.js";
import { r as normalizeElevenLabsBaseUrl } from "./shared-B7utk7gS.js";
import { r as resolveElevenLabsApiKeyWithProfileFallback } from "./config-compat-C8915suS.js";
import "./config-api-B3YCqLRi.js";
...
function normalizeProviderConfig(config) {
	...
	return {
		...
		vadSilenceThresholdSecs: parseFiniteNumber(raw.vadSilenceThresholdSecs ?? raw.vad_silence_threshold_secs),
		vadThreshold: parseFiniteNumber(raw.vadThreshold ?? raw.vad_threshold),
		minSpeechDurationMs: parseFiniteNumber(raw.minSpeechDurationMs ?? raw.min_speech_duration_ms),
		minSilenceDurationMs: parseFiniteNumber(raw.minSilenceDurationMs ?? raw.min_silence_duration_ms)
	};
}
