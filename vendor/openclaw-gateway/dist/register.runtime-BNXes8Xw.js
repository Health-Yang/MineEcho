...
import { s as upsertAuthProfileWithLock } from "./profiles-7sSr_su8.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-DJpWDBsm.js";
import "./string-coerce-runtime-qOd7_06l.js";
import { c as resolveClaudeThinkingProfile, l as cloneFirstTemplateModel } from "./provider-model-shared-Co6lnz7Y.js";
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./provider-auth-token-DFQwAe7c.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BypOO1dt.js";
...
import { a as fetchClaudeUsage } from "./provider-usage-CTwMCKvn.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive, t as readClaudeCliCredentialsForRuntime } from "./cli-auth-seam-DQdMWCSj.js";
import { n as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, r as CLAUDE_CLI_DEFAULT_MODEL_REF, t as CLAUDE_CLI_BACKEND_ID } from "./cli-constants-BxhhDXHI.js";
import "./cli-shared-Bfo3blb2.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-DwiKCLEg.js";
import { t as buildClaudeCliCatalogEntries } from "./cli-catalog-ClXOo1O-.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-DwwhS_4Q.js";
import { n as normalizeAnthropicProviderConfigForProvider, t as applyAnthropicConfigDefaults } from "./config-defaults-DmI5MKeQ.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-CXlsT4Kg.js";
import { t as buildReplayPolicy } from "./replay-policy-3TQxoUN-.js";
import { l as wrapAnthropicProviderStream } from "./stream-wrappers-C5t4aSj4.js";
...
function applyAnthropicGa1MContextWindow(params) {
	if (!isAnthropicGa1MModel(params.modelId)) return;
	if (hasConfiguredModelContextOverride(params.config, params.provider, params.modelId)) return;
	const nextContextWindow = Math.max(params.model.contextWindow ?? 0, ANTHROPIC_GA_1M_CONTEXT_TOKENS);
	const nextContextTokens = typeof params.model.contextTokens === "number" ? Math.max(params.model.contextTokens, ANTHROPIC_GA_1M_CONTEXT_TOKENS) : ANTHROPIC_GA_1M_CONTEXT_TOKENS;
...
function resolveAnthropicImageMediaInput(modelId, modelName) {
	...
	const opus47 = [modelId, modelName].filter((value) => typeof value === "string").some((ref) => [ANTHROPIC_OPUS_47_MODEL_ID, ANTHROPIC_OPUS_47_DOT_MODEL_ID].some((prefix) => normalizeLowercaseStringOrEmpty(ref).startsWith(prefix)));
	return { image: {
...
function normalizeAnthropicResolvedModel(ctx) {
	...
	const contextWindowModel = applyAnthropicGa1MContextWindow({
		config: ctx.config,
...
function buildAnthropicProvider() {
	...
	return {
		...
		resolveDynamicModel: (ctx) => {
			...
			return applyAnthropicGa1MContextWindow({
				config: ctx.config,
				provider: ctx.provider,
				modelId: ctx.modelId,
