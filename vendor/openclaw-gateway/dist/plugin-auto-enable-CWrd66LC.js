...
import { h as compileSafeRegex } from "./redact-9hVaCauP.js";
import { g as sortUniqueStrings, l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { c as isRecord, d as resolveConfigDir, p as resolveUserPath } from "./utils-B5r0V84N.js";
...
import { i as loadPluginMetadataSnapshot } from "./plugin-metadata-snapshot-Bb8bov-r.js";
import { m as resolveInstalledPluginIndexPolicyHash } from "./installed-plugin-index-store-Db9FQc7C.js";
import { r as normalizeChatChannelId } from "./ids-OP3BJTaQ.js";
import { l as resolveEffectivePluginActivationState, s as normalizePluginsConfig } from "./config-state-CzzsKZJi.js";
...
import { p as loadPluginRegistrySnapshot, r as normalizePluginsConfigWithRegistry, y as getCurrentPluginMetadataSnapshot } from "./plugin-registry-BALJ9TgI.js";
import { r as withBundledPluginVitestCompat } from "./bundled-compat-BEMJyVTl.js";
...
import "./registry-49GbU2k5.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-L6rqw6O0.js";
import { i as passesManifestOwnerBasePolicy, n as isActivatedManifestOwner } from "./manifest-owner-policy-BKVRFeLo.js";
import { t as createPluginIdScopeSet } from "./plugin-scope-Cg_NWH2k.js";
import { t as collectConfiguredAgentHarnessRuntimes } from "./harness-runtimes-B76WrYrN.js";
import { i as listPotentialConfiguredChannelPresenceSignals } from "./config-presence-CzmQFkYe.js";
import { i as listBundledChannelIdsWithConfiguredState, r as hasBundledChannelConfiguredState, t as isChannelConfigured } from "./channel-configured-BbAjVXEv.js";
import { n as resolvePluginSetupAutoEnableReasons } from "./setup-registry-Y0sCwnR-.js";
...
function resolveOwningPluginIdsForProvider(params) {
	...
	}).manifestRegistry).plugins.filter((plugin) => plugin.providers.some((providerId) => normalizeProviderId(providerId) === normalizedProvider) || plugin.cliBackends.some((backendId) => normalizeProviderId(backendId) === normalizedProvider) || (plugin.setup?.cliBackends ?? []).some((backendId) => normalizeProviderId(backendId) === normalizedProvider)).map((plugin) => plugin.id);
