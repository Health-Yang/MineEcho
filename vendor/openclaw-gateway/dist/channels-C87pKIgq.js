...
import { a as getResolvedLoggerSettings } from "./logger-xjL_xnHy.js";
import { t as danger } from "./globals-DZ-ifL5z.js";
...
import { a as getBundledChannelSetupPlugin } from "./bundled-CTRQpZ0m.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Be8exPcf.js";
import "./plugins-BGmuVWWz.js";
import "./logging-3S-Z1HW2.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-wSy4wTx3.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BCy4bTc9.js";
...
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-N4j9wB4b.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CC7zWwhc.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CaJFRzVY.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BsXHgP_f.js";
import { n as resolveLogFile } from "./log-tail-quJdRb5H.js";
...
import { t as applyAgentBindings } from "./agents.bindings-DyWhXU0K.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-B7bRdA4J.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-BQxtvbHi.js";
import { t as channelsListCommand } from "./list-BmMR0CNn.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-gYOnHHVg.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CjT2Aepy.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-Bt5AIH-9.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-CUm3djLh.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BOzpif1Q.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-kavimZzM.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-C85MW67a.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-BiD5xYjE.js");
