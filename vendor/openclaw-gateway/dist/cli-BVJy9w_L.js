...
import { i as resolveMatrixAccount } from "./accounts-D3gJsMAZ.js";
import { t as formatMatrixErrorMessage } from "./errors-DY2AYXwT.js";
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-9qftOx2-.js";
import { n as matrixSetupAdapter } from "./setup-core-CZVhDCpO.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-Dm_YMVFT.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-84fTkVrP.js";
import { t as withResolvedActionClient } from "./client-BVb3oLn3.js";
import { r as resolveMatrixAuthContext } from "./config-RNdXIa5r.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-ht60Y3yG.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-C9BUmnEP.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-Buy4eU1p.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-ualvzaI2.js");
