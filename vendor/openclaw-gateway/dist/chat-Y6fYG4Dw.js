...
import { b as assertNoWindowsNetworkPath, w as safeFileURLToPath } from "./fs-safe-JUdtLZkh.js";
...
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BxgIUTRt.js";
import { i as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-NW6lw3Ys.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { C as validateChatSendParams, Ii as ErrorCodes, Li as errorShape, S as validateChatInjectParams, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./protocol-BkfNT2Bp.js";
import { c as normalizeInputProvenance } from "./input-provenance-D_ZjwTES.js";
...
import { i as resolveSessionFilePath } from "./paths-DZXdqwOo.js";
import { o as isAudioFileName } from "./mime-DppuT-pZ.js";
import "./sessions-Ct4mpWsk.js";
import { o as resolveMirroredTranscriptText, s as appendSessionTranscriptMessage, u as streamSessionTranscriptLines } from "./transcript-DxGLLD67.js";
...
import { h as stripEnvelopeFromMessage, i as readRecentSessionMessagesAsync, m as readSessionTranscriptIndex, n as capArrayByJsonBytes, x as jsonUtf8Bytes } from "./session-utils.fs-D_Qde0sG.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-DBD-mk-0.js";
import { c as loadSessionEntry, d as resolveDeletedAgentIdFromSessionKey, h as resolveGatewaySessionThinkingDefault, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-CmwnszsS.js";
...
import { t as dispatchInboundMessage } from "./dispatch-BGwFKOyt.js";
import { st as createUserTurnTranscriptRecorder } from "./selection-C4e-Qn9W.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-BSIGv16L.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-CkmEdlzm.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-D6qfvE07.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-BLpt3hx9.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BEN4j_RH.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-DWoIGpXc.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-jzFwkanA.js";
import { n as resolveSendPolicy } from "./send-policy-BUg-fAPA.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-weoPd60T.js";
import { t as createReplyDispatcher } from "./reply-dispatcher-DmOOpho9.js";
import { i as registerChatAbortController, o as updateChatRunProvider, r as isChatStopCommandText, t as abortChatRunById } from "./chat-abort-BRIlXlGa.js";
...
import { t as logLargePayload } from "./diagnostic-payload-C5j-OULj.js";
...
import { n as isSuppressedControlReplyText } from "./control-reply-text-lOMF8eR0.js";
import { a as projectRecentChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-C0lsXGny.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-Nwhtzyyt.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CeQlBJCY.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-C9tZ2-i4.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-JdPenpRZ.js";
import { n as setGatewayDedupeEntry } from "./agent-wait-dedupe-x4nPImUT.js";
...
async function findAssistantTranscriptMessageByIdempotencyKey(transcriptPath, idempotencyKey) {
	...
	const target = (await readSessionTranscriptIndex(transcriptPath))?.entries.toReversed().find((entry) => {
		...
		return typeof entry.id === "string" && entry.id.trim().length > 0 && message?.role === "assistant" && message.idempotencyKey === trimmedIdempotencyKey;
	});
...
async function appendAssistantTranscriptMessage(params) {
	...
	if (params.idempotencyKey && await transcriptHasIdempotencyKey(transcriptPath, params.idempotencyKey)) {
