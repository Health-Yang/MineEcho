...
import { r as hasGlobalHooks } from "./hook-runner-global-CjzahG2G.js";
...
import { f as runBeforeToolCallHook, o as hasBeforeToolCallPolicy } from "./pi-tools.before-tool-call-BEgB-RpB.js";
...
import { r as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-BULW39MH.js";
import { t as runAgentHarnessAfterToolCallHook } from "./hook-helpers-Bm4bJ7b-.js";
...
async function invokeNativeHookRelay(params) {
	...
	if (params.requireGeneration) {
		if (readNonEmptyString(params.generation, "generation") !== registration.generation) {
			if (!canAcceptNativeHookRelayGenerationMismatch(registration)) throw new Error(NATIVE_HOOK_RELAY_BRIDGE_STALE_REGISTRATION_ERROR);
...
function canAcceptNativeHookRelayGenerationMismatch(registration) {
...
//#endregion
export { isNativeHookRelayBridgeStaleRegistrationError as a, testing as c, invokeNativeHookRelayBridge as i, hasNativeHookRelayInvocation as n, registerNativeHookRelay as o, invokeNativeHookRelay as r, renderNativeHookRelayUnavailableResponse as s, buildNativeHookRelayCommand as t };
