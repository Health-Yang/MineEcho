...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-D_fPrX3v.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-DAradvm6.js");
