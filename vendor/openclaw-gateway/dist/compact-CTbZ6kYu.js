...
import { r as resolveAgentModelFallbackValues } from "./model-input-C697EEaR.js";
import { g as resolveRunModelFallbacksOverride, v as resolveSessionAgentIds } from "./agent-scope-CudANNo3.js";
import { a as isSubagentSessionKey, i as isCronSessionKey } from "./session-key-utils-AmKO9Roj.js";
import { a as resolveAgentDir } from "./agent-scope-config-BfxErZq2.js";
...
import { u as normalizeMessageChannel } from "./message-channel-CD8Rw4Ab.js";
import { r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-BpWFUQhi.js";
import { c as resolveContextConfigProviderForRuntime, l as resolveOpenAICompactionRuntimeProvider } from "./openai-codex-routing-CnBPb3N4.js";
...
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-B48uOlVM.js";
import { K as transformProviderSystemPrompt, P as resolveProviderTextTransforms, b as prepareProviderRuntimeAuth } from "./provider-runtime-CGENk1Ok.js";
...
import { n as coerceToFailoverError, r as describeFailoverError } from "./failover-error-wBZizcCn.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-BHGQ7y-R.js";
import { $ as hasMeaningfulConversationContent, A as shouldRotateCompactionTranscript, B as createSystemPromptOverride, F as collectAllowedToolNames, G as trackSessionManagerAccess, H as resolveEmbeddedAgentStreamFn, I as collectRegisteredToolNames, J as validateReplayTurns, K as createEmbeddedPiResourceLoader, L as toSessionToolAllowlist, M as flushPendingToolResultsAfterIdle, N as mapThinkingLevel, O as rotateTranscriptAfterCompaction, P as normalizeContextTokenBudget, Q as buildEmbeddedExtensionFactories, R as applySystemPromptOverrideToSession, U as resolveEmbeddedRunSkillEntries, V as resolveEmbeddedAgentBaseStreamFn, W as prewarmSessionFile, X as getHistoryLimitFromSessionKey, Y as buildEmbeddedMessageActionDiscoveryInput, Z as limitHistoryTurns, et as isRealConversationMessage, ft as collectRuntimeChannelCapabilities, it as guardSessionManager, j as dedupeDuplicateUserMessagesForCompaction, kt as isReasoningTagProvider, lt as repairSessionFileIfNeeded, nt as consumeCompactionSafeguardCancelReason, pt as createPreparedEmbeddedPiSettingsManager, q as sanitizeSessionHistory, rt as setCompactionSafeguardCancelReason, z as buildEmbeddedSystemPrompt } from "./selection-C4e-Qn9W.js";
import { t as getMachineDisplayName } from "./machine-name-C08F-g3p.js";
import { _ as listActiveProcessSessionReferences, m as resolveEmbeddedCompactionTarget } from "./attempt.prompt-helpers-6Y-UzS6M.js";
import { n as extractModelCompat } from "./provider-model-compat-M50YUhbu.js";
import { i as generateSecureToken } from "./secure-random-BxnbXS5x.js";
import { a as resolveBootstrapContextForRun, i as makeBootstrapWarn, s as resolveContextInjectionMode } from "./bootstrap-files-_8BLxDNp.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-DX41nv_s.js";
import { _ as ensureSessionHeader, i as pickFallbackThinkingLevel } from "./pi-embedded-helpers-Bj4nONRY.js";
import { A as resolveChannelReactionGuidance, D as listChannelSupportedActions, O as resolveChannelMessageToolHints } from "./pi-tools.before-tool-call-BEgB-RpB.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./pi-tools-B2ovZXCA.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DyXQ-M1b.js";
import { d as resolveModelAuthMode, i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-DEXDfJh7.js";
import { t as supportsModelTools } from "./model-tool-support-D9jCvogW.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BNe3-tQr.js";
import { t as createBundleMcpToolRuntime } from "./pi-bundle-mcp-materialize-CJjmpfX1.js";
import "./pi-bundle-mcp-tools-Dx9OBYuL.js";
import { _ as resolveCompactionTimeoutMs, g as compactWithSafetyTimeout } from "./attempt.tool-run-context-TMML7ez9.js";
import { a as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback--w47Y_pS.js";
import { t as log } from "./logger-DLLDK9dc.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-BdQiXWNP.js";
import { t as splitSdkTools } from "./tool-split-DchkB24K.js";
import { n as resolveModelAsync } from "./model-D1xkjWU8.js";
import { s as resolveAgentPromptSurfaceForSessionKey } from "./system-prompt-config-D_cH_Bz5.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CIUub-IS.js";
import { w as sanitizeToolUseResultPairing } from "./openai-transport-stream-BOZ_TYPY.js";
import { o as resolveSandboxContext } from "./sandbox-BEN4j_RH.js";
import { c as readTranscriptFileState, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-DWoIGpXc.js";
import { t as detectRuntimeShell } from "./shell-utils-BDYMhC5E.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-CtKr5dRj.js";
import { s as resolveSkillsPromptForRun } from "./workspace-C9EyWtKF.js";
import "./skills-AlUGzl4g.js";
import { n as resolveSystemPromptOverride } from "./system-prompt-report-CCt0Pjyb.js";
import { i as resolveUserTimezone, r as resolveUserTimeFormat, t as formatUserTime } from "./date-time-D7najZvu.js";
import { t as applyExtraParamsToAgent } from "./extra-params-BxDvfOci.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-B8qKn5SZ.js";
import { s as resolveContextWindowInfo } from "./context-window-guard-0r-APPpV.js";
...
import { _ as persistSessionCompactionCheckpoint, a as runAfterCompactionHooks, d as resolveCompactionFailureReason, f as captureCompactionCheckpointSnapshotAsync, i as estimateTokensAfterCompaction, l as classifyCompactionReason, n as asCompactionHookRunner, o as runBeforeCompactionHooks, p as cleanupCompactionCheckpointSnapshot, r as buildBeforeCompactionHookMetrics, s as runPostCompactionSideEffects, t as readPiModelContextTokens, u as formatUnknownCompactionReasonDetail, y as resolveSessionCompactionCheckpointReason } from "./model-context-tokens-BpXhDFUw.js";
...
async function compactEmbeddedPiSessionDirectOnce(params) {
	...
	const modelConfigProvider = resolvedCompactionTarget.provider ?? "openai";
