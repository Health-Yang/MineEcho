...
import { t as createDirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-DYhAD3nm.js";
...
import { r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-E8u-aPa3.js";
...
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-3grDB0ix.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-B9Ln6QwG.js";
import { i as DEFAULT_RELAYS } from "./setup-adapter-DijL_7B5.js";
...
const startNostrGatewayAccount = async (ctx) => {
	...
	const bus = await startNostrBus({
		...
		onMessage: async (senderPubkey, text, reply, meta) => {
			...
			const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-DKjKjNQS.js");
