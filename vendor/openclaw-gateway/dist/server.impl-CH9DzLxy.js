...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DmmbBEHd.js";
import { a as normalizeStateDirEnv, i as isNixMode } from "./paths-CQv1_CDw.js";
import { _ as uniqueStrings } from "./string-normalization-B8G0vlWE.js";
import { _ as sleep } from "./utils-B5r0V84N.js";
import { o as emitDiagnosticsTimelineEvent, s as isDiagnosticsTimelineEnabled } from "./plugin-metadata-snapshot-Bb8bov-r.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-BqWfg4Sp.js";
import { S as setCurrentPluginMetadataSnapshot } from "./plugin-registry-BALJ9TgI.js";
...
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-1gTaEPwP.js";
...
import { n as resolveGatewayAuth } from "./auth-resolve-DsCwkRwQ.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-CbKYHGo4.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BlARNTf3.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-C_i-H7Rr.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-BUnLwpF8.js";
...
import "./method-scopes-BnJ64Q8O.js";
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-BMCHYmJL.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-C5wAa84u.js";
import { d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-B5Ug58ea.js";
import { i as createPluginGatewayMethodDescriptors, n as createGatewayMethodRegistry, t as createGatewayMethodDescriptorsFromHandlers } from "./registry-Doj5s8ld.js";
import { i as resolveMainSessionKey } from "./main-session-896o98eb.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-lQzPIJ_8.js";
import "./sessions-Ct4mpWsk.js";
import { a as enqueueSystemEvent } from "./system-events-BbV9wJlR.js";
import { b as startDiagnosticHeartbeat, x as stopDiagnosticHeartbeat } from "./diagnostic-BDsaMZfL.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-C4T_uTKE.js";
import { s as getActiveEmbeddedRunCount } from "./run-state-Du9_ntOI.js";
import { l as getTotalQueueSize } from "./command-queue-fCeWoVd6.js";
import { i as resolveCronStorePath } from "./store-Dd-tb17i.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-CCyqNOzR.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-BniQMVzq.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-Yp6H5_aR.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BZvg9ZTv.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-C5j-OULj.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-Fic6EinB.js";
import { t as createDefaultDeps } from "./deps-2n_htaMu.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-MGNcOBGY.js";
import { t as GatewayLockError } from "./gateway-lock-DItVi1yl.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-3luipiKg.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-DqI76DDQ.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DfhdJohv.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-Cxg4FBG3.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-OAv1SCAo.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-D14M-vmX.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-C93LQxTG.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-CNlmEIxR.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-BeWuACQY.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BBiUdcwa.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-Bskm4nLi.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-B6f5_zjM.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-BI9gJWUd.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-VwBhSklc.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DyUlYhev.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-D7neKd7S.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BSYvZl2P.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-CzBzOauq.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-BTum9EQA.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-D5zrLAOO.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-DYL6uNQx.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DJldr0Cw.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-DGz_3CsR.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-DGz_3CsR.js");
...
async function resetModelCatalogCacheForTest() {
	const { resetModelCatalogCacheForTest } = await import("./server-model-catalog-BsMRv3zg.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CJlIcbUn.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-B-WZcjxr.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-WmYwWRSf.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-DhM-KX0L.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DwkezWMN.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-BsMRv3zg.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-D6ziyeMD.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-BJexkhI8.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	normalizeStateDirEnv(process.env);
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-BkKzMyKT.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-Dy6JgLXO.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-B8Ebevmx.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-BVf0RGn3.js");
	...
	const { createChannelManager } = await import("./server-channels-DpmsRljB.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-BpwrW2aJ.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-DMMX70Uj.js"), import("./server-runtime-startup-services-Cdje52T4.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers }] = await Promise.all([import("./server-aux-handlers-D1uXI0qh.js"), import("./server-methods-Bl5BQpPk.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BcU8jUQm.js"),
				import("./server-plugin-bootstrap-z5cxkjzt.js"),
				import("./services-Ci6twmx8.js")
			]);
		...
		const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
			const { createGatewayRequestContext } = await import("./server-request-context-Cid8NNJV.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-z5cxkjzt.js");
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-DFEhmtNz.js"), import("./route-capability-BX66WOI0.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-DYPcT7bV.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DHNbXHnG.js");
